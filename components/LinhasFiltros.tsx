...
const T: Record<Lang, {
  ...
  fr: {
    essentialsHeading: "Gamme Essentials - Système de Filtration Haute Efficacité",
    premiumHeading: "Gamme Premium - Système de Filtration Haute Efficacité",
  ...
  de: {
    essentialsHeading: "Essentials-Linie - Hochleistungs-Filtrationssystem",
    premiumHeading: "Premium-Linie - Hochleistungs-Filtrationssystem",
    phHeading: "pH-Skala",
    labelAcido: "Sauer",
    labelNeutro: "Neutral",
  ...
  it: {
    essentialsHeading: "Linea Essentials - Sistema di Filtrazione ad Alta Efficienza",
    premiumHeading: "Linea Premium - Sistema di Filtrazione ad Alta Efficienza",
  ...
  zh: {
    essentialsHeading: "Essentials系列 - 高效能净水系统",
    premiumHeading: "Premium系列 - 高效能净水系统",
    phHeading: "pH值刻度",
    labelAcido: "酸性",
    labelNeutro: "中性",
    labelAlcalino: "碱性",
  ...
  ja: {
    essentialsHeading: "エッセンシャルライン - 高効率ろ過システム",
    premiumHeading: "プレミアムライン - 高効率ろ過システム",
    phHeading: "pH スケール",
    labelAcido: "酸性",
    labelNeutro: "中性",
    labelAlcalino: "アルカリ性",
  ...
  ko: {
    essentialsHeading: "에센셜 라인 - 고효율 여과 시스템",
    premiumHeading: "프리미엄 라인 - 고효율 여과 시스템",
    phHeading: "pH 척도",
    labelAcido: "산성",
    labelNeutro: "중성",
    labelAlcalino: "알칼리성",
