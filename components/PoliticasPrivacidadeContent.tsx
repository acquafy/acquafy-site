...
const T: Record<Lang, {
  ...
  pt: {
    ...
    nav: [
      ...
      { id: "contato",          label: "13. Encarregado de Proteção de Dados" },
    ],
    ...
    s13Title: "13. Encarregado de Proteção de Dados (DPO)",
    s13Intro: "Para quaisquer questões, pedidos ou reclamações relacionadas com esta Política de Privacidade ou com o tratamento dos seus dados pessoais, entre em contato com o nosso Encarregado de Proteção de Dados:",
    s13DpoTitle: "Encarregado de Proteção de Dados (DPO)",
    s13Labels: [["E-mail", "info@acquafy.com"], ["Empresa", "Acquafy Corporation"], ["Website", "acquafy.com/contact"]],
  ...
  en: {
    ...
    s13Labels: [["E-mail", "info@acquafy.com"], ["Company", "Acquafy Corporation"], ["Website", "acquafy.com/contact"]],
  ...
  "en-gb": {
    ...
    s7Items: [
      "Period during which you maintain an active account with our Services",
      "Legal and regulatory retention obligations (e.g. tax data for 5 years)",
      "Applicable limitation period for potential disputes or claims",
      "Need to maintain records for security and fraud prevention",
    ],
    s7Outro: "After the contractual relationship ends and the applicable retention period expires, data is securely deleted or anonymised.",
    s8Title: "8. Data Security",
    ...
    s9Rights: [
      { direito: "Confirmation and access", desc: "Know whether we process your data and obtain a copy." },
      { direito: "Correction", desc: "Request correction of incomplete, inaccurate or out-of-date data." },
      { direito: "Anonymisation / Blocking / Deletion", desc: "For unnecessary, excessive or unlawfully processed data." },
      { direito: "Portability", desc: "Receive your data in a structured format for transfer to another provider." },
      { direito: "Deletion", desc: "Request deletion of data processed based on your consent." },
      { direito: "Withdrawal of consent", desc: "Withdraw consent for processing based on that legal basis, at any time." },
    ...
    s9Outro1: "To exercise any of these rights, please contact us by email at",
    s9Outro2: ". We will respond within 15 working days, as required by the LGPD.",
    s10Title: "10. International Data Transfers",
    s10Intro: "Acquafy operates globally and may transfer your personal data to countries outside Brazil or the European Economic Area. In such cases, we ensure the transfer is carried out with appropriate safeguards:",
    s10Items: [
      "Standard contractual clauses approved by the European Commission and the ANPD",
  ...
  es: {
    ...
    s13Labels: [["E-mail", "info@acquafy.com"], ["Empresa", "Acquafy Corporation"], ["Sitio web", "acquafy.com/contact"]],
  ...
  fr: {
    ...
    s13Labels: [["E-mail", "info@acquafy.com"], ["Entreprise", "Acquafy Corporation"], ["Site web", "acquafy.com/contact"]],
  ...
  de: {
    ...
    s13Labels: [["E-Mail", "info@acquafy.com"], ["Unternehmen", "Acquafy Corporation"], ["Website", "acquafy.com/contact"]],
  ...
  it: {
    ...
    s13Labels: [["E-mail", "info@acquafy.com"], ["Azienda", "Acquafy Corporation"], ["Sito web", "acquafy.com/contact"]],
  ...
  zh: {
    ...
    s13Labels: [["电子邮件", "info@acquafy.com"], ["公司", "Acquafy Corporation"], ["网站", "acquafy.com/contact"]],
  ...
  ja: {
    ...
    s13Labels: [["メール", "info@acquafy.com"], ["会社名", "Acquafy Corporation"], ["ウェブサイト", "acquafy.com/contact"]],
  ...
  ko: {
    ...
    s13Labels: [["이메일", "info@acquafy.com"], ["회사", "Acquafy Corporation"], ["웹사이트", "acquafy.com/contact"]],
    s13Outro: "브라질 국가 데이터 보호 당국(ANPD) 또는 거주 국가의 관할 감독 기관에 불만을 제기할 권리도 있습니다.",
  },
  sv: {
    onThisPage: "Pa denna sida",
    nav: [
      { id: "controlador",      label: "1. Personuppgiftsansvarig" },
      { id: "coleta",           label: "2. Insamlade uppgifter" },
      { id: "finalidades",      label: "3. Andamal med behandlingen" },
      { id: "bases-legais",     label: "4. Rattsliga grunder" },
      { id: "compartilhamento", label: "5. Delning av uppgifter" },
      { id: "cookies",          label: "6. Cookies" },
      { id: "retencao",         label: "7. Lagring" },
      { id: "seguranca",        label: "8. Sakerhet" },
      { id: "direitos",         label: "9. Dina rattigheter" },
      { id: "transferencias",   label: "10. Internationella overforing" },
      { id: "menores",          label: "11. Minderariga" },
      { id: "alteracoes",       label: "12. Andring" },
      { id: "contato",          label: "13. Kontakt" },
    ],
    intro1: <><strong>Acquafy Corporation</strong> (&quot;Acquafy&quot;, &quot;vi&quot; eller &quot;var&quot;) ar engagerade i att skydda din integritet. Denna integritetspolicy beskriver hur vi behandlar personuppgifter som du tillhandahaller oss eller som vi samlar in nar du anvander var webbplats, plattform, applikation och ovriga tjanster (&quot;Tjanster&quot;).</>,
    intro2: "Denna policy uppfyller kraven i Brasiliens dataskyddslag (LGPD - lag nr 13.709/2018), Europeiska unionens allmanna dataskyddsforordning (GDPR) och ovrig tillamplig dataskyddslagstiftning.",
    s1Title: "1. Personuppgiftsansvarig",
    s1Intro: "Den ansvarige for behandlingen av dina personuppgifter ar:",
    s1Labels: [["Foretag", "Acquafy Corporation"], ["E-post", "info@acquafy.com"], ["Webbplats", "acquafy.com"]],
    s2Title: "2. Personuppgifter vi samlar in",
    s21Title: "2.1 Uppgifter du tillhandahaller",
    s21Items: [
      "Fullstandigt namn och e-postadress vid skapande av konto eller ifyllning av kontaktformular",
      "Adress- och leveransinformation for orderhantering",
      "Betalningsuppgifter (sakert behandlade av PCI-DSS-certifierade leverantorer)",
      "Meddelanden, fragor och forfragan skickade via vara supportkanaler",
      "Installningar och preferenser for ditt konto pa Acquafy-plattformen",
    ],
    s22Title: "2.2 Automatiskt insamlade uppgifter",
    s22Items: [
      "IP-adress, webblasartyp och operativsystem",
      "Besokta sidor, tid pa sidan och klick (navigeringsdata)",
      "Enhetsidentifierare och ungefarliq geografisk platsdata",
      "Anvandningsinformation for Acquafy-appen och telemetridata fran reningen (IoT)",
      "Cookies och liknande tekniker (detaljerade i avsnitt 6)",
    ],
    s23Title: "2.3 Uppgifter mottagna fran tredje part",
    s23Items: [
      "Information fran sociala natverk nar du valjer att autentisera via social inloggning",
      "Data fran distributionspartners for att stodja aterforstaljare och integratorer",
      "Identitetsverifieringsinformation fran godkanda tjanstleverantorer",
    ],
    s3Title: "3. Andamal med behandlingen",
    s3Intro: "Vi anvander dina personuppgifter for foljande andamal:",
    s3Items: [
      "Tillhandahallande av tjanster: skapande och hantering av konto, orderbehandling och produktleverans",
      "Kundsupport: svar pa fragor, underhallsforfragan och eftermarknadsservice",
      "Forbattring av tjanster: analys av anvandning av plattform, app och IoT-enheter for att forbattra funktioner",
      "Marknadskommunikation: utskick av nyhetsbrev, erbjudanden och nyheter med forhandssamtycke",
      "Rattsliga och regulatoriska skyldigheter: efterlevnad av tillampliga rattsliga, skattemassiga och regulatoriska krav",
      "Sakerhet och bedrageriforebyggande: upptackt av misstankta aktiviteter och skydd av tjansternas integritet",
      "Personalisering: erbjudande av innehall, rekommendationer och upplevelser anpassade till din profil",
    ],
    s4Title: "4. Rattsliga grunder for behandlingen",
    s4Intro: "Vi behandlar dina uppgifter med stod i foljande rattsliga grunder enligt LGPD och GDPR:",
    s4Bases: [
      { base: "Avtalsfullgorande", desc: "Behandling som ar nodvandig for att tillhandahalla de tjanster du har ingatt avtal om." },
      { base: "Rattslig skyldighet", desc: "Efterlevnad av skyldigheter i lag, forordningar eller myndighetsbeslut." },
      { base: "Legitimt intresse", desc: "Forbattring av tjanster, sakerhet, bedrageriforebyggande och institutionell kommunikation, forutsatt att detta inte asidosatter dina rattigheter." },
      { base: "Samtycke", desc: "Utskick av marknadskommunikation och anvandning av icke-nodvandiga cookies. Du kan ateralla ditt samtycke nar som helst." },
    ],
    s5Title: "5. Delning av uppgifter",
    s5Intro: "Vi saljer inte dina personuppgifter till tredje part. Vi kan dela dem enbart i foljande situationer:",
    s51Title: "5.1 Tjanstleverantorer",
    s51Text: "Vi delar uppgifter med leverantorer som hjalper oss att driva tjansterarna (betalningsbehandling, molnhotell, e-postutskick, dataanalys), alltid under ett databehandlingsavtal med sekretess- och sakerhetskyldigheter.",
    s52Title: "5.2 Distributionspartners",
    s52Text: "Godkanda aterforstaljare och integratorer i Acquafy-natverket kan ta emot uppgifter som ar nodvandiga for orderuppfyllelse, teknisk support och enhetsinstallation i din region.",
    s53Title: "5.3 Rattslig skyldighet",
    s53Text: "Vi kan lamna ut uppgifter nar detta kravs enligt lag, domstolsbeslut eller beholrig myndighet, eller nar det ar nodvandigt for att skydda Acquafys, vara anvandares eller tredje parts rattigheter och sakerhet.",
    s54Title: "5.4 Foretagsoverforing",
    s54Text: "Vid fusion, forvarv eller forsaljning av tillgangar kan uppgifter overforaras till den nya personuppgiftsansvarige, som blir bunden av skyldigheterna i denna policy.",
    s6Title: "6. Cookies och sparningstekniker",
    s6Intro: "Vi anvander cookies och liknande tekniker for att forbattra din upplevelse av vara tjanster. Cookies klassificeras som:",
    s6Cookies: [
      { tipo: "Nodvandiga", cor: "#0569ff", desc: "Kravs for webbplatsens och plattformens grundlaggande funktion (autentisering, sakerhet, sessionsinstellningar). Kan inte inaktiveras." },
      { tipo: "Analytiska", cor: "#7b5ea7", desc: "Hjalper oss att forsta hur besokare anvander webbplatsen (besokta sidor, tid pa sidan). Vi anvander verktyg som Google Analytics." },
      { tipo: "Funktionella", cor: "#0ab572", desc: "Sparar preferenser som sprak, plats och anpassade installningar for att forbattra din upplevelse." },
      { tipo: "Marknadsforing", cor: "#e05c00", desc: "Anvands for att visa relevant reklam och mata effektiviteten hos kampanjer. Kraver ditt forhandssamtycke." },
    ],
    s6Outro: "Du kan hantera dina cookieinstellningar nar som helst via webblasarinstellningarna eller samtyckespanelen pa var webbplats.",
    s7Title: "7. Lagring av uppgifter",
    s7Intro: "Vi bevarar dina personuppgifter sa lange som ar nodvandigt for att uppfylla de andamal som beskrivs i denna policy, om inte lagen kraver eller tillater en langre period. Kriterierna for att bestamma lagringsperioden innefattar:",
    s7Items: [
      "Period under vilken du upprattahaller ett aktivt konto i vara tjanster",
      "Rattsliga och regulatoriska lagringsskyldigheter (t.ex. skatteuppgifter i 5 ar)",
      "Tillamplig preskriptionstid for eventuella tvister eller krav",
      "Behov av att bevara poster for sakerhet och bedrageriforebyggande",
    ],
    s7Outro: "Efter att avtalsforhallandet avslutats och den tillampliga lagringsperioden lopt ut raderas uppgifterna sakert eller anonymiseras.",
    s8Title: "8. Datasakerhet",
    s8Intro: "Vi vidtar lampliga tekniska och organisatoriska atgarder for att skydda dina uppgifter mot obehohrig atkomst, forlust, forstoring eller otillborlig rojanande, inklusive:",
    s8Items: [
      "Kryptering vid overforing (TLS/HTTPS) och i vila for kansliga uppgifter",
      "Rollbaserade atkomstkontroller (RBAC) och multifaktorautentisering for interna system",
      "Kontinuerlig sakerhetsovervakning och sarbarhetshantering",
      "Regelmaessiga utbildnings- och medvetenhetsprogram om integritet for anstallda",
      "Rutiner for hantering av sakerhetshander med anmalan till myndigheter och registrerade nar lagen kraver det",
    ],
    s8Outro: "Inget system for dataoverforing eller datalagring ar till 100% sakert. Vid en incident som riskerar dina uppgifter kommer vi att underratta beholriga myndigheter och berorda registrerade inom lagstadgade tidsfrister.",
    s9Title: "9. Dina rattigheter som registrerad",
    s9Intro: "Enligt LGPD och annan tillamplig lagstiftning har du foljande rattigheter avseende dina personuppgifter:",
    s9Rights: [
      { direito: "Bekraftelse och atkomst", desc: "Ta reda pa om vi behandlar dina uppgifter och fa en kopia." },
      { direito: "Rattelse", desc: "Begara rattelse av ofullstandiga, felaktiga eller foraldrade uppgifter." },
      { direito: "Anonymisering / Blockering / Radering", desc: "For uppgifter som ar onodiga, overflodiga eller behandlade i strid med lagen." },
      { direito: "Portabilitet", desc: "Ta emot dina uppgifter i ett strukturerat format for overforing till en annan leverantor." },
      { direito: "Radering", desc: "Begara radering av uppgifter som behandlas baserat pa ditt samtycke." },
      { direito: "Aterkallande av samtycke", desc: "Ateralla samtycket till behandling baserat pa denna rattsliga grund nar som helst." },
      { direito: "Invandning", desc: "Invanda mot behandling baserad pa legitimt intresse nar det finns grundade skal." },
      { direito: "Information", desc: "Ta reda pa vilka enheter vi delar dina uppgifter med och de rattsliga grunder som anvands." },
    ],
    s9Outro1: "For att utova nagon av dessa rattigheter, kontakta oss via e-post pa",
    s9Outro2: ". Vi svarar inom 15 arbetsdagar i enlighet med LGPD:s krav.",
    s10Title: "10. Internationella uppgiftsovorforingar",
    s10Intro: "Acquafy verkar globalt och kan overfora dina personuppgifter till lander utanfor Brasilien eller Europeiska ekonomiska samarbetsomradet. I sadana fall sakerstaller vi att overforingen sker med lampliga skyddsatgarder:",
    s10Items: [
      "Standardavtalsklausuler godkanda av Europeiska kommissionen och ANPD",
      "Overforing till lander som erbjuder en tillracklig skyddsniva som erkants av beholrig myndighet",
      "Internationellt erkanda certifieringar och uppforandekoder",
      "Uttryckligt samtycke fran den registrerade nar det ar tillampligt",
    ],
    s11Title: "11. Minderariga",
    s11Text1: "Vara tjanster ar inte riktade till personer under 18 ar. Vi samlar inte avsiktligt in personuppgifter fran barn eller ungdomar. Om vi far kannedom om att vi har samlat in uppgifter fran en minderarig utan verifierbart foraldrasamtycke kommer vi omedelbart att radera dessa uppgifter.",
    s11Text2: "Om du ar vardnadshavare for ett barn och tror att det har lammnat personuppgifter till oss, vanligan kontakta oss via e-post pa",
    s12Title: "12. Andring av denna policy",
    s12Intro: "Vi kan uppdatera denna integritetspolicy periodiskt for att afspegla andring av vara tjanster, tillamplig lagstiftning eller vara integritetsmetoder. Nar vi gor vasentliga andringar meddelar vi via:",
    s12Items: [
      "En framtradande avisering pa var webbplats under en rimlig period",
      "E-postavisering till kontoinnehavare nar andringar ar betydande",
      "Uppdatering av datumet 'Senast uppdaterad' overst i denna policy",
    ],
    s12Outro: "Vi rekommenderar att du regelbundet granskar denna policy. Fortsatt anvandning av tjansterarna efter att andringar tratt i kraft innebar acceptans av dem.",
    s13Title: "13. Kontakt och dataskyddsombud (DPO)",
    s13Intro: "For fragor, forfragan eller klagomal rorande denna integritetspolicy eller behandlingen av dina personuppgifter, vanligan kontakta vart dataskyddsombud:",
    s13DpoTitle: "Dataskyddsombud (DPO)",
    s13Labels: [["E-post", "info@acquafy.com"], ["Foretag", "Acquafy Corporation"], ["Webbplats", "acquafy.com/contato"]],
    s13Outro: "Du har ocksa ratt att inge ett klagomal till Brasiliens nationella dataskyddsmyndighet (ANPD) eller den beholriga tillsynsmyndigheten i ditt bosattningsland.",
  },
  fi: {
    onThisPage: "Talla sivulla",
    nav: [
      { id: "controlador",      label: "1. Rekisterinpitaja" },
      { id: "coleta",           label: "2. Keratyt tiedot" },
      { id: "finalidades",      label: "3. Kasittelyn tarkoitukset" },
      { id: "bases-legais",     label: "4. Oikeudelliset perusteet" },
      { id: "compartilhamento", label: "5. Tietojen jakaminen" },
      { id: "cookies",          label: "6. Evasteet" },
      { id: "retencao",         label: "7. Sailytys" },
      { id: "seguranca",        label: "8. Turvallisuus" },
      { id: "direitos",         label: "9. Oikeutesi" },
      { id: "transferencias",   label: "10. Kansainvaliset siirrot" },
      { id: "menores",          label: "11. Alaikaiset" },
      { id: "alteracoes",       label: "12. Muutokset" },
      { id: "contato",          label: "13. Yhteystiedot" },
    ],
    intro1: <><strong>Acquafy Corporation</strong> (&quot;Acquafy&quot;, &quot;me&quot; tai &quot;meidaan&quot;) on sitoutunut suojelemaan yksityisyyttasi. Tama tietosuojakaytanto kuvaa, miten kasittelemme henkilotietoja, joita toimitat meille tai joita keraammme, kun kaytat verkkosivustoamme, alustaamme, sovellustamme ja muita palveluitamme (&quot;Palvelut&quot;).</>,
    intro2: "Tama kaytanto noudattaa Brasilian yleista tietosuojalakia (LGPD - laki nro 13.709/2018), Euroopan unionin yleista tietosuoja-asetusta (GDPR) ja muuta sovellettavaa tietosuojalainsaadantoa.",
    s1Title: "1. Rekisterinpitaja",
    s1Intro: "Henkilotietojesi kasittelysta vastaava rekisterinpitaja on:",
    s1Labels: [["Yritys", "Acquafy Corporation"], ["Sahkoposti", "info@acquafy.com"], ["Verkkosivusto", "acquafy.com"]],
    s2Title: "2. Keraamamme henkilotiedot",
    s21Title: "2.1 Sinun toimittamasi tiedot",
    s21Items: [
      "Taydellinen nimi ja sahkopostiosoite tilin luomisen tai yhteydenottolomakkeen tayttamisen yhteydessa",
      "Osoite- ja toimitustiedot tilausten kasittelya varten",
      "Maksutiedot (turvallisesti kasitelty PCI-DSS-sertifioitujen palveluntarjoajien toimesta)",
      "Viestit, kysymykset ja pyynnot, jotka on lahetetty tukikanaviemme kautta",
      "Acquafy-alustan tilin asetukset ja mieltymykset",
    ],
    s22Title: "2.2 Automaattisesti keratyt tiedot",
    s22Items: [
      "IP-osoite, selaintyyppi ja kayttojarjestelma",
      "Vieraillut sivut, sivulla vietetty aika ja napsautukset (selausdata)",
      "Laitetunnisteet ja likimaarainen sijaintidata",
      "Acquafy-sovelluksen kayttotiedot ja vedenpuhdistimen telemetriatiedot (IoT)",
      "Evasteet ja vastaavat teknologiat (kuvattu tarkemmin kohdassa 6)",
    ],
    s23Title: "2.3 Kolmansilta osapuolilta vastaanotetut tiedot",
    s23Items: [
      "Sosiaalisten verkostojen tiedot, kun valitset kirjautumisen sosiaalisen kirjautumisen kautta",
      "Jakelukumppaneiden tiedot jalkeeenmyyjien ja integraattoreiden tukemiseksi",
      "Henkilollisyyden varmistustiedot valtuutetuilta palveluntarjoajilta",
    ],
    s3Title: "3. Kasittelyn tarkoitukset",
    s3Intro: "Kayytamme henkilotietojasi seuraaviin tarkoituksiin:",
    s3Items: [
      "Palvelujen tarjoaminen: tilin luominen ja hallinta, tilausten kasittely ja tuotteiden toimitus",
      "Asiakastuki: kysymyksiin vastaaminen, huoltopyynnot ja jalleenmyyntipalvelu",
      "Palvelujen parantaminen: alustan, sovelluksen ja IoT-laitteiden kayton analysointi ominaisuuksien parantamiseksi",
      "Markkinointiviestinta: uutiskirjeiden, tarjousten ja uutisten lahettaminen ennakkosuostumuksella",
      "Oikeudelliset ja saantelyvelvoitteet: sovellettavien oikeudellisten, verotuksellisten ja saantelyvaatimusten noudattaminen",
      "Turvallisuus ja petostentorjunta: epailevan toiminnan havaitseminen ja palvelujen eheyden suojaaminen",
      "Personointi: profiiliisi raataloidun sisallon, suositusten ja kokemusten tarjoaminen",
    ],
    s4Title: "4. Kasittelyn oikeudelliset perusteet",
    s4Intro: "Kasittelemme tietojasi seuraavien LGPD:n ja GDPR:n mukaisten oikeudellisten perusteiden nojalla:",
    s4Bases: [
      { base: "Sopimuksen tayttaminen", desc: "Kasittely, joka on tarpeen sinulle sopimuksen perusteella tarjottavien palvelujen toimittamiseksi." },
      { base: "Oikeudellinen velvoite", desc: "Laissa, asetuksissa tai viranomaismaarayksissa saatety velvoitteiden noudattaminen." },
      { base: "Oikeutettu etu", desc: "Palvelujen parantaminen, turvallisuus, petostentorjunta ja institutionaalinen viestinta, edellyttaen etteivat ne syrjaytan oikeuksiasi." },
      { base: "Suostumus", desc: "Markkinointiviestinnan lahettaminen ja ei-valttamattomien evasteiden kayttaminen. Voit peruuttaa suostumuksesi milloin tahansa." },
    ],
    s5Title: "5. Tietojen jakaminen",
    s5Intro: "Emme myy henkilotietojasi kolmansille osapuolille. Voimme jakaa niita vain seuraavissa tilanteissa:",
    s51Title: "5.1 Palveluntarjoajat",
    s51Text: "Jaamme tietoja toimittajille, jotka auttavat meita palvelujen kayttamisessa (maksujen kasittely, pilvipalvelut, sahkopostin toimittaminen, data-analytiikka), aina tietojen kasittelyyn liittyvan sopimuksen alaisena, johon sisaltyvat luottamuksellisuus- ja turvallisuusvelvoitteet.",
    s52Title: "5.2 Jakelukumppanit",
    s52Text: "Acquafy-verkoston valtuutetut jalleenmyyjat ja integraattorit voivat vastaanottaa tietoja, jotka ovat tarpeen tilausten tayttamiseksi, tekniseksi tueksi ja laitteiden asennukseksi alueellasi.",
    s53Title: "5.3 Oikeudellinen velvoite",
    s53Text: "Voimme luovuttaa tietoja, kun laki, tuomioistuimen maarays tai toimivaltainen viranomainen sitae edellyttaa, tai kun se on tarpeen Acquafyn, kayttajiemme tai kolmansien osapuolten oikeuksien ja turvallisuuden suojaamiseksi.",
    s54Title: "5.4 Yrityssiirrot",
    s54Text: "Fuusion, yrityskaupan tai omaisuuserien myynnin yhteydessa tiedot voidaan siirtaa uudelle rekisterinpitajalle, jota sitovat taman kaytannon mukaiset velvoitteet.",
    s6Title: "6. Evasteet ja seurantateknologiat",
    s6Intro: "Kaytamme evasteia ja vastaavia teknologioita parantaaksemme kokemustasi palvelujemme kaytossa. Evasteet luokitellaan seuraavasti:",
    s6Cookies: [
      { tipo: "Valttamattomat", cor: "#0569ff", desc: "Tarvitaan verkkosivuston ja alustan perustoimintaan (todentaminen, turvallisuus, istuntoasetukset). Niita ei voi poistaa kaytosta." },
      { tipo: "Analyyttiset", cor: "#7b5ea7", desc: "Auttavat meita ymmartamaan, miten kaurjaat kayttavat sivustoa (vieraillut sivut, sivulla vietetty aika). Kaytamme tyokaluja kuten Google Analytics." },
      { tipo: "Toiminnalliset", cor: "#0ab572", desc: "Tallentavat mieltymyksia, kuten kielen, sijainnin ja mukautetut asetukset, kokemuksesi parantamiseksi." },
      { tipo: "Markkinointi", cor: "#e05c00", desc: "Kaytetaan relevanttien mainosten nayttamiseen ja kampanjoiden tehokkuuden mittaamiseen. Edellyttavat ennakkosuostumustasi." },
    ],
    s6Outro: "Voit hallita evastepreferenssejasi milloin tahansa selaimesi asetusten tai verkkosivustollamme saatavilla olevan suostumuspaneelin kautta.",
    s7Title: "7. Tietojen sailytys",
    s7Intro: "Sailytamme henkilotietojasi niin kauan kuin on tarpeen tassa kaytannossa kuvattujen tarkoitusten tayttamiseksi, ellei laki edellyta tai salli pitempaa aikaa. Sailytysajan maarittamiseen kaytetyt kriteerit sisaltavat:",
    s7Items: [
      "Jakso, jonka aikana sinulla on aktiivinen tili palveluksissamme",
      "Oikeudelliset ja saantelysailytysvelvoitteet (esim. verotiedot 5 vuoden ajan)",
      "Sovellettava vanhenumisaika mahdollisille riidoille tai vaatimuksille",
      "Tarve sailyttaa tietueita turvallisuutta ja petostentorjuntaa varten",
    ],
    s7Outro: "Sopimussuhtee paatyttya ja sovellettavan sailytysajan umpeuduttua tiedot poistetaan turvallisesti tai anonymisoidaan.",
    s8Title: "8. Tietoturva",
    s8Intro: "Toteutamme asianmukaisia teknisia ja organisatorisia toimenpiteita tietojesi suojaamiseksi luvattomalta kaytolta, menetykselta, tuhoamiselta tai asiattomalta paljastamiselta, mukaan lukien:",
    s8Items: [
      "Salaus siirron aikana (TLS/HTTPS) ja levossa arkaluonteisille tiedoille",
      "Roolipohjainen paasynhallinta (RBAC) ja monivaiheinen todentaminen sisaisiin jarjestelmiin",
      "Jatkuva turvallisuusvalvonta ja haavoittuvuuksien hallinta",
      "Saannolliset tietosuojakoulutus- ja tietoisuusohjelmat tyontekijoille",
      "Tietoturvapoikkeamien vastausmentelmat, mukaan lukien ilmoittaminen viranomaisille ja rekisteroityille lain vaatimalla tavalla",
    ],
    s8Outro: "Mikaan tiedonsiirto- tai tallennusjarjestelma ei ole 100-prosenttisesti turvallinen. Tietojasi vaarantavan tapahtuman sattuessa ilmoitamme toimivaltaisille viranomaisille ja asianomaisille rekisteroityille lain mukaisissa maarajoissa.",
    s9Title: "9. Oikeutesi rekisteroityna",
    s9Intro: "LGPD:n ja muun sovellettavan lainsaadannon mukaisesti sinulla on seuraavat oikeudet henkilotietojesi osalta:",
    s9Rights: [
      { direito: "Vahvistus ja paasy", desc: "Selvittaa, kasitelemmeko tietojasi, ja saada kopio niista." },
      { direito: "Oikaisu", desc: "Pyytaa puutteellisten, virheellisten tai vanhentuneiden tietojen korjaamista." },
      { direito: "Anonymisointi / Estaminen / Poistaminen", desc: "Tarpeettomien, liiallisten tai lainvastaisesti kasiteltyjen tietojen osalta." },
      { direito: "Siirrettavyys", desc: "Vastaanottaa tietosi jastennellyssa muodossa siirtamista varten toiselle palveluntarjoajalle." },
      { direito: "Poistaminen", desc: "Pyytaa suostumuksesi perusteella kasiteltyjen tietojen poistamista." },
      { direito: "Suostumuksen peruuttaminen", desc: "Peruuttaa suostumus kasittelyyn, joka perustuu tahan oikeudelliseen perusteeseen, milloin tahansa." },
      { direito: "Vastustaminen", desc: "Vastustaa oikeutettuun etuun perustuvaa kasittelya, kun sille on perustellut syyt." },
      { direito: "Tiedonsaanti", desc: "Selvittaa, mille tahoille jaamme tietojasi ja mita oikeudellisia perusteita kaytetaan." },
    ],
    s9Outro1: "Kayttaaksesi jotain naista oikeuksista, ota meihiin yhteys sahkopostitse osoitteessa",
    s9Outro2: ". Vastaamme 15 tyopaivan kuluessa LGPD:n vaatimusten mukaisesti.",
    s10Title: "10. Kansainvaliset tiedonsiirrot",
    s10Intro: "Acquafy toimii maailmanlaajuisesti ja saattaa siirtaa henkilotietojasi maihin, jotka sijaitsevat Brasilian tai Euroopan talousalueen ulkopuolella. Tallaissa tapauksissa varmistamme, etta siirto tapahtuu asianmukaisilla suojatoimilla:",
    s10Items: [
      "Euroopan komission ja ANPD:n hyvaksymat vakiosopimuslausekkeet",
      "Siirto maihin, jotka tarjoavat toimivaltaisen viranomaisen tunnustaman riittavan suojan tason",
      "Kansainvalisesti tunnustetut sertifioinnit ja kayttaytymissaannot",
      "Rekisteroityn nimenomainen suostumus tarvittaessa",
    ],
    s11Title: "11. Alaikaiset",
    s11Text1: "Palvelumme eivat ole tarkoitettu alle 18-vuotiaille. Emme kerae tarkoituksellisesti lasten tai nuorten henkilotietoja. Jos saamme tietaa keranneemme tietoja alaikaiselta ilman todennettavissa olevaa vanhempien suostumusta, poistamme nama tiedot valittomasti.",
    s11Text2: "Jos olet lapsen huoltaja ja uskot lapsen toimittaneen meille henkilotietoja, ota meihin yhteys sahkopostitse osoitteessa",
    s12Title: "12. Muutokset tahan kaytantoon",
    s12Intro: "Saatamme paivittaa tata tietosuojakaytantoa satunnaisesti kuvastaaksemme muutoksia palveluksissamme, sovellettavassa lainsaadannossa tai tietosuojakaytannoissamma. Kun teemme olennaisia muutoksia, ilmoitamme niista:",
    s12Items: [
      "Nakyva ilmoitus verkkosivustollamme kohtuullisen ajanjakson ajan",
      "Sahkopostitilmoitus tilinhaltijoille, kun muutokset ovat merkittavia",
      "Taman kaytannon ylalaidassa olevan 'Viimeksi paivitetty' -paivamaaran paivitys",
    ],
    s12Outro: "Suosittelemme, etta tarkistat taman kaytannon saannollisesti. Palvelujen jatkuva kayttaminen muutosten voimaantulon jalkeen merkitsee niiden hyvaksymista.",
    s13Title: "13. Yhteystiedot ja tietosuojavastaava (DPO)",
    s13Intro: "Tata tietosuojakaytantoa tai henkilotietojesi kasittelya koskevissa kysymyksissa, pyynnnoissa tai valituksissa ota yhteys tietosuojavastaavaamme:",
    s13DpoTitle: "Tietosuojavastaava (DPO)",
    s13Labels: [["Sahkoposti", "info@acquafy.com"], ["Yritys", "Acquafy Corporation"], ["Verkkosivusto", "acquafy.com/contato"]],
    s13Outro: "Sinulla on myos oikeus tehda valitus Brasilian kansalliselle tietosuojaviranomaiselle (ANPD) tai asuinmaasi toimivaltaiselle valvontaviranomaiselle.",
  },
  ru: {
    onThisPage: "Na etoj stranice",
    nav: [
      { id: "controlador",      label: "1. Operator personalnyh dannyh" },
      { id: "coleta",           label: "2. Sobirayemye dannye" },
      { id: "finalidades",      label: "3. Celi obrabotki" },
      { id: "bases-legais",     label: "4. Pravovye osnovaniya" },
      { id: "compartilhamento", label: "5. Peredacha dannyh" },
      { id: "cookies",          label: "6. Fajly cookie" },
      { id: "retencao",         label: "7. Hranenie" },
      { id: "seguranca",        label: "8. Bezopasnost" },
      { id: "direitos",         label: "9. Vashi prava" },
      { id: "transferencias",   label: "10. Mezhdunarodnye peredachi" },
      { id: "menores",          label: "11. Nesovershennoletnie" },
      { id: "alteracoes",       label: "12. Izmeneniya" },
      { id: "contato",          label: "13. Kontakty" },
    ],
    intro1: <><strong>Acquafy Corporation</strong> (&quot;Acquafy&quot;, &quot;my&quot; ili &quot;nashe&quot;) priverzhjona zashchite vashej privatnosti. Nastoyashchaya Politika konfidentsialnosti opisyvaet, kak my obrabatyvaem personalnye dannye, kotorye vy nam predostavlyaete ili kotorye my sobiraem, kogda vy ispolzuete nash sajt, platformu, prilozhenie i drugie servisy (&quot;Servisy&quot;).</>,
    intro2: "Nastoyashchaya politika sootvetstvuet brazilskomu Zakonu o zashchite personalnyh dannyh (LGPD - Zakon no 13.709/2018), Obshchemu reglamentu ES po zashchite dannyh (GDPR) i inomu primenimomu zakonodatelstvu o konfidentsialnosti i zashchite dannyh.",
    s1Title: "1. Operator personalnyh dannyh",
    s1Intro: "Operatorom, otvetstvennym za obrabotku vashih personalnyh dannyh, yavlyaetsya:",
    s1Labels: [["Kompaniya", "Acquafy Corporation"], ["E-mail", "info@acquafy.com"], ["Sajt", "acquafy.com"]],
    s2Title: "2. Personalnye dannye, kotorye my sobiraem",
    s21Title: "2.1 Dannye, predostavlyaemye vami",
    s21Items: [
      "Polnoe imya i adres elektronnoj pochty pri sozdanii uchyotnoj zapisi ili zapolnenii kontaktnyh form",
      "Adres i svedeniya o dostavke dlya obrabotki zakazov",
      "Platezhnye dannye (bezopasno obrabatyvaemye PCI-DSS-sertificirovannymi postavshchikami)",
      "Soobshcheniya, voprosy i zaprosy, otpravlennye cherez nashi kanaly podderzhki",
      "Nastrojki i predpochteniya vashej uchyotnoj zapisi na platforme Acquafy",
    ],
    s22Title: "2.2 Avtomaticheski sobirayemye dannye",
    s22Items: [
      "IP-adres, tip brauzera i operatsionnaya sistema",
      "Prosmotrennye stranitsy, vremya prebyvaniya i kliki (dannye brauzinga)",
      "Identifikatory ustrojstv i pribliziternye dannye geolokatsii",
      "Informatsiya ob ispolzovanii prilozheniya Acquafy i telemetricheskie dannye ochistitelya (IoT)",
      "Fajly cookie i analogichnye tekhnologii (podrobno opisany v razdele 6)",
    ],
    s23Title: "2.3 Dannye, poluchennye ot tretih lits",
    s23Items: [
      "Informatsiya iz sotsialnykh setej, kogda vy vybiraete autentifikatsiyu cherez sotsialnyj vhod",
      "Dannye ot distribucionnykh partnyorov dlya podderzhki dilerov i integratorov",
      "Informatsiya dlya verifikatsii lichnosti ot avtorizovannykh postavshchikov uslug",
    ],
    s3Title: "3. Tseli obrabotki",
    s3Intro: "My ispolzuem vashi personalnye dannye dlya sleduyushchikh tselej:",
    s3Items: [
      "Predostavlenie servisov: sozdanie i upravlenie uchyotnoj zapisyu, obrabotka zakazov i dostavka produktov",
      "Podderzhka klientov: otvety na voprosy, zayavki na obsluzhivanie i posleprodazhnoe obsluzhivanie",
      "Uluchshenie servisov: analiz ispolzovaniya platformy, prilozheniya i IoT-ustrojstv dlya sovershenstvovaniya funktsij",
      "Marketingovye kommunikatsii: rassylka byulletenej, predlozhenij i novostej s predvaritelnym soglasiem",
      "Yuridicheskie i regulyatornye obyazannosti: soblyudenie primenimykh trebovanij zakona, nalogooblozheniya i regulirovaniya",
      "Bezopasnost i predotvrashchenie moshennichestva: vyyavlenie podozritelnoj aktivnosti i zashchita tselostnosti servisov",
      "Personalizatsiya: predlozhenie kontenta, rekomendatsij i vpechatlenij, adaptirovannykh k vashemu profilyu",
    ],
    s4Title: "4. Pravovye osnovaniya dlya obrabotki",
    s4Intro: "My obrabatyvaem vashi dannye na osnove sleduyushchikh pravovykh osnovanij v sootvetstvii s LGPD i GDPR:",
    s4Bases: [
      { base: "Ispolnenie dogovora", desc: "Obrabotka, neobhodimaya dlya predostavleniya zaklyuchyonnykh vami Servisov." },
      { base: "Yuridicheskoe obyazatelstvo", desc: "Soblyudenie obyazatelstv, predusmotrennykh zakonom, normativnymi aktami ili predpisaniyami organov vlasti." },
      { base: "Zakonnyj interes", desc: "Uluchshenie Servisov, bezopasnost, predotvrashchenie moshennichestva i institutsionalnye kommunikatsii, pri uslovii, chto eto ne narushayot vashi prava." },
      { base: "Soglasie", desc: "Otpravka marketingovykh soobshchenij i ispolzovanie neobyzatelnykh fajlov cookie. Vy mozhete otozvat soglasie v lyuboe vremya." },
    ],
    s5Title: "5. Peredacha dannyh",
    s5Intro: "My ne prodayom vashi personalnye dannye tretim litsam. My mozhem peredat ikh tolko v sleduyushchikh situatsiyakh:",
    s51Title: "5.1 Postavshchiki uslug",
    s51Text: "My peredayom dannye postavshchikam, kotorye pomogayut nam ekspluatirovat Servisy (obrabotka platezhej, oblachnyj hosting, dostavka elektronnoj pochty, analiz dannyh), vsegda v ramkah dogovora ob obrabotke dannyh s obyazatelstvami konfidentsialnosti i bezopasnosti.",
    s52Title: "5.2 Distributsionnye partnyory",
    s52Text: "Avtorizovannye dilery i integratory v seti Acquafy mogut poluchat dannye, neobhodimye dlya vypolneniya zakazov, tehnicheskoj podderzhki i ustanovki ustrojstv v vashem regione.",
    s53Title: "5.3 Yuridicheskoe obyazatelstvo",
    s53Text: "My mozhem raskryvat dannye, kogda etogo trebuet zakon, reshenie suda ili kompetentnyj organ, ili kogda eto neobhodimo dlya zashchity prav i bezopasnosti Acquafy, nashih polzovatelej ili tretih lits.",
    s54Title: "5.4 Korporativnye peredachi",
    s54Text: "V sluchae sliyaniya, pogloshcheniya ili prodazhi aktivov dannye mogut byt peredany novomu operatoru, kotoryj budet svyazan obyazatelstvami nastoyashchej politiki.",
    s6Title: "6. Fajly cookie i tekhnologii otslezhivaniya",
    s6Intro: "My ispolzuem fajly cookie i analogichnye tekhnologii dlya uluchsheniya vashego opyta ispolzovaniya nashih Servisov. Fajly cookie klassifitsiruyutsya kak:",
    s6Cookies: [
      { tipo: "Neobhodimye", cor: "#0569ff", desc: "Neobhodimy dlya osnovnoj raboty sajta i platformy (autentifikatsiya, bezopasnost, nastrojki sessii). Ne mogut byt otklyucheny." },
      { tipo: "Analiticheskie", cor: "#7b5ea7", desc: "Pozvolyayut nam ponimat, kak posetiteli ispolzuyut sajt (prosmotrennye stranitsy, vremya prebyvaniya). My ispolzuem instrumenty, takie kak Google Analytics." },
      { tipo: "Funktsionalnye", cor: "#0ab572", desc: "Hranyat predpochteniya, takie kak yazyk, mestopolozhenie i personalizirovannye nastrojki, dlya uluchsheniya vashego opyta." },
      { tipo: "Marketing", cor: "#e05c00", desc: "Ispolzuyutsya dlya otobrazheniya relevantnoj reklamy i otsenki effektivnosti kampanij. Trebuyut vashego predvaritelnogo soglasiya." },
    ],
    s6Outro: "Vy mozhete upravlyat nastrojkami fajlov cookie v lyuboe vremya cherez nastrojki brauzera ili panel soglasiya, dostupnuyu na nashem sajte.",
    s7Title: "7. Hranenie dannyh",
    s7Intro: "My hraniim vashi personalnye dannye stolko, skolko neobhodimo dlya dostizheniya tselej, opisannykh v nastoyashchej politike, esli zakon ne trebuet ili ne pozvolyaet bolshe dlinnogo perioda. Kriterii dlya opredeleniya srokov hraneniya vklyuchayut:",
    s7Items: [
      "Period, v techenie kotorogo vy podderzhivaete aktivnuyu uchyotnuyu zapis v nashih Servisah",
      "Yuridicheskie i normativnye obyazatelstva po hraneniyu (napr.: nalogovye dannye v techenie 5 let)",
      "Primenimyj srok davnosti dlya vozmozhnykh sporov ili pretenzij",
      "Neobhodimost hraneniya zapisej dlya bezopasnosti i preduprezhdeniya moshennichestva",
    ],
    s7Outro: "Posle okonchaniya dogovornykh otnoshenij i istecheniya primenimogo sroka hraneniya dannye bezopasno udalyayutsya ili anonimiziruutsya.",
    s8Title: "8. Bezopasnost dannyh",
    s8Intro: "My prinimaem nadlezhashchie tehnicheskie i organizatsionnye mery dlya zashchity vashih dannyh ot nesanktsionnirovannogo dostupa, poteri, unichtozheniya ili nenadlezhashchego raskrytiya, vklyuchaya:",
    s8Items: [
      "Shifrovanie pri peredache (TLS/HTTPS) i v sostoyanii pokoya dlya konfidentsialnyh dannyh",
      "Upravlenie dostupom na osnove rolej (RBAC) i mnozhestvennaya autentifikatsiya dlya vnutrennikh sistem",
      "Nepreryvnyj monitoring bezopasnosti i upravlenie uyazzvimostyami",
      "Regulyarnye programmy obucheniya i povysheniya osvedomlyonnosti sotrudnikov v oblasti konfidentsialnosti",
      "Protsedury reagirovaniya na intsidenty bezopasnosti s uvedomleniem organov i subektov dannyh, kogda etogo trebuet zakon",
    ],
    s8Outro: "Ni odna sistema peredachi ili hraneniya dannyh ne yavlyaetsya na 100% bezopasnoj. V sluchae intsidenta, stavyashchego pod ugrozu vashi dannye, my uvedomim kompetentnyye organy i zatronutykh subektov dannyh v zakonodatelno ustanovlennye sroki.",
    s9Title: "9. Vashi prava kak subekta dannyh",
    s9Intro: "V sootvetstvii s LGPD i inym primenimym zakonodatelstvom vy imeete sleduyushchie prava v otnoshenii vashih personalnyh dannyh:",
    s9Rights: [
      { direito: "Podtverzhdenie i dostup", desc: "Uznat, obrabatyvaem li my vashi dannye, i poluchit ikh kopiyu." },
      { direito: "Ispravlenie", desc: "Potrebovat ispravleniya nepolnykh, netochnykh ili ustarevshih dannyh." },
      { direito: "Anonimizatsiya / Blokirovanie / Udalenie", desc: "Dlya dannyh, kotorye yavlyayutsya nenuzhnymi, izbytochnymi ili nezakonno obrabotannymi." },
      { direito: "Perenosimost", desc: "Poluchit vashi dannye v strukturirovannom formate dlya peredachi drugomu postavshchiku." },
      { direito: "Udalenie", desc: "Potrebovat udaleniya dannyh, obrabatyvaemykh na osnove vashego soglasiya." },
      { direito: "Otzov soglasiya", desc: "Otozvat soglasie na obrabotku na osnove etogo pravovogo osnovaniya v lyuboe vremya." },
      { direito: "Vozrazhenie", desc: "Vozrazhat protiv obrabotki na osnove zakonnogo interesa pri nalichii obosnovannykh prichin." },
      { direito: "Informatsiya", desc: "Uznat, s kakimi subyektami my delimsya vashimi dannymi i kakie pravovye osnovaniya ispolzuyutsya." },
    ],
    s9Outro1: "Chtoby vospolzovatsya lyubym iz etih prav, svyazhites s nami po elektronnoj pochte na adres",
    s9Outro2: ". My otvetim v techenie 15 rabochih dnej v sootvetstvii s trebovaniyami LGPD.",
    s10Title: "10. Mezhdunarodnye peredachi dannyh",
    s10Intro: "Acquafy dejstvuet v globalnom masshtabe i mozhet peredavat vashi personalnye dannye v strany za predelami Brazilii ili Evropejskogo ekonomicheskogo prostranstva. V takih sluchayah my garantiruem, chto peredacha osushchestvlyaetsya s nadlezhashchimi mekhanizmami zashchity:",
    s10Items: [
      "Standartnye dogovornye klauzy, odobrennye Evropejskoj komissiej i ANPD",
      "Peredacha v strany, kotorye obespecheivayut nadlezhashchij uroven zashchity, priznannyj kompetentnym organom",
      "Mezhdunarodno priznanye sertifikatsii i kodeksy povedeniya",
      "Yavnoe soglasie subekta dannyh, gde eto primenimo",
    ],
    s11Title: "11. Nesovershennoletnie",
    s11Text1: "Nashi Servisy ne prednaznacheny dlya lits mladshe 18 let. My prednamerenno ne sobiraem personalnye dannye detej ili podrostkov. Esli my uznaem, chto sobrali dannye nesovershennoletnego bez proveryaemogo soglasiya roditelej, my nemedlenno udalim eti dannye.",
    s11Text2: "Esli vy yavlyaetes opekinom rebyonka i schitaete, chto on predostavil nam personalnye dannye, svyazhites s nami po elektronnoj pochte na adres",
    s12Title: "12. Izmeneniya nastoyashchej politiki",
    s12Intro: "My mozhem periodicheski obnovlyat nastoyashchuyu Politiku konfidentsialnosti, chtoby otrazhat izmeneniya v nashikh Servisah, primenimom zakonodatelstve ili nashih praktikah konfidentsialnosti. Kogda my vnosim sushchestvennye izmeneniya, my uvedomlyaem cherez:",
    s12Items: [
      "Vydayushcheesya uvedomlenie na nashem sajte v techenie razumnogo perioda",
      "Uvedomlenie po elektronnoj pochte vladeltcam uchyotnykh zapisej, kogda izmeneniya znachitelny",
      "Obnovlenie daty 'Poslednego obnovleniya' v verhnej chasti nastoyashchej politiki",
    ],
    s12Outro: "Rekomenduyem vam regulyarno prosmatrivat nastoyashchuyu politiku. Prodolzhenie ispolzovaniya Servisov posle vstupleniya v silu izmenenij oznachaet ikh prinyatie.",
    s13Title: "13. Kontakty i ofitser po zashchite dannyh (DPO)",
    s13Intro: "Po lyubym voprosam, zaprosam ili zhalobam, svyazannym s nastoyashchej Politikoj konfidentsialnosti ili obrabotkoj vashih personalnyh dannyh, obrashchajtes k nashemu Ofitseru po zashchite dannyh:",
    s13DpoTitle: "Ofitser po zashchite dannyh (DPO)",
    s13Labels: [["E-mail", "info@acquafy.com"], ["Kompaniya", "Acquafy Corporation"], ["Sajt", "acquafy.com/contato"]],
    s13Outro: "Vy takzhe imeete pravo podavat zhalobu v Natsionalnoe agentstvo po zashchite dannyh Brazilii (ANPD) ili v kompetentnyj nadzornyj organ v strane vashego prozhivaniya.",
  },
  ro: {
    onThisPage: "Pe aceasta pagina",
    nav: [
      { id: "controlador",      label: "1. Operatorul de date" },
      { id: "coleta",           label: "2. Date colectate" },
      { id: "finalidades",      label: "3. Scopurile prelucrarii" },
      { id: "bases-legais",     label: "4. Temeiuri juridice" },
      { id: "compartilhamento", label: "5. Partajarea datelor" },
      { id: "cookies",          label: "6. Cookie-uri" },
      { id: "retencao",         label: "7. Retentia" },
      { id: "seguranca",        label: "8. Securitate" },
      { id: "direitos",         label: "9. Drepturile tale" },
      { id: "transferencias",   label: "10. Transferuri internationale" },
      { id: "menores",          label: "11. Minori" },
      { id: "alteracoes",       label: "12. Modificari" },
      { id: "contato",          label: "13. Contact" },
    ],
    intro1: <><strong>Acquafy Corporation</strong> (&quot;Acquafy&quot;, &quot;noi&quot; sau &quot;nostru&quot;) este angajata in protejarea confidentialitatii tale. Aceasta Politica de Confidentialitate descrie modul in care prelucram datele cu caracter personal pe care ni le furnizezi sau pe care le colectam atunci cand utilizezi site-ul nostru web, platforma, aplicatia si alte servicii (&quot;Servicii&quot;).</>,
    intro2: "Aceasta politica este conforma cu Legea generala braziliana privind protectia datelor (LGPD - Legea nr. 13.709/2018), Regulamentul general al Uniunii Europene privind protectia datelor (GDPR) si alte legislatii aplicabile in materie de confidentialitate si protectia datelor.",
    s1Title: "1. Operatorul de date",
    s1Intro: "Operatorul responsabil pentru prelucrarea datelor tale cu caracter personal este:",
    s1Labels: [["Companie", "Acquafy Corporation"], ["E-mail", "info@acquafy.com"], ["Site web", "acquafy.com"]],
    s2Title: "2. Date cu caracter personal pe care le colectam",
    s21Title: "2.1 Date pe care le furnizezi tu",
    s21Items: [
      "Numele complet si adresa de e-mail la crearea unui cont sau completarea formularelor de contact",
      "Informatii de adresa si livrare pentru procesarea comenzilor",
      "Date de plata (procesate in mod securizat de catre furnizori certificati PCI-DSS)",
      "Mesaje, intrebari si solicitari trimise prin canalele noastre de asistenta",
      "Preferintele si setarile contului tau pe Platforma Acquafy",
    ],
    s22Title: "2.2 Date colectate automat",
    s22Items: [
      "Adresa IP, tipul de browser si sistemul de operare",
      "Paginile vizitate, timpul petrecut pe pagina si clicurile (date de navigare)",
      "Identificatori de dispozitiv si date de geolocalizare aproximativa",
      "Informatii despre utilizarea aplicatiei Acquafy si date de telemetrie ale purificatorului (IoT)",
      "Cookie-uri si tehnologii similare (detaliate in Sectiunea 6)",
    ],
    s23Title: "2.3 Date primite de la terti",
    s23Items: [
      "Informatii din retelele sociale atunci cand optezi pentru autentificarea prin autentificare sociala",
      "Date de la partenerii de distributie pentru a sprijini dealerii si integratorii",
      "Informatii de verificare a identitatii de la furnizori de servicii autorizati",
    ],
    s3Title: "3. Scopurile prelucrarii",
    s3Intro: "Utilizam datele tale cu caracter personal in urmatoarele scopuri:",
    s3Items: [
      "Furnizarea Serviciilor: crearea si gestionarea contului, procesarea comenzilor si livrarea produselor",
      "Asistenta pentru clienti: raspunsuri la intrebari, solicitari de intretinere si servicii post-vanzare",
      "Imbunatatirea Serviciilor: analiza utilizarii platformei, aplicatiei si dispozitivelor IoT pentru a imbunatati functionalitati",
      "Comunicari de marketing: trimiterea de buletine informative, oferte si noutati, cu consimtamant prealabil",
      "Obligatii juridice si de reglementare: respectarea cerintelor legale, fiscale si de reglementare aplicabile",
      "Securitate si prevenirea fraudelor: detectarea activitatilor suspecte si protejarea integritatii Serviciilor",
      "Personalizare: oferirea de continut, recomandari si experiente adaptate profilului tau",
    ],
    s4Title: "4. Temeiuri juridice pentru prelucrare",
    s4Intro: "Prelucram datele tale in temeiul urmatoarelor baze juridice prevazute de LGPD si GDPR:",
    s4Bases: [
      { base: "Executarea unui contract", desc: "Prelucrare necesara pentru furnizarea Serviciilor contractate de tine." },
      { base: "Obligatie juridica", desc: "Respectarea obligatiilor prevazute de lege, regulamente sau dispozitii ale autoritatilor." },
      { base: "Interes legitim", desc: "Imbunatatirea Serviciilor, securitate, prevenirea fraudelor si comunicari institutionale, cu conditia sa nu prevaleze asupra drepturilor tale." },
      { base: "Consimtamant", desc: "Trimiterea comunicarilor de marketing si utilizarea cookie-urilor neesential. Iti poti retrage consimtamantul oricand." },
    ],
    s5Title: "5. Partajarea datelor",
    s5Intro: "Nu vindem datele tale cu caracter personal catre terti. Le putem partaja numai in urmatoarele situatii:",
    s51Title: "5.1 Furnizori de servicii",
    s51Text: "Partajam datele cu furnizori care ne ajuta sa operam Serviciile (procesarea platilor, gazduire in cloud, trimitere de e-mailuri, analiza datelor), intotdeauna in baza unui acord de prelucrare a datelor cu obligatii de confidentialitate si securitate.",
    s52Title: "5.2 Parteneri de distributie",
    s52Text: "Dealerii si integratorii autorizati din reteaua Acquafy pot primi datele necesare pentru onorarea comenzilor, asistenta tehnica si instalarea dispozitivelor in zona ta.",
    s53Title: "5.3 Obligatie juridica",
    s53Text: "Putem dezvalui date atunci cand acest lucru este cerut de lege, decizie judecatoreasca sau autoritate competenta, ori cand este necesar pentru a proteja drepturile si securitatea Acquafy, utilizatorilor nostri sau ale tertilor.",
    s54Title: "5.4 Transferuri corporative",
    s54Text: "In cazul unei fuziuni, achizitii sau vanzari de active, datele pot fi transferate noului operator, care va fi obligat de obligatiile din aceasta politica.",
    s6Title: "6. Cookie-uri si tehnologii de urmarire",
    s6Intro: "Utilizam cookie-uri si tehnologii similare pentru a imbunatati experienta ta cu Serviciile noastre. Cookie-urile sunt clasificate astfel:",
    s6Cookies: [
      { tipo: "Esentiale", cor: "#0569ff", desc: "Necesare pentru functionarea de baza a site-ului web si a platformei (autentificare, securitate, preferinte de sesiune). Nu pot fi dezactivate." },
      { tipo: "Analitice", cor: "#7b5ea7", desc: "Ne permit sa intelegem cum utilizeaza vizitatorii site-ul (pagini vizitate, timp petrecut). Utilizam instrumente precum Google Analytics." },
      { tipo: "Functionale", cor: "#0ab572", desc: "Stocheaza preferinte precum limba, locatia si setarile personalizate pentru a imbunatati experienta ta." },
      { tipo: "Marketing", cor: "#e05c00", desc: "Utilizate pentru a afisa publicitate relevanta si a masura eficacitatea campaniilor. Necesita consimtamantul tau prealabil." },
    ],
    s6Outro: "Poti gestiona preferintele tale privind cookie-urile oricand prin setarile browserului sau panoul de consimtamant disponibil pe site-ul nostru.",
    s7Title: "7. Retentia datelor",
    s7Intro: "Pastram datele tale cu caracter personal pentru perioada necesara realizarii scopurilor descrise in aceasta politica, cu exceptia cazului in care legea impune sau permite o perioada mai lunga. Criteriile utilizate pentru determinarea perioadelor de retentie includ:",
    s7Items: [
      "Perioada in care mentii un cont activ in Serviciile noastre",
      "Obligatii legale si de reglementare privind retentia (ex.: date fiscale timp de 5 ani)",
      "Termenul de prescriptie aplicabil pentru potentiale dispute sau reclamatii",
      "Necesitatea de a pastra inregistrari pentru securitate si prevenirea fraudelor",
    ],
    s7Outro: "Dupa incetarea relatiei contractuale si expirarea perioadei de retentie aplicabile, datele sunt sterse in mod securizat sau anonimizate.",
    s8Title: "8. Securitatea datelor",
    s8Intro: "Adoptam masuri tehnice si organizatorice adecvate pentru a proteja datele tale impotriva accesului neautorizat, pierderii, distrugerii sau dezvaluirii necorespunzatoare, inclusiv:",
    s8Items: [
      "Criptare in tranzit (TLS/HTTPS) si in repaus pentru datele sensibile",
      "Controale de acces bazate pe roluri (RBAC) si autentificare multifactor pentru sistemele interne",
      "Monitorizare continua a securitatii si gestionarea vulnerabilitatilor",
      "Programe regulate de formare si constientizare a angajatilor privind confidentialitatea",
      "Proceduri de raspuns la incidente de securitate cu notificarea autoritatilor si persoanelor vizate, atunci cand legea o impune",
    ],
    s8Outro: "Niciun sistem de transmitere sau stocare a datelor nu este 100% sigur. In cazul unui incident care pune in pericol datele tale, vom notifica autoritatile competente si persoanele vizate in termenele legale.",
    s9Title: "9. Drepturile tale ca persoana vizata",
    s9Intro: "In conformitate cu LGPD si alte legi aplicabile, ai urmatoarele drepturi cu privire la datele tale cu caracter personal:",
    s9Rights: [
      { direito: "Confirmare si acces", desc: "Sa stii daca prelucram datele tale si sa obtii o copie a acestora." },
      { direito: "Rectificare", desc: "Sa soliciti corectarea datelor incomplete, inexacte sau invechite." },
      { direito: "Anonimizare / Blocare / Stergere", desc: "Pentru datele inutile, excesive sau prelucrate ilegal." },
      { direito: "Portabilitate", desc: "Sa primesti datele intr-un format structurat pentru transfer la un alt furnizor." },
      { direito: "Stergere", desc: "Sa soliciti stergerea datelor prelucrate pe baza consimtamantului tau." },
      { direito: "Retragerea consimtamantului", desc: "Sa retragi consimtamantul pentru prelucrarea bazata pe acel temei juridic, oricand." },
      { direito: "Opozitie", desc: "Sa te opui prelucrarii bazate pe interes legitim atunci cand exista motive justificate." },
      { direito: "Informare", desc: "Sa stii cu ce entitati partajam datele tale si temeiurile juridice utilizate." },
    ],
    s9Outro1: "Pentru a exercita oricare dintre aceste drepturi, contacteaza-ne prin e-mail la",
    s9Outro2: ". Vom raspunde in termen de 15 zile lucratoare, conform cerintelor LGPD.",
    s10Title: "10. Transferuri internationale de date",
    s10Intro: "Acquafy opereaza la nivel global si poate transfera datele tale cu caracter personal catre tari din afara Braziliei sau a Spatiului Economic European. In astfel de cazuri, garantam ca transferul se efectueaza cu garantii adecvate:",
    s10Items: [
      "Clauze contractuale standard aprobate de Comisia Europeana si ANPD",
      "Transfer catre tari care ofera un nivel adecvat de protectie recunoscut de autoritatea competenta",
      "Certificari si coduri de conduita recunoscute la nivel international",
      "Consimtamantul explicit al persoanei vizate, dupa caz",
    ],
    s11Title: "11. Minori",
    s11Text1: "Serviciile noastre nu sunt destinate persoanelor sub 18 ani. Nu colectam intentionat date cu caracter personal ale copiilor sau adolescentilor. Daca aflam ca am colectat date ale unui minor fara consimtamantul parental verificabil, vom sterge imediat aceste date.",
    s11Text2: "Daca esti tutorele unui copil si crezi ca acesta ne-a furnizat date cu caracter personal, te rugam sa ne contactezi prin e-mail la",
    s12Title: "12. Modificari ale acestei politici",
    s12Intro: "Putem actualiza periodic aceasta Politica de Confidentialitate pentru a reflecta modificarile Serviciilor noastre, ale legilor aplicabile sau ale practicilor noastre de confidentialitate. Cand facem modificari semnificative, vom notifica prin:",
    s12Items: [
      "O notificare proeminenta pe site-ul nostru web pentru o perioada rezonabila",
      "Notificare prin e-mail catre titularii de cont atunci cand modificarile sunt semnificative",
      "Actualizarea datei de 'Ultima actualizare' din partea de sus a acestei politici",
    ],
    s12Outro: "Recomandam sa revizuiesti aceasta politica periodic. Continuarea utilizarii Serviciilor dupa intrarea in vigoare a modificarilor constituie acceptarea acestora.",
    s13Title: "13. Contact si Responsabil cu Protectia Datelor (DPO)",
    s13Intro: "Pentru orice intrebari, solicitari sau reclamatii referitoare la aceasta Politica de Confidentialitate sau la prelucrarea datelor tale cu caracter personal, te rugam sa contactezi Responsabilul nostru cu Protectia Datelor:",
    s13DpoTitle: "Responsabil cu Protectia Datelor (DPO)",
    s13Labels: [["E-mail", "info@acquafy.com"], ["Companie", "Acquafy Corporation"], ["Site web", "acquafy.com/contato"]],
    s13Outro: "Ai de asemenea dreptul de a depune o plangere la Autoritatea Nationala de Supraveghere a Prelucrarii Datelor cu Caracter Personal din Romania sau la Autoritatea Nationala Braziliana de Protectie a Datelor (ANPD) ori la autoritatea de supraveghere competenta din tara ta de resedinta.",
  },
  he: {
    onThisPage: "Badeaf haze",
    nav: [
      { id: "controlador",      label: "1. Ba'al ha-nitunim" },
      { id: "coleta",           label: "2. Nitunim she-neesfu" },
      { id: "finalidades",      label: "3. Matarot ha-itut" },
      { id: "bases-legais",     label: "4. Bisusei mishpat" },
      { id: "compartilhamento", label: "5. Shituf nitunim" },
      { id: "cookies",          label: "6. Cookie-im" },
      { id: "retencao",         label: "7. Shamira" },
      { id: "seguranca",        label: "8. Betihut" },
      { id: "direitos",         label: "9. Zekhuyotekha" },
      { id: "transferencias",   label: "10. Ha'avarot beinleumiyot" },
      { id: "menores",          label: "11. Katinim" },
      { id: "alteracoes",       label: "12. Shinuyim" },
      { id: "contato",          label: "13. Yetzira kesher" },
    ],
    intro1: <><strong>Acquafy Corporation</strong> (&quot;Acquafy&quot;, &quot;anachnu&quot; o &quot;shelanu&quot;) mesumedet lehaganat pratiutekha. Mediniyut prat zo metateret keitsad anachnu menatalim nitunim ishiim she-ata memsir lanu o she-anachnu osefim kesheata mishtamesh be-atar ha-internet, ha-platform, ha-yishum veshaarot hasheirut shelanu (&quot;Sheirutim&quot;).</>,
    intro2: "Mediniyut zo omedet bekhuke haganat ha-nitunim shel Brazil (LGPD - Hok mispar 13.709/2018), Takanot haganat ha-nitunim hakelalit shel ha-Itut ha-Eiropaei (GDPR) ushar chikkim habelimim bethnai prat vehaganat nitunim.",
    s1Title: "1. Ba'al ha-nitunim (Operator)",
    s1Intro: "Ha-operator ha-achrai le-itut ha-nitunim ha-ishiim shelkha hu:",
    s1Labels: [["Chevra", "Acquafy Corporation"], ["Davar-davur", "info@acquafy.com"], ["Atar", "acquafy.com"]],
    s2Title: "2. Nitunim ishiim she-anachnu osefim",
    s21Title: "2.1 Nitunim she-ata masir",
    s21Items: [
      "Shem male ve-dover davar-davur beyitsirat cheshbon o milui formularon yitzira kesher",
      "Meidei ktovet umesira le-itut hazmana",
      "Nitunim tashlum (menotalim be-vetihut al yedei naakim meomasim PCI-DSS)",
      "Haodaot, she-elot uvakshot she-nishlehu davur taalumat tmaicheinu",
      "Ha-kadafot vehagdrot shel hacheshbon shelkha be-Plaform Acquafy",
    ],
    s22Title: "2.2 Nitunim she-ne-esfu otomatit",
    s22Items: [
      "Ktovet IP, sug dapdaf u-maarechet hahapala",
      "Duafim she-bikhru, zman hashihiya veha-atsirim (nitunim si-ur)",
      "Mezahim shel hakilalit ve-nitunim meshurat mekum meguramin",
      "Meidei shimush be-yishum Acquafy ve-nitunim telemtria shel ha-mitaher (IoT)",
      "Cookie-im vetiknologyot domot (meforatu be-khefet 6)",
    ],
    s23Title: "2.3 Nitunim she-hitkabalnu mi-tzadim shliishiim",
    s23Items: [
      "Meidei reshutot hevratiot kesheata behoher lehitashet deavad knisat chevra",
      "Nitunim mishutafei ha-vatsa-at makhirim le-tikun mitkariim vemashkilim",
      "Meidei isut zehut mi-naakim mearim meomasim",
    ],
    s3Title: "3. Matarot ha-itut",
    s3Intro: "Anachnu mishtamshim be-nitunei ha-isiyim shelkha limatarot ha-ba-ot:",
    s3Items: [
      "Matn sheirutim: yetzira ve-nihul cheshbon, itut hazmana umessorat menua",
      "Tikun lakoach: tashuv le-she-elot, bakashot tzikhut vesheirut achar-mekhar",
      "Shipur sheirutim: nituach shimush ba-platform, yishum uviklalot IoT le-shipur tpukot",
      "Tikshoret hashiva-a: mishloh itonim, hatsa-ot vehadashot be-sikum hadasha rishonam",
      "Chiyuvim mishpatiyim vetikaniyim: imut dakkashot mishpatiyot, misui vetikaniyot halachunyot",
      "Betihut uminiat mirma: gitui pealut hashuda ve-haganat shelimut hasheirutim",
      "Ishiyut: hatsaat takhna, hamlaazot vetajribiyot me-utarot leprofil shelkha",
    ],
    s4Title: "4. Bisusei mishpat le-itut",
    s4Intro: "Anachnu menatalim et ha-nitunim shelkha al samach ha-bisusei mishpat ha-ba-im tacht LGPD ve-GDPR:",
    s4Bases: [
      { base: "Bikuf haskem", desc: "Itut nehutza limesur ha-sheirutim she-hikasharno itekha." },
      { base: "Chiyuv mishpati", desc: "Imut chiyuvim ha-mukzavim ba-hok, betakanot o be-hora-ot rashuyot." },
      { base: "Inyan legiti", desc: "Shipur sheirutim, betihut, minat mirma vetikshoret mosadim, bimidla ve-eino gorear al zekhuyotekha." },
      { base: "Sikum", desc: "Mishloh tikshoret hashiva-a ve-shimush be-cookie-im lo hehrachim. Ata yakhol lekhazeir et ha-sikum bekhol et." },
    ],
    s5Title: "5. Shituf nitunim",
    s5Intro: "Anachnu lo mokhrim et ha-nitunim ha-ishiim shelkha le-tzadim shlishiyim. Anachnu yekholim leshatef otam rak ba-matzavim ha-ba-im:",
    s51Title: "5.1 Naakim sheirut",
    s51Text: "Anachnu meshatfim nitunim im safa-im she-ozrim lanu le-peel et hasheirutim (itut tashlumim, astafat anan, massorat davar-davur, nituach nitunim), tamid batekef heskem itut nitunim im chiyuvei sod u-vtikhut.",
    s52Title: "5.2 Shutfei vatsa-at makhar",
    s52Text: "Mikariim ve-mishkalim meurshanim be-rshtet Acquafy yekholim lekabel nitunim ha-nehuzim le-imut hazmana, tikun tkhniki u-hitkanut kilaliot be-ezorekha.",
    s53Title: "5.3 Chiyuv mishpati",
    s53Text: "Anachnu yekholim legalot nitunim keshe-hahok, mishpat o rashut mugenet dorshim et zeh, o keshezeh nehutza le-haganat zekhuyot u-vtikhut shel Acquafy, meshtatfei ha-sheirut shelanu o tzadim shlishiim.",
    s54Title: "5.4 Ha-avarot taarigiyot",
    s54Text: "Bimkre mizmog, rkhisha o mekhira shel nevaser, nitunim yekholim le-haavet le-ba-al heshbon chadash, she-yihiyeh kesher le-chiyuvei ha-mediniyut hazot.",
    s6Title: "6. Cookie-im ve-tiknologyot mitkoret",
    s6Intro: "Anachnu mishtamshim be-cookie-im ve-tiknologyot domot le-shipur hanikyon shelkha ba-sheirutim shelanu. Cookie-im muvdallim le:",
    s6Cookies: [
      { tipo: "Hehrachim", cor: "#0569ff", desc: "Nehuzim le-paaluliut ha-yesodi shel ha-atar ve-ha-platform (isut, betihut, hadafot istantziya). Lo nitn le-natkilam." },
      { tipo: "Analytiyim", cor: "#7b5ea7", desc: "Meafsherim lanu lefanem etsek ha-mevasherim mit-amshim ba-atar (duafim she-bikhru, zman hashiya). Anachnu mishtamshim be-kelim keGo Google Analytics." },
      { tipo: "Tipalutiim", cor: "#0ab572", desc: "Shomrim hakhadafot ke-safah, mekum ve-hagdrot isiyot le-shipur nikayonkha." },
      { tipo: "Hashiva-a", cor: "#e05c00", desc: "Mishtamshim le-hatsagat pirasum relanti umiddat efektivit kampanat. Doreshim sikum kidmi shelkha." },
    ],
    s6Outro: "Ata yakhol le-nahal et hakhadafot shel cookie-im shelkha bekhol et derekh hadafot ha-dapdaf o luach ha-sikum ha-memushan ba-atar shelanu.",
    s7Title: "7. Shamira shel nitunim",
    s7Intro: "Anachnu shomrim et ha-nitunim ha-isiyim shelkha le-mudad ha-nehutza le-hashagat ha-matarot ha-metuarot ba-mediniyut hazot, ela im ken hahok doresh o matar tekufa arokha yoter. Ha-kriteryonot ha-mishtamshim le-kaveat tekufat ha-shamira kolelim:",
    s7Items: [
      "Tekufa she-ba-hah ata meshayet cheshbon pail ba-sheirutim shelanu",
      "Chiyuvei shamira mishpatiyim ve-tikaniyim (le-mashal: nitunim misui le-5 shanim)",
      "Tekufat ha-hitiyashvut ha-halakhit le-sikhsuhim o tvi-ot otzi-iyot",
      "Tzorekh le-shamir rashomot le-betihut u-minat mirma",
    ],
    s7Outro: "Aharei siyum ha-kesher ha-hozit ve-aharei pituy tekufat ha-shamira ha-halachutit, ha-nitunim nimakhkim be-derech betuhah o menyanonim.",
    s8Title: "8. Betihut ha-nitunim",
    s8Intro: "Anachnu nohigim bitsua-im tekhniyim ve-irguniyim meitamim le-haganat nitunim shelkha mi-knisat lo mearshit, aveda, hashmadat o galuy lo nakhon, lirbot:",
    s8Items: [
      "Hatzfana be-ma-avar (TLS/HTTPS) uv-menuhah le-nitunim ragishim",
      "Pakuhot knisa musmakhot al tafkidim (RBAC) ve-autentifikazia rav-gormim le-manakhot panimi-ot",
      "Monitering betihut ratzuf ve-nihul fguiyut",
      "Tokhniyot hadraha ve-hairut sadirit le-ovdim be-tkhum ha-niut",
      "Nhaligim tashuv le-kilkalei betihut im hodaat le-rashuyot u-nosim keshe-hahok doresh zeh",
    ],
    s8Outro: "Ayn manakha haavara o shamira shel nitunim she-hia 100% betuhah. Bimkre shel kilkala she-masukenot nitunim shelkha, naodi et ha-rashuyot ha-mugganot ve-ha-nosim ha-metalim be-zadot ha-mishpatiyot.",
    s9Title: "9. Zekhuyotekha ke-nose nitunim",
    s9Intro: "Betekef LGPD ve-hukkim acheirim halachunim, yesh lekha ha-zekhuyot ha-ba-ot bithum nitunim ishiim shelkha:",
    s9Rights: [
      { direito: "Ishur ve-gishot", desc: "La-da-at im anachnu menatalim nitunim shelkha u-lekabel otekem." },
      { direito: "Tikun", desc: "Livkosh tikun shel nitunim lo shalemim, lo meduiyakim o niyushanim." },
      { direito: "Anonimiout / Hisud / Mehika", desc: "Le-nitunim she-einam nehuzim, yetarim o menualim be-nigged hahok." },
      { direito: "Nidut", desc: "Lekabel et ha-nitunim shelkha be-forma mivneit le-ha-avara le-naakem acher." },
      { direito: "Mehika", desc: "Livkosh mehika shel nitunim ha-menualim al samach ha-sikum shelkha." },
      { direito: "Bizur ha-sikum", desc: "Lehahzir et ha-sikum le-itut ha-mesumet al ha-bishus ha-mishpati hazeh bekhol et." },
      { direito: "Hitnaggadut", desc: "Lehitnagged le-itut al samach inyan legiti keshe-yesh sibot megunyanot." },
      { direito: "Meidah", desc: "La-da-at im eila gufim anachnu meshatfim nitunim shelkha ve-ha-bisusei mishpat ha-mishtamshim." },
    ],
    s9Outro1: "Le-ashtumesh bekhol meze ha-zekhuyot, tzor itekha davar-davur be-",
    s9Outro2: ". Nishuv be-tukh 15 yamei avoda bematnit LGPD.",
    s10Title: "10. Ha-avarot nitunim beinleumiyot",
    s10Intro: "Acquafy poelet be-rkhav ha-olam ve-yekholah le-ha-avir nitunim ishiim shelkha le-aratzot me-hutz le-Brazil o le-Eizor ha-Kalkali ha-Eiropaei. Ba-makim ka-ele, anachnu mazkhirim she-ha-ha-avara metzutseyet im bitukhim meitamim:",
    s10Items: [
      "Sif-ei hazeh standartiyim she-ushru al yedei ha-Komissia ha-Eiropaeit ve-ANPD",
      "Ha-avara le-aratzot ha-matzi-ot rova haganah meitam she-meukar al yedei ha-rashut ha-mugenet",
      "Ishurim ve-kodim shel hitnahagut ha-meukarim beinleumit",
      "Sikum meforash shel ha-nose bithniyut mitatem",
    ],
    s11Title: "11. Katinim",
    s11Text1: "Ha-sheirutim shelanu ainam meugodim le-benet pakhot mi-18 shanim. Anachnu lo osefim kav-ut nitunim ishiim shel yeladim o metziruim. Im noda lanu she-asafnu nitunim shel katan beli sikum hure verifiti, nimkhok nitunim ele mi-yad.",
    s11Text2: "Im atah apotropos shel yeled ve-ata ma-amin she-hu siper lanu nitunim ishiim, tzor itekha be-davar-davur",
    s12Title: "12. Shinuyim la-mediniyut hazot",
    s12Intro: "Anachnu yekholim le-adken et mediniyut ha-niut hazot le-tukfot kazot le-shem shikuf shinuyim ba-sheirutim shelanu, ba-hukkim ha-halachunim o ba-shilusei ha-niut shelanu. Keshe-anachnu osim shinuyim mahutiyim, naodi al yedei:",
    s12Items: [
      "Hoda-ah mevuletet ba-atar shelanu le-tekufa svirutit",
      "Hodaat davar-davur le-ba-alei heshbon keshe-ha-shinuyim hem mashma-utiyim",
      "Adkun tarikh Adkun aharum be-rosh mediniyut zo",
    ],
    s12Outro: "Anachnu amamim she-ata tikhon et ha-mediniyut hazot ledira-it. Hamshakh hashimush ba-sheirutim aharei shinuyim niknasin le-tukpo me-atsim kibul shelahem.",
    s13Title: "13. Yetzira kesher ve-memune haganat nitunim (DPO)",
    s13Intro: "Le-khol she-elot, bakkashot o talunanot hekeshirot la-mediniyut ha-niut hazot o le-itut ha-nitunim ha-isiyim shelkha, tzor kesher im ha-memune haganat nitunim shelanu:",
    s13DpoTitle: "Memune haganat nitunim (DPO)",
    s13Labels: [["Davar-davur", "info@acquafy.com"], ["Chevra", "Acquafy Corporation"], ["Atar", "acquafy.com/contato"]],
    s13Outro: "Yesh lekha gam ha-zkhut le-hagish talunanah le-Rashut ha-Leumit shel Haganat ha-Nitunim shel Brazil (ANPD) o le-rashut ha-piku-ah ha-mugenet be-eretz megurikha.",
  },
};
            ...
            >
              {t.s13Labels.map(([label, value]) => {
                const href = value.includes("@")
                  ? `mailto:${value}`
                  : value.startsWith("acquafy.com/")
                  ? `/${value.replace("acquafy.com/", "")}`
                  : value.match(/\.\w{2,}\/|\.com|\.io|\.org/)
                ...
                return (
                  <div key={label} className="flex gap-[12px] items-center py-[8px] border-b border-[#e0e8ff] last:border-0">
                    ...
                    {href ? (
                      <a
                        href={href}
                        className="font-['Avenir_LT_Pro:55_Roman'] text-[14px] text-[#0569ff] hover:underline underline-offset-2 transition-colors"
                      >
                        {value}
                      </a>
                    ) : (
