...
const T: Record<Lang, {
  ...
  sv: {
    ...
    items: [
      { phase: "Grundande",          description: "Acquafy grundas i USA med syftet att förändra hur världen tar hand om vatten." },
      { phase: "Utveckling",         description: "Utveckling av den initiala produktlinjen och den intelligenta hanteringsplattformen." },
      { phase: "Neo-ekosystem",      description: "Lansering av Neo-ekosystemet och Acquafy Media Network för utbildning, innehåll och engagemang." },
      { phase: "Uppkoppling",        description: "Plattformsutbyggnad med App + AI + IoT som kopplar samman enheter och människor." },
      { phase: "Ny global fas",      description: "Ny tillväxtfas med skalbar global närvaro och expansion av partnernätverket." },
    ],
  },
  fi: {
    heading: "Historiamme",
    items: [
      { phase: "Perustaminen",        description: "Acquafy perustetaan Yhdysvalloissa tarkoituksena muuttaa tapaa, jolla maailma huolehtii vedestä." },
      { phase: "Kehitys",             description: "Alkuperäisen tuotesarjan ja älykkään hallinta-alustan kehittäminen." },
      { phase: "Neo-ekosysteemi",     description: "Neo-ekosysteemin ja Acquafy Media Networkin lanseeraus koulutusta, sisältöä ja sitoutumista varten." },
      { phase: "Yhdistyvyys",         description: "Alustan laajentaminen App + AI + IoT:lla yhdistämällä laitteet ja ihmiset." },
      { phase: "Uusi globaali vaihe", description: "Uusi kasvuvaihe skaalautuvalla globaalilla läsnäololla ja kumppaniverkoston laajentamisella." },
    ],
  },
  ru: {
