...
const T: Record<Lang, {
  ...
  sv: {
    desc: "Sofistikerade modeller i rostfritt stål med LCD IPS Touch-panel 15.6, RO/omvänd osmos, app, UV LED, Wi-Fi 5, Bluetooth 5.3 och integrerad premiumupplevelse.",
    waterHeader: ["Vattentyper från ", "Neo Premium", "-produkter, det perfekta vattnet för varje ögonblick"],
    waterTypes: [
    ...
    tankNote: "Alla modeller har en 3000ml källvattentank.",
    panelTitle: ["Premiumpanel ", "med IPS-teknik"],
    panelSub: "Avancerad teknik för sofistikerade miljöer och krävande användare.",
    features: [
      { title: "LCD IPS / Total Touch", desc: "Navigation som iPhone / iPad" },
      { title: "Premiumteknik",         desc: "Högpresterande filter" },
      { title: "Omvänd osmos (RO)",     desc: "Rent alkaliskt vatten" },
      { title: "Avancerad IoT",         desc: "Realtidstelemetri" },
    ],
  },
  fi: {
    desc: "Hienostuneet ruostumattomasta teräksestä valmistetut mallit, joissa on LCD IPS Touch -paneeli 15.6, RO/käänteisosmoosi, sovellus, UV LED, Wi-Fi 5, Bluetooth 5.3 ja integroitu premium-kokemus.",
    waterHeader: ["Vesityypit ", "Neo Premium", " -tuotteista, täydellinen vesi jokaiseen hetkeen"],
    waterTypes: [
    ...
    sub6: "6 in 1", sub7: "7 in 1", sub8: "8 in 1",
    tankNote: "Kaikissa malleissa on 3000 ml:n kylmävesisäiliö.",
    panelTitle: ["Premium-paneeli ", "IPS-teknologialla"],
    panelSub: "Edistynyt teknologia hienostuneisiin ympäristöihin ja vaativille käyttäjille.",
    features: [
      ...
      { title: "Käänteisosmoosi (RO)",  desc: "Puhdas emäksinen vesi" },
