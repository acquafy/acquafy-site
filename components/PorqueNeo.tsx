...
const T: Record<Lang, {
  ...
  sv: {
    heading1: "Varför välja ",
    heading2: "Neo-linjen",
    items: [
      { title: "App Acquafy",         desc: "Full kontroll via appen var som helst." },
      { title: "Acquafy AI",          desc: "Intelligens som lär sig dina vanor." },
      { title: "Smart IoT",           desc: "Anslutning och realtidsdata." },
      { title: "Personaliserat vatten", desc: "Temperaturer och funktioner för varje ögonblick." },
      { title: "Hög prestanda",       desc: "Global teknik och nästa generations filter." },
      { title: "Globalt design",      desc: "Sofistikerad och prisbelönt finish." },
    ],
  },
  fi: {
    ...
    heading2: "Neo-linja",
    items: [
      { title: "App Acquafy",         desc: "Täydellinen hallinta sovelluksen kautta mistä tahansa." },
      { title: "Acquafy AI",          desc: "Älykkyys, joka oppii tapasi." },
      { title: "Äly-IoT",             desc: "Yhteydet ja reaaliaikaiset tiedot." },
      { title: "Personoitu vesi",     desc: "Lämpötilat ja toiminnot jokaiseen hetkeen." },
