...
const T: Record<Lang, {
  ...
  pt: {
    ...
    items: [
      ...
      { title: "Acquafy AI",          desc: "Inteligencia que aprende seus habitos." },
      { title: "IoT Inteligente",     desc: "Conectividade e dados em tempo real." },
      { title: "Agua Personalizada",  desc: "Temperaturas e funcoes para cada momento." },
      { title: "Alta Performance",    desc: "Tecnologia global e filtros de ultima geracao." },
  ...
  es: {
    heading1: "Por que elegir la ",
    heading2: "Linea Neo",
    items: [
      { title: "App Acquafy",         desc: "Control total desde la app donde quieras." },
      { title: "Acquafy AI",          desc: "Inteligencia que aprende tus habitos." },
      ...
      { title: "Alto Rendimiento",    desc: "Tecnologia global y filtros de ultima generacion." },
      { title: "Diseno Global",       desc: "Acabado sofisticado y premiado." },
    ],
  },
  fr: {
    ...
    heading2: "Gamme Neo",
    items: [
      { title: "App Acquafy",          desc: "Controle total via l'application ou que vous soyez." },
      { title: "Acquafy AI",           desc: "Intelligence qui apprend vos habitudes." },
      { title: "IoT Intelligent",      desc: "Connectivite et donnees en temps reel." },
      { title: "Eau Personnalisee",    desc: "Temperatures et fonctions pour chaque instant." },
      { title: "Haute Performance",    desc: "Technologie mondiale et filtres de derniere generation." },
      { title: "Design Global",        desc: "Finition sophistiquee et primee." },
    ],
  },
  de: {
    heading1: "Warum die ",
    heading2: "Neo-Linie wahlen",
    items: [
      { title: "App Acquafy",          desc: "Vollstandige Steuerung uber die App von uberall." },
      { title: "Acquafy AI",           desc: "Intelligenz, die Ihre Gewohnheiten erlernt." },
      { title: "Smartes IoT",          desc: "Konnektivitat und Echtzeitdaten." },
      { title: "Personalisiertes Wasser", desc: "Temperaturen und Funktionen fur jeden Moment." },
      { title: "Hochleistung",         desc: "Globale Technologie und Filter der neuesten Generation." },
      { title: "Globales Design",      desc: "Anspruchsvolle und preisgekronte Verarbeitung." },
    ],
  },
  it: {
    heading1: "Perche scegliere la ",
    heading2: "Linea Neo",
    items: [
      ...
      { title: "IoT Intelligente",     desc: "Connettivita e dati in tempo reale." },
  ...
  sv: {
    heading1: "Varfor valja ",
    heading2: "Neo-linjen",
    items: [
      { title: "App Acquafy",         desc: "Full kontroll via appen var som helst." },
      { title: "Acquafy AI",          desc: "Intelligens som lar sig dina vanor." },
      { title: "Smart IoT",           desc: "Anslutning och realtidsdata." },
      { title: "Personaliserat vatten", desc: "Temperaturer och funktioner for varje ogonblick." },
      { title: "Hog prestanda",       desc: "Global teknik och nasta generations filter." },
      { title: "Globalt design",      desc: "Sofistikerad och prisbelont finish." },
    ],
  },
  fi: {
    heading1: "Miksi valita ",
    heading2: "Neo-linja",
    items: [
      { title: "App Acquafy",         desc: "Taydellinen hallinta sovelluksen kautta mista tahansa." },
      ...
      { title: "Korkea suorituskyky", desc: "Globaali teknologia ja uuden sukupolven suodattimet." },
      { title: "Globaali muotoilu",   desc: "Hienostunut ja palkittu viimeistely." },
    ],
  },
  ru: {
    heading1: "Зачем выбирать ",
    heading2: "линейку Neo",
    items: [
      { title: "App Acquafy",         desc: "Полный контроль через приложение откуда угодно." },
      { title: "Acquafy AI",          desc: "Интеллект, который учится вашим привычкам." },
      { title: "Умный IoT",          desc: "Подключение и данные в реальном времени." },
      { title: "Персонализированная вода", desc: "Температуры и функции для каждого момента." },
      { title: "Высокая производительность", desc: "Глобальные технологии и фильтры последнего поколения." },
      { title: "Глобальный дизайн",      desc: "Изысканная и награжденная отделка." },
    ],
  },
  ro: {
    heading1: "De ce sa alegi ",
    heading2: "linia Neo",
    items: [
      { title: "App Acquafy",         desc: "Control total prin aplicatie de oriunde." },
      { title: "Acquafy AI",          desc: "Inteligenta care iti invata obiceiurile." },
      ...
      { title: "Inalta performanta",  desc: "Tehnologie globala si filtre de ultima generatie." },
      { title: "Design global",       desc: "Finisaj sofisticat si premiat." },
    ],
  },
  he: {
    heading1: "למה לבחור את ",
    heading2: "סדרת Neo",
    items: [
      { title: "App Acquafy",         desc: "שליטה מלאה דרך האפליקציה מכל מקום." },
      { title: "Acquafy AI",          desc: "בינה מלאכותית שלומדת את הרגלים שלך." },
      { title: "IoT חכם",          desc: "קישוריות ונתונים בזמן אמת." },
      { title: "מים מותאם אישית",   desc: "טמפרטורות ופונקציות לכל רגע." },
      { title: "ביצוע גבוה",  desc: "טכנולוגיה גלובלית ומסנני דור הבא." },
      { title: "עיצוב גלובלי",       desc: "גימור משוכלל וזוכה בפרסים." },
    ],
  },
  "pt-pt": {
    heading1: "Porque escolher a ",
    ...
    items: [
      ...
      { title: "Acquafy AI",          desc: "Inteligencia que aprende os seus habitos." },
      { title: "IoT Inteligente",     desc: "Conectividade e dados em tempo real." },
      { title: "Agua Personalizada",  desc: "Temperaturas e funcoes para cada momento." },
      { title: "Alta Performance",    desc: "Tecnologia global e filtros de ultima geracao." },
      { title: "Design Global",       desc: "Acabamento sofisticado e premiado." },
