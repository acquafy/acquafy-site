...
const BTN_LABELS: Record<string, Record<string, string>> = {
  falaAcquafy:  { pt: "Falar com a Acquafy",      "pt-pt": "Falar com a Acquafy",        en: "Talk to Acquafy",            es: "Hablar con Acquafy",        fr: "Parler à Acquafy",            de: "Mit Acquafy sprechen",        it: "Parla con Acquafy",           zh: "联系 Acquafy",        ja: "Acquafyに連絡",     ko: "Acquafy에 문의" },
  distribuidor: { pt: "Quero ser Distribuidor",   "pt-pt": "Quero ser Distribuidor",      en: "I want to be a Distributor", es: "Quiero ser Distribuidor",   fr: "Je veux être Distributeur",   de: "Ich möchte Distributor sein", it: "Voglio essere Distributore",  zh: "成为经销商",         ja: "代理店になる",      ko: "유통업체 되기" },
  kitGift:      { pt: "Solicitar Kit Promocional","pt-pt": "Solicitar Kit Promocional",   en: "Request Promotional Kit",    es: "Solicitar Kit Promocional", fr: "Demander un Kit Promotionnel", de: "Werbekit anfordern",          it: "Richiedi Kit Promozionale",   zh: "申请促销套件",       ja: "プロモキットを申請",ko: "프로모션 키트 요청" },
};
