...
const T: Record<Lang, {
  ...
  sv: {
    ...
    cards: [
      { title: "Partners",             desc: "Fullständig hantering av Gold-, Silver- och Platinum-partners. Silver-nätverk och strategiska affärsregler." },
      { title: "QR-koder & Länkar",    desc: "Generering, spårning, försäljningskälla, prestanda och realtidskonvertering." },
      { title: "Media Network",        desc: "Hantering av annonsörer, kampanjer, kreativt material och visning på Acquafy Media och Neo Premium." },
      { title: "Produkter & Försäljning", desc: "Neo-linjekatalog, amerikanska priser, beställningar, kunder, fakturering och returer." },
      { title: "Provisioner",          desc: "Beräkning och betalning av provisioner för Gold och Silver. Platinum FOB-regel." },
    ],
  },
  fi: {
    ...
    cards: [
      { title: "Kumppanit",            desc: "Gold-, Silver- ja Platinum-kumppanien täydellinen hallinta. Silver-verkosto ja strategiset kaupalliset säännöt." },
      { title: "QR-koodit & Linkit",   desc: "Luonti, seuranta, myynnin alkuperä, suorituskyky ja reaaliaikainen konversio." },
      { title: "Media Network",        desc: "Mainostajien, kampanjoiden, luovien materiaalien hallinta ja näkyvyys Acquafy Mediassa ja Neo Premiumissa." },
      { title: "Tuotteet & Myynti",    desc: "Neo-linjan katalogi, Yhdysvaltojen hinnat, tilaukset, asiakkaat, laskutus ja palautukset." },
      { title: "Provisiot",            desc: "Provisioiden laskenta ja maksaminen Gold- ja Silver-tasoille. Platinum FOB -sääntö." },
    ],
  },
  ru: {
