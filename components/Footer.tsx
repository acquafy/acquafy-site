...
const imgX         = "/figma-assets/icon-x-twitter.svg";  // X/Twitter — 1000.78×936.69
...
// Stats card icons
const imgGlobe    = "/figma-assets/icon-globe-planetweb-30px.svg"; // PlanetWeb 30×30
const imgChat     = "/figma-assets/icon-chat-large.svg"; // 501.71×419 landscape
const imgLocation = "/figma-assets/icon-location-b.svg"; // 642×642 square
const imgMoney    = "/figma-assets/icon-money-large-b.svg"; // 472×440

// Bottom bar
const imgFlagUSA   = "/figma-assets/flag-usa.svg"; // 30×30
const imgGlobeSust = "/figma-assets/icon-globe-sust.svg"; // 492×475
const imgArrowDown = "/figma-assets/icon-arrow-down.svg"; // 30×18 landscape

// Certification badges (5 — rendered 50×50 each)
const certLogos = [
  "/figma-assets/cert-badge-a.svg", // Frame37
  "/figma-assets/cert-badge-b.svg", // Frame39
  "/figma-assets/cert-badge-c.svg", // Frame38
  "/figma-assets/cert-badge-d.svg", // Frame35
  "/figma-assets/cert-badge-e.svg", // Frame36
];
      ...
      <div className="border-t border-[#dde5f0] flex items-center justify-center px-[20px] py-[14px] w-full bg-[#f6f9fe]">
        <div className="flex flex-wrap gap-[10px_20px] items-center justify-between max-w-[1400px] w-full mob:flex-col mob:items-center mob:gap-[10px]">
          <p className="font-['Avenir_LT_Pro:55_Roman'] text-[13px] text-[#07235c] mob:text-center">
            Acquafy Corporation © 2026. Todos os direitos reservados.
          </p>
          <div className="flex gap-[20px] items-center shrink-0">
            <a href="/termos-de-uso" className="font-['Avenir_LT_Pro:55_Roman'] text-[13px] text-[#07235c] hover:text-[#0233c3] transition-colors">
              Termos de Uso
            </a>
            <a href="/politicas-privacidade" className="font-['Avenir_LT_Pro:55_Roman'] text-[13px] text-[#07235c] hover:text-[#0233c3] transition-colors">
