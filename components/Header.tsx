...
const NAV_TEXT: Record<Lang, NavTxt[]> = {
  ...
  sv: [
    { label: "Plattform", dd: [
      ...
      { label: "App + AI + IoT",              desc: "Fjärrkontroll, automatisering och konstgjord intelligens i din hand.",                  cta: "Se Appen"            },
      { label: "Supportcenter",               desc: "Specialiserat tekniskt stöd för att hålla din Acquafy alltid i gång.",                 cta: "Få Support"          },
      { label: "Teknik & Hållbarhet",         desc: "Banbrytande innovation kombinerat med positiv miljöpåverkan.",                         cta: "Läs mer"             },
    ]},
    { label: "Produkter", dd: [
      { label: "Neo-linjen",              desc: "Reningsverk med LED-touchpanel, App, UV LED och premium UF-filter.",                        cta: "Se Neo-linjen"   },
      { label: "Acquafy Media",           desc: "Multimediakommunikation och innehåll integrerat i reningsverket.",                         cta: "Se Media"        },
      { label: "Filter & Tillbehör",      desc: "Smart utbyte med spårbarhet och garanterad kvalitet.",                                     cta: "Se Filter"       },
      { label: "Jämför Produkter",        desc: "Hitta den ideala modellen genom att jämföra specs, kapacitet och teknik.",                  cta: "Jämför Nu"       },
    ]},
    { label: "Företag", dd: [
      { label: "Om Oss",            desc: "Grundat i USA 2020 och närvarande i mer än 180 länder.",              cta: "Vår Historia"    },
      { label: "Global Expansion",  desc: "100% global verksamhet med en 100% återkommande intäktsmodell.",      cta: "Se Expansion"    },
      { label: "Kontakt",           desc: "Prata med vårt team och hitta närmaste återförsäljare.",               cta: "Kontakta Oss"    },
    ]},
    { label: "Köp Nu", dd: [] },
  ],
  fi: [
    { label: "Alusta", dd: [
      { label: "Acquafy-alusta",              desc: "Äly-vedenhallinnan alusta, jossa App, AI ja IoT ovat täysin integroituina.",           cta: "Tutki Alustaa"       },
      { label: "App + AI + IoT",              desc: "Etäohjaus, automaatio ja tekoäly kämmenässäsi.",                             cta: "Katso Sovellus"      },
      { label: "Tukikeskus",                  desc: "Erikoistunut tekninen tuki pitääksesi Acquafysi aina toiminnassa.",                    cta: "Hanki Tuki"          },
      { label: "Teknologia & Kestävä kehitys", desc: "Huipputeknologiaa yhdistettynä positiiviseen ympäristövaikutukseen.",           cta: "Lue lisää"           },
    ]},
    { label: "Tuotteet", dd: [
      ...
      { label: "Acquafy Media",           desc: "Multimediaviestintä ja sisältö integroituna puhdistimeen.",                               cta: "Katso Media"      },
      { label: "Suodattimet & Tarvikkeet", desc: "Älykäs vaihto jäljitettävyydellä ja taatulla laadulla.",                                cta: "Katso Suodattimet"},
      { label: "Vertaile Tuotteita",      desc: "Löydä ihanteellinen malli vertaamalla speksejä, kapasiteettia ja teknologiaa.",            cta: "Vertaile Nyt"     },
    ]},
    { label: "Yritys", dd: [
      { label: "Tietoa Meistä",     desc: "Perustettu USA:ssa vuonna 2020 ja läsnäolevana yli 180 maassa.",         cta: "Tarinamme"         },
      { label: "Globaali Laajentuminen", desc: "100% globaali toiminta 100% toistuvilla tuloilla.",               cta: "Katso Laajentuminen" },
      { label: "Yhteystiedot",      desc: "Ota yhteys tiimiimme ja löydä lähin jakelijamme.",                       cta: "Ota Yhteys"         },
    ]},
    { label: "Osta Nyt", dd: [] },
  ],
  ru: [
...
const ARIA_MENU: Record<Lang, { open: string; close: string }> = {
  ...
  sv: { open: "Öppna menyn",     close: "Stäng menyn"     },
