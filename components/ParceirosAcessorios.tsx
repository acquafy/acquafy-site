...
const T: Record<Lang, {
  ...
  sv: {
    heading:  "För partners, evenemang och kampanjaktioner",
    subtitle: "Acquafy-tillbehör kan användas av Silver-, Gold- och Platinum-partners på mässor, showroom-aktiveringar, produktlanseringar, kundförvärvskampanjer och Media Network-operationer.",
    tiers: [
      { desc: "Viktiga tillbehör för att presentera ditt varumärke med Acquafy-kvalitet." },
      { desc: "Premiummaterial för upplevelser med differentiering och sofistikering." },
      { desc: "Exklusiva lösningar och anpassningar för att framhäva din marknadsledarskap." },
    ],
    benefits: [
      { title: "Konsekvent identitet",        desc: "Global standardisering med Acquafys visuella identitet." },
      { title: "Premiumkvalitet",             desc: "Utvalda material och utmärkt finish." },
      { title: "Strategisk merchandising",    desc: "Stärker ditt varumärke vid varje kontaktpunkt." },
      { title: "Idealiskt för showrooms",     desc: "Tillbehör som förbättrar miljön och upplevelsen." },
      { title: "Evenemangsaktivering",        desc: "Perfekt för mässor, kampanjaktioner och aktiveringar." },
    ],
  },
  fi: {
    heading:  "Kumppaneille, tapahtumille ja kampanjatoimille",
    subtitle: "Acquafy-tarvikkeita voivat käyttää Silver-, Gold- ja Platinum-kumppanit messuilla, showroom-aktivoinneissa, tuotelanseerauksissa, asiakashankintakampanjoissa ja Media Network -toiminnoissa.",
    tiers: [
      { desc: "Välttämättömät tarvikkeet brändisi esittelemiseksi Acquafy-laadulla." },
      { desc: "Premium-materiaalit kokemuksiin, joissa on erottuvuutta ja hienostuneisuutta." },
      { desc: "Eksklusiiviset ratkaisut ja räätälöinnit markkina-johtajuutesi korostamiseksi." },
    ],
    benefits: [
      { title: "Yhtenäinen identiteetti",     desc: "Globaali standardointi Acquafyn visuaalisella identiteetillä." },
      { title: "Premiumlaatu",                desc: "Valitut materiaalit ja erinomainen viimeistely." },
      { title: "Strateginen myynninedistäminen", desc: "Vahvistaa brändisi jokaisessa kontaktipisteessä." },
      { title: "Ihanteellinen showroomeihin", desc: "Tarvikkeet, jotka parantavat ympäristöä ja kokemusta." },
      { title: "Tapahtumaaktivointi",         desc: "Täydellinen messuille, kampanjatoimille ja aktivoinneille." },
    ],
  },
  ru: {
