...
const T: Record<Lang, {
  ...
  sv: {
    badge: "NY GLOBAL FAS",
    titleLine1: "Teknik & ",
    titleLine2: "Hallbarhet",
    subtitle: "Innovation som omvandlar vatten till livskvalitet och bevarar planeten for framtida generationer.",
    description: "Acquafy kombinerar banbrytande teknik, artificiell intelligens och hallbar design for att leverera rent, sakert och tillgangligt vatten, minska miljopaverkan och framja en halsosammare framtid.",
    stat1: <><span>Rent och</span><br /><span>sakert vatten</span></>,
    stat2: "Smart teknik",
    stat3: "Verklig hallbarhet",
    stat4: "Positivt globalt inflytande",
    trust1: "Palitlig och certifierad teknik",
    trust2: "Haltbara och atervinnbara material",
    trust3: "Globalt engagemang for en hallbar framtid",
  },
  fi: {
    badge: "UUSI GLOBAALI VAIHE",
    titleLine1: "Teknologia & ",
    titleLine2: "Kestavyys",
    subtitle: "Innovaatio, joka muuttaa veden elaemanlaaduksi ja sailyttaa planeetan tuleville sukupolville.",
    description: "Acquafy yhdistaa huipputeknologian, tekoalyn ja kestavan suunnittelun toimittaakseen puhdasta, turvallista ja saavutettavaa vetta samalla vahentaen ymparistovaikutuksia ja edistaden terveellisempaa tulevaisuutta.",
    stat1: <><span>Puhdasta ja</span><br /><span>turvallista vetta</span></>,
    stat2: "Aly-teknologia",
    stat3: "Todellinen kestavyys",
    stat4: "Positiivinen globaali vaikutus",
    trust1: "Luotettava ja sertifioitu teknologia",
    trust2: "Kestavat ja kierratettavat materiaalit",
    trust3: "Globaali sitoutuminen kestavaan tulevaisuuteen",
  },
  ru: {
