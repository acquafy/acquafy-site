...
const categorias: DownloadCategoria[] = [
  {
    ...
    arquivos: [
      ...
      { nome: "Manual do Usuário — SPARK",        tipo: "PDF", tamanho: "9 MB",   href: "#" },
      { nome: "Manual do Usuário — SPARK H₂",    tipo: "PDF", tamanho: "10 MB",  href: "#" },
      { nome: "Manual do Usuário — Neo MAX",      tipo: "PDF", tamanho: "11 MB",  href: "#" },
      { nome: "Manual do Usuário — INFINITY",     tipo: "PDF", tamanho: "12 MB",  href: "#" },
      { nome: "Manual do Usuário — PRESTIGE",     tipo: "PDF", tamanho: "11 MB",  href: "#" },
      { nome: "Manual do Usuário — PRIME",        tipo: "PDF", tamanho: "11 MB",  href: "#" },
    ],
  },
  {
