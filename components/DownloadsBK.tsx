...
const categorias: DownloadCategoria[] = [
  {
    ...
    arquivos: [
      ...
      { nome: "Manual do Usuário — PRESTIGE SPARK",     tipo: "PDF", tamanho: "9 MB",   href: "#" },
      { nome: "Manual do Usuário — PRESTIGE SPARK H₂",  tipo: "PDF", tamanho: "10 MB",  href: "#" },
      { nome: "Manual do Usuário — PRIME SPARK",        tipo: "PDF", tamanho: "9 MB",   href: "#" },
      { nome: "Manual do Usuário — PRIME SPARK H₂",     tipo: "PDF", tamanho: "10 MB",  href: "#" },
    ],
  },
  {
