...
const T: Record<Lang, {
  ...
  "en-gb": {
    ...
    locations: [
      { title: "Airports",                          desc: "High traffic, qualified audience and great visibility for brands." },
      { title: "Shopping Centres",                  desc: "Constant engagement and shopping and conversion opportunities." },
      { title: "Hospitals",                         desc: "Accessible hydration and well-being for patients, visitors and staff." },
      { title: "Companies",                         desc: "More health and productivity for employees and visitors." },
      { title: "Universities",                      desc: "Young and connected audience, ideal for media and promotions." },
      { title: "Public networks and high-traffic locations", desc: "Stations, bus terminals, squares and urban spaces with heavy foot traffic." },
  ...
  sv: {
    heading1: "Var Acquafy Media ",
    headingHighlight: "ger störst genomslag",
    locations: [
      { title: "Flygplatser",                        desc: "Hög trafik, kvalificerad publik och stor varumärkessynlighet." },
      { title: "Köpcentrum",                         desc: "Konstant engagemang och möjligheter till köp och konvertering." },
    ...
    heading1: "Missä Acquafy Media ",
    headingHighlight: "tuottaa eniten vaikutusta",
    locations: [
      { title: "Lentoasemat",                        desc: "Suuri liikenne, pätevä yleisö ja erinomainen näkyvyys brändeille." },
      { title: "Ostoskeskukset",                     desc: "Jatkuva sitoutuminen sekä osto- ja konversiomahdollisuudet." },
      { title: "Sairaalat",                          desc: "Helposti saatavilla oleva nesteytys ja hyvinvointi potilaille, vierailijoille ja henkilöstölle." },
      { title: "Yritykset",                          desc: "Parempi terveys ja tuottavuus työntekijöille ja vierailijoille." },
      { title: "Yliopistot",                         desc: "Nuori ja verkottunut yleisö, ihanteellinen medialle ja kampanjoille." },
      { title: "Julkiset verkostot ja vilkkaat paikat", desc: "Asemat, linja-autoterminaalit, torit ja kaupunkitilat, joissa on runsaasti kulkijoita." },
    ],
  },
  ru: {
    heading1: "Где Acquafy Media ",
    headingHighlight: "оказывает наибольшее воздействие",
    locations: [
      { title: "Аэропорты",                          desc: "Высокий трафик, качественная аудитория и отличная видимость для брендов." },
      { title: "Торговые центры",                    desc: "Постоянное вовлечение и возможности для покупок и конверсий." },
      { title: "Больницы",                           desc: "Доступное увлажнение и благополучие для пациентов, посетителей и персонала." },
      { title: "Компании",                           desc: "Больше здоровья и продуктивности для сотрудников и посетителей." },
      { title: "Университеты",                       desc: "Молодая и подключённая аудитория, идеальная для медиа и акций." },
      { title: "Публичные сети и места с высоким трафиком", desc: "Станции, автовокзалы, площади и городские пространства с большим потоком людей." },
    ],
  },
  ro: {
    heading1: "Unde Acquafy Media ",
    headingHighlight: "generează cel mai mare impact",
    locations: [
      { title: "Aeroporturi",                        desc: "Trafic ridicat, public calificat si vizibilitate mare pentru branduri." },
      { title: "Centre comerciale",                  desc: "Implicare constanta si oportunitati de cumparare si conversie." },
      { title: "Spitale",                            desc: "Hidratare accesibila si bunastare pentru pacienti, vizitatori si personal." },
      { title: "Companii",                           desc: "Mai multa sanatate si productivitate pentru angajati si vizitatori." },
      { title: "Universitati",                       desc: "Public tanar si conectat, ideal pentru media si promotii." },
      { title: "Retele publice si locatii cu trafic ridicat", desc: "Statii, gari, piete si spatii urbane cu circulatie intensa." },
    ],
  },
  he: {
    heading1: "Acquafy Media ",
    headingHighlight: "מייצר את ההשפעה הגדולה ביותר",
    locations: [
      { title: "שדות תעופה",                        desc: "תנועה גבוהה, קהל איכותי ונראות מצוינת למותגים." },
      { title: "קניונים",                            desc: "מעורבות מתמדת והזדמנויות רכישה והמרה." },
      { title: "בתי חולים",                          desc: "הידרציה נגישה ורווחה למטופלים, מבקרים וצוות." },
      { title: "חברות",                              desc: "יותר בריאות ופרודוקטיביות לעובדים ולמבקרים." },
      { title: "אוניברסיטאות",                      desc: "קהל צעיר ומחובר, אידיאלי למדיה ולמבצעים." },
      { title: "רשתות ציבוריות ומקומות עם תנועה גבוהה", desc: "תחנות, מסופים, כיכרות ומרחבים עירוניים עם תנועת רגלים ערה." },
    ],
  },
};
