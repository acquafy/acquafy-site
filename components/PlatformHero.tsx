...
const T: Record<Lang, {
  ...
  sv: {
    ...
    h1part1: "Plattform ",
    h1part2: "Smart App",
    subtitle: "Global hantering, App + AI + IoT i en integrerad upplevelse för media, partners, försäljning och drift av smart vatten.",
    cta: "Begär en demo",
    mockupAlt: "Acquafy Plattform — surfplatta och smartphone",
    featureCards: [
      { title: "Cloud Platform",    desc: "Säker och skalbar infrastruktur." },
      { title: "App + AI",          desc: "Artificiell intelligens för beslut och automatisering" },
      { title: "IoT & Enheter",     desc: "Fjärrövervakning och anslutna sensorer" },
      { title: "Global Hantering",  desc: "Drift i 180+ länder och 16 språk" },
    ],
    trustBadges: [
      { title: "Säker & Pålitlig",  sub: "Skyddad data" },
      { title: "Skalbar",           sub: "Elastisk prestanda" },
      { title: "Full Integration",  sub: "App + Web + IoT + AI" },
      { title: "Tillgänglighet",    sub: "99,9% drifttid" },
    ],
  },
  fi: {
    badge: "ACQUAFY DIGITAALINEN EKOSYSTEEMI",
    h1part1: "Alusta ",
    h1part2: "Älykkäs Sovellus",
    subtitle: "Globaali hallinta, App + AI + IoT integroituna kokemuksena medialle, kumppaneille, myynnille ja älykkäälle vesioperaatiolle.",
    cta: "Pyydä demo",
    mockupAlt: "Acquafy Alusta — tabletti ja älypuhelin",
    featureCards: [
      { title: "Cloud Platform",    desc: "Turvallinen ja skaalautuva infrastruktuuri." },
      { title: "App + AI",          desc: "Tekoäly päätöksentekoon ja automatisointiin" },
      { title: "IoT & Laitteet",    desc: "Etävalvonta ja yhdistetyt anturit" },
      { title: "Globaali Hallinta", desc: "Toiminta 180+ maassa ja 16 kielellä" },
    ],
    trustBadges: [
      { title: "Turvallinen & Luotettava", sub: "Suojattu data" },
      { title: "Skaalautuva",              sub: "Joustava suorituskyky" },
      { title: "Täysintegraatio",          sub: "App + Web + IoT + AI" },
      { title: "Käytettävyys",             sub: "99,9% käyntiaste" },
    ],
  },
  ru: {
