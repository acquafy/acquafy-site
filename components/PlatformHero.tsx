...
const T: Record<Lang, {
  ...
  fr: {
    badge: "ECOSYSTEME DIGITAL ACQUAFY",
    h1part1: "Plateforme ",
    h1part2: "App Intelligente",
    subtitle: "Gestion mondiale, App + AI + IoT dans une experience integree pour les medias, partenaires, ventes et operation de l'eau intelligente.",
    cta: "Demander une demo",
    mockupAlt: "Plateforme Acquafy — tablette et smartphone",
    featureCards: [
      { title: "Cloud Platform",     desc: "Infrastructure securisee et evolutive." },
      { title: "App + AI",           desc: "Intelligence artificielle pour les decisions et l'automatisation" },
      { title: "IoT & Appareils",    desc: "Surveillance a distance et capteurs connectes" },
      { title: "Gestion Mondiale",   desc: "Operation dans 180+ pays et 16 langues" },
    ],
    trustBadges: [
      { title: "Securise & Fiable",  sub: "Donnees protegees" },
      { title: "Evolutif",           sub: "Performance elastique" },
      { title: "Integration Totale", sub: "App + Web + IoT + AI" },
      { title: "Disponibilite",      sub: "99,9% uptime" },
    ],
  },
  de: {
    badge: "DIGITALES OKOSYSTEM ACQUAFY",
    h1part1: "Plattform ",
    h1part2: "Smart App",
    subtitle: "Globales Management, App + AI + IoT in einer integrierten Erfahrung fur Medien, Partner, Vertrieb und intelligenten Wasserbetrieb.",
    cta: "Demo anfordern",
    mockupAlt: "Acquafy Plattform — Tablet und Smartphone",
    featureCards: [
      { title: "Cloud Platform",     desc: "Sichere und skalierbare Infrastruktur." },
      { title: "App + AI",           desc: "Kunstliche Intelligenz fur Entscheidungen und Automatisierung" },
      { title: "IoT & Gerate",       desc: "Fernuberwachung und vernetzte Sensoren" },
      { title: "Globales Management",desc: "Betrieb in 180+ Landern und 16 Sprachen" },
    ],
    trustBadges: [
      { title: "Sicher & Zuverlassig", sub: "Geschutzte Daten" },
      { title: "Skalierbar",           sub: "Elastische Performance" },
      { title: "Vollintegration",      sub: "App + Web + IoT + AI" },
      { title: "Verfugbarkeit",        sub: "99,9% Uptime" },
    ],
  },
  it: {
    ...
    trustBadges: [
      ...
      { title: "Disponibilita",       sub: "99,9% uptime" },
    ],
  },
  zh: {
  ...
  sv: {
    badge: "ACQUAFY DIGITALT EKOSYSTEM",
    h1part1: "Plattform ",
    h1part2: "Smart App",
    subtitle: "Global hantering, App + AI + IoT i en integrerad upplevelse for media, partners, forsaljning och drift av smart vatten.",
    cta: "Begara en demo",
    mockupAlt: "Acquafy Plattform — surfplatta och smartphone",
    featureCards: [
      { title: "Cloud Platform",    desc: "Saker och skalbar infrastruktur." },
      { title: "App + AI",          desc: "Artificiell intelligens for beslut och automatisering" },
      { title: "IoT & Enheter",     desc: "Fjarrovvakning och anslutna sensorer" },
      { title: "Global Hantering",  desc: "Drift i 180+ lander och 16 sprak" },
    ],
    trustBadges: [
      { title: "Saker & Palitlig",  sub: "Skyddad data" },
      { title: "Skalbar",           sub: "Elastisk prestanda" },
      { title: "Full Integration",  sub: "App + Web + IoT + AI" },
      { title: "Tillganglighet",    sub: "99,9% drifttid" },
    ],
  },
  fi: {
    badge: "ACQUAFY DIGITAALINEN EKOSYSTEEMI",
    h1part1: "Alusta ",
    h1part2: "Alykas Sovellus",
    subtitle: "Globaali hallinta, App + AI + IoT integroituna kokemuksena medialle, kumppaneille, myynnille ja alykkaalle vesioperaatiolle.",
    cta: "Pyynna demo",
    mockupAlt: "Acquafy Alusta — tabletti ja alypuhelin",
    featureCards: [
      { title: "Cloud Platform",    desc: "Turvallinen ja skaalautuva infrastruktuuri." },
      { title: "App + AI",          desc: "Tekoaly paatoksentekoon ja automatisointiin" },
      { title: "IoT & Laitteet",    desc: "Etavalvonta ja yhdistetyt anturit" },
      { title: "Globaali Hallinta", desc: "Toiminta 180+ maassa ja 16 kielella" },
    ],
    trustBadges: [
      { title: "Turvallinen & Luotettava", sub: "Suojattu data" },
      { title: "Skaalautuva",              sub: "Joustava suorituskyky" },
      { title: "Taysintegraatio",          sub: "App + Web + IoT + AI" },
      { title: "Kaytettavyys",             sub: "99,9% kayntiaste" },
    ],
  },
  ru: {
    badge: "CIFROVAYA EKOSISTEMA ACQUAFY",
    h1part1: "Platforma ",
    h1part2: "Umnoe Prilozhenie",
    subtitle: "Globalnoe upravlenie, App + AI + IoT v edinom opyte dlya media, partnerov, prodazh i operacij s umnoj vodoj.",
    cta: "Zaprosit demonstraciyu",
    mockupAlt: "Platforma Acquafy — planshet i smartfon",
    featureCards: [
      { title: "Cloud Platform",       desc: "Bezopasnaya i masshtabiruemaya infrastruktura." },
      { title: "App + AI",             desc: "Iskusstvennyj intellekt dlya prinyatiya reshenij i avtomatizacii" },
      { title: "IoT & Ustrojstva",     desc: "Udalennyj monitoring i podklyuchennye datchiki" },
      { title: "Globalnoe Upravlenie", desc: "Rabota v 180+ stranah na 16 yazykah" },
    ],
    trustBadges: [
      { title: "Bezopasno & Nadezhno", sub: "Zashchita dannyh" },
      { title: "Masshtabiruemo",       sub: "Elastichnaya proizvoditelnost" },
      { title: "Polnaya Integraciya",  sub: "App + Web + IoT + AI" },
      { title: "Dostupnost",           sub: "99,9% bezotkaznosti" },
    ],
  },
  ro: {
    badge: "ECOSISTEM DIGITAL ACQUAFY",
    h1part1: "Platforma ",
    h1part2: "Aplicatie Inteligenta",
    subtitle: "Management global, App + AI + IoT intr-o experienta integrata pentru media, parteneri, vanzari si operatiuni de apa inteligenta.",
    cta: "Solicitati o demonstratie",
    mockupAlt: "Platforma Acquafy — tableta si smartphone",
    featureCards: [
      { title: "Cloud Platform",       desc: "Infrastructura sigura si scalabila." },
      { title: "App + AI",             desc: "Inteligenta artificiala pentru decizii si automatizare" },
      { title: "IoT & Dispozitive",    desc: "Monitorizare la distanta si senzori conectati" },
      { title: "Management Global",    desc: "Operatiuni in 180+ tari si 16 limbi" },
    ],
    trustBadges: [
      { title: "Sigur & Fiabil",       sub: "Date protejate" },
      { title: "Scalabil",             sub: "Performanta elastica" },
      { title: "Integrare Totala",     sub: "App + Web + IoT + AI" },
      { title: "Disponibilitate",      sub: "99,9% uptime" },
    ],
  },
  he: {
    badge: "ECOSISTEM DIJITAL ACQUAFY",
    h1part1: "Platformah ",
    h1part2: "Yiyum Haqir",
    subtitle: "Nihul glubali, App + AI + IoT betajribah meshulevet lemedia, shutafim, mekhirot upeulot mayim hakhukhim.",
    cta: "Bakesh demo",
    mockupAlt: "Platformat Acquafy — tablet usmartphone",
    featureCards: [
      { title: "Cloud Platform",    desc: "Tashitit betukhah venikpetzet." },
      { title: "App + AI",          desc: "Binah melakutit lehakhlatatot veotomatizatziah" },
      { title: "IoT & Hakhanot",    desc: "Nitur merakhok vekhashanim mekhubarim" },
      { title: "Nihul Glubali",     desc: "Peulah be-180+ aratzot ve-16 safot" },
    ],
    trustBadges: [
      { title: "Batuakh & Amin",    sub: "Netunim mehugganim" },
      { title: "Nikpatz",           sub: "Biztsuim gmuishim" },
      { title: "Integratzia Melea", sub: "App + Web + IoT + AI" },
      { title: "Zaminut",           sub: "99.9% uptime" },
    ],
  },
};
