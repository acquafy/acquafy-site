...
const T: Record<Lang, {
  ...
  "en-gb": { baseConhecimento: "Knowledge Base",        artigos: "Articles",  minLeitura: "min read",        nestaCategoria: "In this category",      artigosPopulares: "Popular articles",     outrosArtigos: "Other articles in", verTodos: "View all"      },
  es:      { baseConhecimento: "Base de Conocimiento",  artigos: "Articulos", minLeitura: "min de lectura",  nestaCategoria: "En esta categoria",     artigosPopulares: "Articulos populares",  outrosArtigos: "Otros articulos en",verTodos: "Ver todos"     },
  fr:      { baseConhecimento: "Base de Connaissances", artigos: "Articles",  minLeitura: "min de lecture",  nestaCategoria: "Dans cette categorie",  artigosPopulares: "Articles populaires",  outrosArtigos: "Autres articles en",verTodos: "Voir tout"     },
  ...
  sv:      { baseConhecimento: "Kunskapsbas",            artigos: "Artiklar",  minLeitura: "min lasning",     nestaCategoria: "I denna kategori",      artigosPopulares: "Populara artiklar",    outrosArtigos: "Andra artiklar i",  verTodos: "Visa alla"     },
  fi:      { baseConhecimento: "Tietopohja",             artigos: "Artikkelit",minLeitura: "min lukuaika",    nestaCategoria: "Tassa kategoriassa",    artigosPopulares: "Suositut artikkelit",  outrosArtigos: "Muut artikkelit:",  verTodos: "Nayta kaikki" },
  ru:      { baseConhecimento: "База знаний",            artigos: "Статьи",    minLeitura: "мин чтения",      nestaCategoria: "В этой категории",      artigosPopulares: "Популярные статьи",    outrosArtigos: "Другие статьи в",   verTodos: "Смотреть все"  },
  ro:      { baseConhecimento: "Baza de cunostinte",     artigos: "Articole",  minLeitura: "min citire",      nestaCategoria: "In aceasta categorie",  artigosPopulares: "Articole populare",    outrosArtigos: "Alte articole in",  verTodos: "Vezi toate"    },
  he:      { baseConhecimento: "בסיס ידע",               artigos: "מאמרים",    minLeitura: "דקות קריאה",      nestaCategoria: "בקטגוריה זו",           artigosPopulares: "מאמרים פופולריים",     outrosArtigos: "מאמרים נוספים ב",   verTodos: "הצג הכל"       },
};
