...
const T: Record<Lang, {
  ...
  sv:      { baseConhecimento: "Kunskapsbas",            artigos: "Artiklar",  minLeitura: "min läsning",     nestaCategoria: "I denna kategori",      artigosPopulares: "Populära artiklar",    outrosArtigos: "Andra artiklar i",  verTodos: "Visa alla"     },
  fi:      { baseConhecimento: "Tietopohja",             artigos: "Artikkelit",minLeitura: "min lukuaika",    nestaCategoria: "Tässä kategoriassa",    artigosPopulares: "Suositut artikkelit",  outrosArtigos: "Muut artikkelit:",  verTodos: "Näytä kaikki" },
