...
const T: Record<Lang, {
  ...
  sv: {
    ...
    features: [
      ...
      { title: "Personaliserat vatten", desc: "Temperaturer och funktioner för varje stund." },
      { title: "Hög prestanda",      desc: "Global teknik och filter av senaste generationen." },
      { title: "Globalt design",     desc: "Sofistikerad, prisbelönt finish." },
    ],
    stats: [
      { title: "Teknik + AI",        desc: "Artificiell intelligens tillämpat på vattenupplevelsen" },
      { title: "Premium rening",     desc: "Rent, säkert vatten av överlegen kvalitet" },
      { title: "Global anslutning",  desc: "Smarta lösningar med IoT och realtidshantering" },
      { title: "Hållbarhet",         desc: "Positiv inverkan på människor, samhällen och planeten" },
    ],
  },
  fi: {
    desc: "Äly-vedenpuhdistimet jokaiseen elämäntapaan, globaalilla teknologialla, App + AI + IoT sekä Essentials & Premium -vaihtoehdoilla.",
    features: [
      { title: "App Acquafy",        desc: "Täysinen hallinta sovelluksesta mistä tahansa." },
    ...
    stats: [
      { title: "Teknologia + AI",    desc: "Tekoäly sovellettuna vesikokemukseen" },
      { title: "Premium-puhdistus",  desc: "Puhdas, turvallinen ja korkealaatuinen vesi" },
      { title: "Globaali yhteys",    desc: "Äly-ratkaisut IoT:lla ja reaaliaikaisella hallinnalla" },
      { title: "Kestävyys",          desc: "Positiivinen vaikutus ihmisiin, yhteisöihin ja planeettaan" },
    ],
  },
  ru: {
