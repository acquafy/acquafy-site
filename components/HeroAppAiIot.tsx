...
const T: Record<Lang, {
  ...
  sv: {
    ...
    mockupAlt: "App Acquafy — surfplatta och smartphone",
  },
  fi: {
    label: "ACQUAFY YHDISTETTY EKOSYSTEEMI",
    description: "Hallitse suodattimia, valvo laitteita, vastaanota alokkaat havainnoinnit ja hallitse koko toimintaa integroidussa kokemuksessa.",
    badges: [
      { title: "App Acquafy", desc: "Kauko-ohjaus, laitteiden tila ja tuki kamenessasi." },
      { title: "Acquafy AI", desc: "Tekoaly oivallusten, automaatioiden ja nopeampien paatoksen tueksi." },
      { title: "IoT & Laitteet", desc: "Anturit, yhteydet ja reaaliaikainen valvonta." },
    ],
    btnPrimary: "Lataa sovellus",
    btnSecondary: "Tutustu ominaisuuksiin",
    mockupAlt: "App Acquafy — tabletti ja alypuhelin",
  },
  ru: {
    label: "СВЯЗАННАЯ ЭКОСИСТЕМА ACQUAFY",
    description: "Управляйте очистителями, отслеживайте устройства, получайте умные оповещения и управляйте всей операцией в едином интегрированном опыте.",
    badges: [
      { title: "App Acquafy", desc: "Дистанционное управление, статус оборудования и поддержка под рукой." },
      { title: "Acquafy AI", desc: "Искусственный интеллект для аналитики, автоматизации и быстрых решений." },
      { title: "IoT & Устройства", desc: "Датчики, подключение и мониторинг в режиме реального времени." },
    ],
    btnPrimary: "Скачать приложение",
    btnSecondary: "Изучить функции",
    mockupAlt: "App Acquafy — планшет и смартфон",
  },
  ro: {
    label: "ECOSISTEMUL CONECTAT ACQUAFY",
    description: "Controleaza purificatoarele, monitorizeaza dispozitivele, primeste alerte inteligente si gestioneaza intreaga operatiune intr-o experienta integrata.",
    badges: [
      { title: "App Acquafy", desc: "Telecomanda, statusul echipamentului si suport la indemana." },
      { title: "Acquafy AI", desc: "Inteligenta artificiala pentru informatii, automatizari si decizii mai rapide." },
      { title: "IoT & Dispozitive", desc: "Senzori, conectivitate si monitorizare in timp real." },
    ],
    btnPrimary: "Descarca aplicatia",
    btnSecondary: "Exploreaza functiile",
    mockupAlt: "App Acquafy — tableta si smartphone",
  },
  he: {
    label: "המערכת האקולוגית המחוברת של ACQUAFY",
    description: "שלוט במטהרים שלך, נטר מכשירים, קבל התראות חכמות ונהל את כל הפעולה בחוויה משולבת.",
    badges: [
      { title: "App Acquafy", desc: "שליטה מרחוק, סטטוס הציוד ותמיכה בקצה האצבע." },
      { title: "Acquafy AI", desc: "בינה מלאכותית לתובנות, אוטומציות והחלטות מהירות יותר." },
      { title: "IoT ומכשירים", desc: "חיישנים, קישוריות וניטור בזמן אמת." },
    ],
    btnPrimary: "הורד את האפליקציה",
    btnSecondary: "גלה את התכונות",
    mockupAlt: "App Acquafy — טאבלט וסמארטפון",
  },
  "pt-pt": {
    label: "ECOSSISTEMA CONECTADO ACQUAFY",
