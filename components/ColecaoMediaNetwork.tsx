...
const T: Record<Lang, {
  ...
  "en-gb": {
    ...
    products: [
      ...
      { title: "Banner / Backdrop",          desc: "Ideal for events and promotional actions." },
      { title: "Promoter Uniform",           desc: "T-Shirt - Cap for promoters and team." },
      { title: "Other Suggested Materials",  desc: "Silicone bracelet, key ring, pen, notepad and other items." },
    ],
    cta: "Become a Partner",
  },
  es: {
  ...
  sv: {
    heading: "Tillbehör för Acquafy",
    products: [
      { title: "Exklusiv Mugg",              desc: "Gåva för evenemang och aktiveringar" },
      { title: "T-Shirt",                    desc: "Standarduniform för team och marknadsförare" },
      { title: "Keps",                       desc: "Visuell identitet för fältteam." },
      { title: "750ml Flaska",               desc: "Praktisk, hållbar och idealisk för aktiviteter och gåvor." },
      { title: "Tygkasse",                   desc: "För kit, gåvor och marknadsföringsmaterial." },
      { title: "Knapp (Brosch)",             desc: "Teampromotion och identifiering." },
      { title: "Klistermärke / Biljett",     desc: "För muggar, utrustning och skyltfönster." },
      { title: "Visitkort",                  desc: "För partners och annonsörer." },
      { title: "Broschyr / Flyer",           desc: "Material för uppsökande verksamhet och marknadsföring." },
      { title: "Banner / Backdrop",          desc: "Idealisk för evenemang och marknadsföringsaktiviteter." },
      { title: "Marknadsföraruniform",       desc: "T-Shirt - Keps för marknadsförare och team." },
      { title: "Annat föreslagen material",  desc: "Silikonarmband, nyckelring, penna, anteckningsblock och andra föremål." },
    ],
    cta: "Bli partner",
  },
  fi: {
    heading: "Lisävarusteet Acquafylle",
    products: [
      { title: "Eksklusiivinen Muki",        desc: "Lahja tapahtumiin ja aktivointeihin" },
      { title: "T-paita",                    desc: "Vakioasu tiimeille ja myynninedistäjille" },
      { title: "Lippalakki",                 desc: "Visuaalinen identiteetti kenttätiimeille." },
      { title: "750ml Pullo",                desc: "Käytännöllinen, kestävä ja ihanteellinen kampanjoihin ja lahjoihin." },
      { title: "Kangaskassi",                desc: "Paketteja, lahjoja ja markkinointimateriaaleja varten." },
      { title: "Nappi (Rintaneula)",         desc: "Tiimin promootio ja tunnistaminen." },
      { title: "Tarra / Lipuke",             desc: "Mukeille, laitteille ja näyteikkunoille." },
      { title: "Käyntikortti",               desc: "Kumppaneille ja mainostajille." },
      { title: "Esite / Flyer",              desc: "Materiaalia tiedottamiseen ja markkinointiin." },
      { title: "Banneri / Taustakuva",       desc: "Ihanteellinen tapahtumiin ja markkinointikampanjoihin." },
      { title: "Myynninedistäjän asu",       desc: "T-paita - Lippalakki myynninedistäjille ja tiimille." },
      { title: "Muut suositellut materiaalit", desc: "Silikoniarmband, avaimenperä, kynä, muistilehtiö ja muut tuotteet." },
    ],
    cta: "Ryhdy kumppaniksi",
  },
  ru: {
    heading: "Аксессуары для Acquafy",
    products: [
      { title: "Эксклюзивный стакан",        desc: "Подарок для мероприятий и акций" },
      { title: "Футболка",                   desc: "Стандартная форма для команд и промоутеров" },
      { title: "Кепка",                      desc: "Визуальная идентичность для полевых команд." },
      { title: "Бутылка 750 мл",             desc: "Практичная, экологичная и идеальная для акций и подарков." },
      { title: "Сумка-шоппер",               desc: "Для наборов, подарков и рекламных материалов." },
      { title: "Значок (Брошь)",             desc: "Продвижение и идентификация команды." },
      { title: "Стикер / Билет",             desc: "Для стаканов, оборудования и витрин." },
      { title: "Визитная карточка",          desc: "Для партнёров и рекламодателей." },
      { title: "Листовка / Флаер",           desc: "Материал для охвата аудитории и продвижения." },
      { title: "Баннер / Задник",            desc: "Идеально для мероприятий и рекламных акций." },
      { title: "Форма промоутера",           desc: "Футболка - Кепка для промоутеров и команды." },
      { title: "Другие рекомендуемые материалы", desc: "Силиконовый браслет, брелок, ручка, блокнот и другие изделия." },
    ],
    cta: "Стать партнёром",
  },
  ro: {
    heading: "Accesorii pentru Acquafy",
    products: [
      { title: "Pahar Exclusiv",             desc: "Cadou pentru evenimente si activari" },
      { title: "Tricou",                     desc: "Uniforma standard pentru echipe si promotori" },
      { title: "Sapca",                      desc: "Identitate vizuala pentru echipele de teren." },
      { title: "Sticla de 750ml",            desc: "Practica, durabila si ideala pentru actiuni si cadouri." },
      { title: "Punga",                      desc: "Pentru kituri, cadouri si materiale promotionale." },
      { title: "Insigna (Brosa)",            desc: "Promovarea si identificarea echipei." },
      { title: "Autocolant / Bilet",         desc: "Pentru pahare, echipamente si vitrine." },
      { title: "Carte de Vizita",            desc: "Pentru parteneri si agentii de publicitate." },
      { title: "Pliant / Flyer",             desc: "Material pentru comunicare si promovare." },
      { title: "Banner / Fundal",            desc: "Ideal pentru evenimente si actiuni promotionale." },
      { title: "Uniforma Promotor",          desc: "Tricou - Sapca pentru promotori si echipa." },
      { title: "Alte Materiale Sugerate",    desc: "Bratara silicon, breloc, pix, bloc de notite si alte articole." },
    ],
    cta: "Devino Partener",
  },
  he: {
    heading: "אביזרים עבור Acquafy",
    products: [
      { title: "ספל בלעדי",                 desc: "מתנה לאירועים ואקטיבציות" },
      { title: "חולצת טי",                  desc: "מדים סטנדרטיים לצוותים ולמקדמים" },
      { title: "כובע מצחייה",               desc: "זהות ויזואלית לצוותי שטח." },
      { title: "בקבוק 750 מ\"ל",            desc: "מעשי, בר-קיימא ואידיאלי לפעולות ומתנות." },
      { title: "תיק קניות",                 desc: "לערכות, מתנות וחומרים פרסומיים." },
      { title: "סיכה (ברוש)",               desc: "קידום וזיהוי הצוות." },
      { title: "מדבקה / כרטיס",             desc: "לספלים, ציוד וחלונות ראווה." },
      { title: "כרטיס ביקור",               desc: "לשותפים ולמפרסמים." },
      { title: "עלון / פלייר",              desc: "חומר להפצה וקידום." },
      { title: "באנר / רקע",               desc: "אידיאלי לאירועים ופעולות קידום מכירות." },
      { title: "מדים למקדם",               desc: "חולצת טי - כובע מצחייה למקדמים ולצוות." },
      { title: "חומרים מוצעים נוספים",      desc: "צמיד סיליקון, מחזיק מפתחות, עט, פנקס ופריטים נוספים." },
    ],
    cta: "הפוך לשותף",
  },
};
