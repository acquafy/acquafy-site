...
const T: Record<Lang, {
  ...
  "pt-pt": {
    title:         "Bem-vindo à Base de Conhecimento Acquafy",
    subtitle:      "Estamos aqui para ajudar.",
    description:   "A nossa equipa e recursos estão prontos para oferecer a melhor experiência com os produtos e soluções Acquafy. Encontre respostas, tutoriais e suporte especializado sempre que precisar.",
    placeholder:   "Pesquisar parceiros, vendas, produtos...",
  ...
  fr: {
    title:         "Bienvenue dans la Base de Connaissances Acquafy",
    subtitle:      "Nous sommes là pour vous aider.",
    description:   "Notre équipe et nos ressources sont prêtes à offrir la meilleure expérience avec les produits et solutions Acquafy. Trouvez des réponses, des tutoriels et un support spécialisé quand vous en avez besoin.",
    placeholder:   "Rechercher partenaires, ventes, produits...",
    clearLabel:    "Effacer la recherche",
    noResultPrefix: "Aucun résultat pour",
  ...
  de: {
    title:         "Willkommen in der Acquafy Wissensdatenbank",
    subtitle:      "Wir sind für Sie da.",
    description:   "Unser Team und unsere Ressourcen sind bereit, die beste Erfahrung mit Acquafy-Produkten und -Lösungen zu bieten. Finden Sie jederzeit Antworten, Tutorials und spezialisierten Support.",
    placeholder:   "Partner, Vertrieb, Produkte suchen...",
    clearLabel:    "Suche löschen",
    noResultPrefix: "Keine Ergebnisse für",
    showing:       "Anzeige von",
    of:            "von",
    results:       "Ergebnissen",
    for:           "für",
  ...
  it: {
    title:         "Benvenuto nella Knowledge Base Acquafy",
    subtitle:      "Siamo qui per aiutarti.",
    description:   "Il nostro team e le nostre risorse sono pronti a offrirti la migliore esperienza con i prodotti e le soluzioni Acquafy. Trova risposte, tutorial e supporto specializzato ogni volta che ne hai bisogno.",
    placeholder:   "Cerca partner, vendite, prodotti...",
    clearLabel:    "Cancella ricerca",
    noResultPrefix: "Nessun risultato per",
    showing:       "Visualizzazione di",
    of:            "di",
    results:       "risultati",
    for:           "per",
    openChat:      "Apri chat",
    talkExpert:    "Parla con uno specialista",
    viewArticles:  "Vedi articoli",
  },
  zh: {
    title:         "欢迎来到 Acquafy 知识库",
    subtitle:      "我们随时为您提供帮助。",
    description:   "我们的团队和资源随时准备为您提供最佳的 Acquafy 产品和解决方案体验。随时查找答案、教程和专业支持。",
    placeholder:   "搜索合作伙伴、销售、产品...",
    clearLabel:    "清除搜索",
    noResultPrefix: "未找到结果",
    showing:       "显示",
    of:            "/",
    results:       "条结果",
    for:           "关于",
  ...
  ja: {
    title:         "Acquafy ナレッジベースへようこそ",
    subtitle:      "私たちはお客様をサポートするためにここにいます。",
    description:   "私たちのチームとリソースは、Acquafy の製品とソリューションで最高の体験を提供する準備ができています。必要なときにいつでも回答、チュートリアル、専門サポートをご利用ください。",
    placeholder:   "パートナー、営業、製品を検索...",
    clearLabel:    "検索をクリア",
    noResultPrefix: "結果が見つかりません",
    showing:       "表示中",
    of:            "/",
    results:       "件の結果",
    for:           "キーワード:",
  ...
  ko: {
    title:         "Acquafy 지식 베이스에 오신 것을 환영합니다",
    subtitle:      "저희가 도와드리겠습니다.",
    description:   "저희 팀과 리소스는 Acquafy 제품 및 솔루션으로 최상의 경험을 제공할 준비가 되어 있습니다. 필요할 때마다 답변, 튜토리얼 및 전문 지원을 찾아보세요.",
    placeholder:   "파트너, 판매, 제품 검색...",
    clearLabel:    "검색 지우기",
    noResultPrefix: "결과 없음",
    showing:       "표시 중",
    of:            "/",
    results:       "개 결과",
    for:           "검색어:",
