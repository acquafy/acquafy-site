...
const T: Record<Lang, {
  ...
  "en-gb": {
    ...
    card2Title: "Acquafy AI in the App",
    card2Subtitle: "Artificial intelligence that learns, analyses and takes care of your water.",
    card2Items: [
      "Smart 24/7 support",
      "Filter alerts",
  ...
  sv: {
    ...
    card1Items: [
      ...
      "Vattenstatus i realtid",
      "Full kommunikation med App + AI",
      "Smarta aviseringar",
    ],
    card2Title: "Acquafy AI i appen",
    card2Subtitle: "Artificiell intelligens som lär sig, analyserar och tar hand om ditt vatten.",
    card2Items: [
      "Smart support dygnet runt",
      "Filteraviseringar",
      "Personliga rekommendationer",
      "Analys av konsumtion och hydrering",
      "Utrustningsövervakning",
      "AI-ansluten upplevelse",
    ],
    card3Title: "Styr allt via Acquafy-appen",
    card3Items: [
      "Filtrets livslängd",
      "Anslutna enheter",
    ...
    card1Title1: "LED ",
    card1Title2: "Älykäs kosketuspaneeli",
    card1Items: [
      "365 päivän lähtölaskenta suodattimen vaihtoon",
      "Digitaalinen kello ja päivämäärä",
      "Vedentila reaaliajassa",
      "Täydellinen viestintä App + AI:n kanssa",
      "Älykkäät hälytykset",
    ],
    card2Title: "Acquafy AI sovelluksessa",
    card2Subtitle: "Tekoäly, joka oppii, analysoi ja huolehtii vedestäsi.",
    card2Items: [
      "Älykäs tuki 24/7",
      "Suodatinhälytykset",
    ...
    card3Title: "Hallitse kaikkea Acquafy-sovelluksella",
    card3Items: [
  ...
  ru: {
    card1Title1: "LED ",
    card1Title2: "Умная сенсорная панель",
    card1Items: [
      "Обратный отсчёт 365 дней до замены фильтров",
      "Цифровые часы и дата",
      "Состояние воды в реальном времени",
      "Полная связь с App + AI",
      "Умные оповещения",
    ],
    card2Title: "Acquafy AI в приложении",
    card2Subtitle: "Искусственный интеллект, который учится, анализирует и заботится о вашей воде.",
    card2Items: [
      ...
      "Опыт с подключением AI",
    ],
    card3Title: "Управляйте всем через приложение Acquafy",
    card3Items: [
  ...
  ro: {
    card1Title1: "Panou LED ",
    card1Title2: "Touch Inteligent",
    card1Items: [
      "Numărătoare inversă de 365 de zile până la schimbarea filtrelor",
      "Ceas digital si data",
      "Starea apei în timp real",
      "Comunicare totală cu App + AI",
      "Alerte inteligente",
    ],
    card2Title: "Acquafy AI în aplicatie",
    card2Subtitle: "Inteligenta artificială care învată, analizează si are grijă de apa ta.",
    card2Items: [
      "Suport inteligent 24/7",
      "Alerte filtre",
      "Recomandări personalizate",
      "Analiza consumului si hidratării",
      "Monitorizarea echipamentului",
      "Experienta conectată cu AI",
    ],
    card3Title: "Controlează totul prin aplicatia Acquafy",
    card3Items: [
      "Durata de viată a filtrelor",
  ...
  he: {
    card1Title1: "LED ",
    card1Title2: "לוח מגע חכם",
    card1Items: [
      "ספירה לאחור של 365 יום עד להחלפת המסננים",
      "שעון דיגיטלי ותאריך",
      "מצב המים בזמן אמת",
      "תקשורת מלאה עם האפליקציה + AI",
      "התראות חכמות",
    ],
    card2Title: "Acquafy AI באפליקציה",
    card2Subtitle: "בינה מלאכותית שלומדת, מנתחת ודואגת למימך.",
    card2Items: [
      "תמיכה חכמה 24/7",
      "התראות מסננים",
    ...
    card3Title: "שלוט בהכל דרך אפליקציית Acquafy",
    card3Items: [
      "אורך חיי המסנן",
      "מכשירים מחוברים",
      "תמיכה מהירה וישירה",
