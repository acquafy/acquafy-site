...
const T: Record<Lang, {
  ...
  fr: {
    ...
    features: [
      { title: "Tableau de bord global", desc: "Vue complete de l'activite en temps reel." },
      { title: "Partenaires",            desc: "Gestion des partenaires et des niveaux." },
      { title: "Codes QR",               desc: "Creation et gestion des codes QR." },
      { title: "Media Network",          desc: "Gestion des medias et des campagnes." },
      ...
      { title: "Carte Mondiale",         desc: "Operation mondiale et multi-region." },
      { title: "Parametres",             desc: "Reglages, utilisateurs et permissions." },
    ],
  },
  de: {
    ...
    features: [
      { title: "Globales Dashboard",  desc: "Vollstandiger Unternehmensüberblick in Echtzeit." },
  ...
  sv: {
    ...
    features: [
      { title: "Global instrumentpanel", desc: "Fullstandig affarsoversikt i realtid." },
      { title: "Partners",               desc: "Hantering av partners och niva." },
      { title: "QR-koder",               desc: "Skapande och hantering av QR-koder." },
      { title: "Media Network",          desc: "Hantering av media och kampanjer." },
      { title: "Neo-produkter",          desc: "Katalog over Neo-linjen och tillbehor." },
      { title: "Forsaljning",            desc: "Ordrar, kunder och fakturering." },
      { title: "Provisioner",            desc: "Berakning och betalning av provisioner." },
      { title: "App + IoT + AI",         desc: "Enheter, IoT och intelligens." },
      { title: "Global karta",           desc: "Global och multi-regional drift." },
      { title: "Installningar",          desc: "Justeringar, anvandare och behorigheter." },
    ],
  },
  fi: {
    heading1: "Kaikki yhdessa ",
    heading2: "alustassa",
    features: [
