...
const T: Record<Lang, {
  ...
  sv: {
    ...
    phoneTitle: "Telefon / WhatsApp",
    phoneLines: ["+1 (321) 888-7963", "Måndag till fredag, 8–18 (EST)"],
    ...
    phoneLines: ["+1 (321) 888-7963", "Maanantai–perjantai, 8–18 (EST)"],
  ...
  ru: {
    ...
    phoneLines: ["+1 (321) 888-7963", "Понедельник–пятница, 8:00–18:00 (EST)"],
  ...
  ro: {
    ...
    phoneTitle: "Telefon / WhatsApp",
    phoneLines: ["+1 (321) 888-7963", "Luni pana vineri, 8:00–18:00 (EST)"],
  ...
  he: {
    ...
    phoneLines: ["+1 (321) 888-7963", "שני עד שישי, 8:00–18:00 (EST)"],
