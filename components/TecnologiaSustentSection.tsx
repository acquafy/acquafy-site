...
const T: Record<Lang, {
  ...
  sv: {
    infoTitle: "Hållbarhet i varje droppe",
    infoParagraph: "Vi tror att teknologi måste gå hand i hand med miljöansvar. Därför är våra lösningar utformade för att minska resursförbrukning, eliminera engångsmaterial av plast och skapa verklig positiv påverkan.",
    infoCta: "Utforska våra hållbara initiativ",
    sustCards: [
      { icon: imgPlastico, aspectW: 405, aspectH: 643, title: "Mindre engångsmaterial av plast", description: "Vi minskar miljontals plastflaskor genom att erbjuda tillgängligt rent vatten på strategiska platser." },
      { icon: imgEnergia, aspectW: 492, aspectH: 492, title: "Medveten energiförbrukning", description: "Effektiva och intelligenta apparater som optimerar energiförbrukningen." },
      { icon: imgReciclavel, aspectW: 30, aspectH: 30, title: "Återvinningsbara och hållbara material", description: "Högkvalitativa återvinningsbara komponenter utformade för lång livslängd." },
      { icon: imgPreservAgua, aspectW: 643, aspectH: 631, title: "Vattenbevarande", description: "Teknik som sparar vatten i varje steg av reningsprocessen." },
    ],
    stats: [
      { value: "+50M",          label: "positivt påverkade människor",            icon: imgStatsPessoas,   aspectW: 43.86,  aspectH: 40.50  },
      { value: "+2 000",        label: "ton plast undvikt per år",                icon: imgStatsAgua,      aspectW: 40,     aspectH: 40     },
      { value: "+15M",          label: "liter vatten sparat per år",              icon: imgStatsPlanta,    aspectW: 335.36, aspectH: 361.50 },
      { value: "+180 länder",   label: "påverkade och i expansion",               icon: imgStatsPlanetWeb, aspectW: 30,     aspectH: 30     },
    ],
    ctaTitle: "Innovation som tar hand om människor och planeten samtidigt.",
    ctaBtn: "Bli en del av denna transformation",
  },
  fi: {
    infoTitle: "Kestävyys jokaisessa pisarassa",
    infoParagraph: "Uskomme, että teknologian on kuljettava käsi kädessä ympäristövastuun kanssa. Siksi ratkaisumme on suunniteltu vähentämään resurssien kulutusta, poistamaan kertakäyttöiset muovit ja luomaan todellisia positiivisia vaikutuksia.",
    infoCta: "Tutustu kestäviin aloitteisiimme",
    sustCards: [
      { icon: imgPlastico, aspectW: 405, aspectH: 643, title: "Vähemmän kertakäyttömuoveja", description: "Vähennämme miljoonia muovipulloja tarjoamalla puhdasta vettä strategisissa paikoissa." },
      { icon: imgEnergia, aspectW: 492, aspectH: 492, title: "Tietoinen energiankulutus", description: "Tehokkaat ja älykkäät laitteet, jotka optimoivat energiankulutuksen." },
      { icon: imgReciclavel, aspectW: 30, aspectH: 30, title: "Kierrätyskelpoiset ja kestävät materiaalit", description: "Korkealaatuiset kierrätyskelpoiset komponentit, jotka on suunniteltu pitkälle käyttöiälle." },
      { icon: imgPreservAgua, aspectW: 643, aspectH: 631, title: "Veden suojelu", description: "Teknologiat, jotka säästävät vettä jokaisessa puhdistusprosessin vaiheessa." },
    ],
    stats: [
      { value: "+50M",          label: "positiivisesti vaikutettuihin ihmisiin",  icon: imgStatsPessoas,   aspectW: 43.86,  aspectH: 40.50  },
      { value: "+2 000",        label: "tonnia muovia vältetty vuodessa",          icon: imgStatsAgua,      aspectW: 40,     aspectH: 40     },
      { value: "+15M",          label: "litraa vettä säästetty vuodessa",          icon: imgStatsPlanta,    aspectW: 335.36, aspectH: 361.50 },
      { value: "+180 maata",    label: "vaikutettu ja laajenemassa",               icon: imgStatsPlanetWeb, aspectW: 30,     aspectH: 30     },
    ],
    ctaTitle: "Innovaatio, joka huolehtii ihmisistä ja planeetasta samanaikaisesti.",
    ctaBtn: "Ole osa tätä muutosta",
  },
  ru: {
