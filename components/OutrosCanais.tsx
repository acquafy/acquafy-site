...
const T: Record<Lang, {
  ...
  "en-gb": {
    heading: "Other Channels",
    subtitle: "Choose the channel you prefer to speak to us",
    agendarAssunto: "Book a Meeting",
    modal: {
      title: "Subscribe to the Newsletter",
      desc: "Receive news, updates and exclusive content from Acquafy.",
      checkboxText: "I have read and agree to the ",
    ...
    cards: [
      ...
      { title: "WhatsApp",           desc: "Quick support via WhatsApp.",                  cta: "Open WhatsApp" },
      { title: "Call Us",            desc: "Get in touch directly.",                       cta: "Call Now" },
      { title: "Book a Meeting",     desc: "Book a conversation with a specialist.",       cta: "Book" },
      { title: "Newsletter",         desc: "Receive Acquafy news and updates.",            cta: "Subscribe" },
    ],
  },
  es: {
  ...
  sv: {
    heading: "Andra kanaler",
    subtitle: "Välj den kanal du föredrar för att kontakta oss",
    agendarAssunto: "Boka möte",
    modal: {
      title: "Prenumerera på nyhetsbrevet",
      desc: "Ta emot nyheter, uppdateringar och exklusivt innehåll från Acquafy.",
      checkboxText: "Jag har läst och godkänner ",
      termsLink: "Användarvillkoren",
      checkboxSuffix: " för Acquafys nyhetsbrev",
      cancelBtn: "Avbryt",
      submitBtn: "Prenumerera",
    },
    cards: [
      { title: "Online-chatt",   desc: "Prata med vårt team i realtid.",                 cta: "Starta chatt" },
      { title: "WhatsApp",       desc: "Snabb support via WhatsApp.",                    cta: "Öppna WhatsApp" },
      { title: "Ring oss",       desc: "Kontakta oss direkt.",                           cta: "Ring nu" },
      { title: "Boka möte",      desc: "Boka ett samtal med en specialist.",             cta: "Boka" },
      { title: "Nyhetsbrev",     desc: "Ta emot Acquafy-nyheter och uppdateringar.",     cta: "Prenumerera" },
    ],
  },
  fi: {
    heading: "Muut kanavat",
    subtitle: "Valitse haluamasi kanava ottaaksesi meihin yhteyttä",
    agendarAssunto: "Varaa kokous",
    modal: {
      title: "Tilaa uutiskirje",
      desc: "Vastaanota uutisia, päivityksiä ja yksinoikeussisältöä Acquafylta.",
      checkboxText: "Olen lukenut ja hyväksyn ",
      termsLink: "Käyttöehdot",
      checkboxSuffix: " Acquafyn uutiskirjeelle",
      cancelBtn: "Peruuta",
      submitBtn: "Tilaa",
    },
    cards: [
      { title: "Verkkochat",     desc: "Keskustele tiimimme kanssa reaaliajassa.",       cta: "Aloita chat" },
      { title: "WhatsApp",       desc: "Nopea tuki WhatsAppin kautta.",                  cta: "Avaa WhatsApp" },
      { title: "Soita meille",   desc: "Ota suoraan yhteyttä.",                         cta: "Soita nyt" },
      { title: "Varaa kokous",   desc: "Varaa keskustelu asiantuntijan kanssa.",         cta: "Varaa" },
      { title: "Uutiskirje",     desc: "Vastaanota Acquafy-uutisia ja päivityksiä.",     cta: "Tilaa" },
    ],
  },
  ru: {
    heading: "Другие каналы",
    subtitle: "Выберите удобный канал для связи с нами",
    agendarAssunto: "Запланировать встречу",
    modal: {
      title: "Подписаться на рассылку",
      desc: "Получайте новости, обновления и эксклюзивные материалы от Acquafy.",
      checkboxText: "Я прочитал(-а) и согласен(-на) с ",
      termsLink: "Условиями использования",
      checkboxSuffix: " рассылки Acquafy",
      cancelBtn: "Отмена",
      submitBtn: "Подписаться",
    },
    cards: [
      { title: "Онлайн-чат",          desc: "Общайтесь с нашей командой в реальном времени.",    cta: "Начать чат" },
      { title: "WhatsApp",             desc: "Быстрая поддержка через WhatsApp.",                 cta: "Открыть WhatsApp" },
      { title: "Позвоните нам",        desc: "Свяжитесь с нами напрямую.",                       cta: "Позвонить" },
      { title: "Запланировать встречу", desc: "Запишитесь на разговор со специалистом.",         cta: "Запланировать" },
      { title: "Рассылка",             desc: "Получайте новости и обновления Acquafy.",          cta: "Подписаться" },
    ],
  },
  ro: {
    heading: "Alte canale",
    subtitle: "Alege canalul preferat pentru a ne contacta",
    agendarAssunto: "Programeaza o intalnire",
    modal: {
      title: "Aboneaza-te la Newsletter",
      desc: "Primeste stiri, actualizari si continut exclusiv de la Acquafy.",
      checkboxText: "Am citit si sunt de acord cu ",
      termsLink: "Termenii de utilizare",
      checkboxSuffix: " ai Newsletter-ului Acquafy",
      cancelBtn: "Anuleaza",
      submitBtn: "Aboneaza-te",
    },
    cards: [
      { title: "Chat online",          desc: "Vorbeste cu echipa noastra in timp real.",          cta: "Incepe chat-ul" },
      { title: "WhatsApp",             desc: "Suport rapid prin WhatsApp.",                       cta: "Deschide WhatsApp" },
      { title: "Suna-ne",              desc: "Contacteaza-ne direct.",                            cta: "Suna acum" },
      { title: "Programeaza o intalnire", desc: "Programeaza o discutie cu un specialist.",      cta: "Programeaza" },
      { title: "Newsletter",           desc: "Primeste stiri si actualizari Acquafy.",            cta: "Aboneaza-te" },
    ],
  },
  he: {
    heading: "ערוצים נוספים",
    subtitle: "בחר את הערוץ המועדף עליך ליצירת קשר איתנו",
    agendarAssunto: "קביעת פגישה",
    modal: {
      title: "הירשם לניוזלטר",
      desc: "קבל חדשות, עדכונים ותוכן בלעדי מ-Acquafy.",
      checkboxText: "קראתי ואני מסכים/ה ל",
      termsLink: "תנאי השימוש",
      checkboxSuffix: " של ניוזלטר Acquafy",
      cancelBtn: "ביטול",
      submitBtn: "הירשם",
    },
    cards: [
      { title: "צ'אט מקוון",   desc: "שוחח עם הצוות שלנו בזמן אמת.",              cta: "התחל צ'אט" },
      { title: "WhatsApp",     desc: "תמיכה מהירה דרך WhatsApp.",                  cta: "פתח WhatsApp" },
      { title: "התקשר אלינו",  desc: "צור קשר ישירות.",                           cta: "התקשר עכשיו" },
      { title: "קביעת פגישה",  desc: "קבע שיחה עם מומחה.",                        cta: "קבע" },
      { title: "ניוזלטר",      desc: "קבל חדשות ועדכונים מ-Acquafy.",              cta: "הירשם" },
    ],
  },
