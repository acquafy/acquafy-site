...
const T: Record<Lang, {
  ...
  "en-gb": {
    ...
    sections: {
      s1: {
        title: "1. Acceptance of Terms",
        p1: "By accessing and using the acquafy.com website (and its subdomains) or any product, application, or service offered by Acquafy, you declare that you have read, understood, and agreed to these Terms of Use, as well as our Privacy Policy.",
        p2: "If you are accessing the services on behalf of a company or organisation, you declare that you have the authority to bind that entity to these terms.",
      },
      s2: {
        title: "2. About Acquafy",
      ...
      s3: {
        ...
        items: [
          "Using the site in any way that violates applicable laws or regulations",
          "Transmitting any unsolicited advertising or promotional material",
          "Attempting to gain unauthorised access to any part of the site or system",
          "Interfering with or disrupting the integrity or performance of the site",
          "Collecting or harvesting data from other users without consent",
          "Using robots, scrapers or other automated means to access the site",
          "Reverse engineering, decompiling, or disassembling any software on the site",
      ...
      s4: {
        ...
        sub1p: "Some Acquafy features and services may require account registration. When creating an account, you agree to provide true, accurate and complete information.",
        sub2t: "4.2 Account responsibility",
        sub2p: "You are responsible for maintaining the confidentiality of your login credentials and for all activities carried out with your account. Immediately notify Acquafy of any unauthorised use.",
        sub3t: "4.3 Cancellation",
        sub3p: "Acquafy reserves the right to cancel or suspend accounts that violate these Terms, without prior notice.",
      },
      s5: {
      ...
      s6: {
        title: "6. Intellectual Property",
        p1: "All content on the Acquafy website — including texts, images, logos, icons, videos, software and design — is the exclusive property of Acquafy Corporation or its licensors, and is protected by copyright laws, trademarks and other applicable intellectual property laws.",
        p2: "Reproduction, distribution, modification, public display or creation of derivative works from any content on the site without prior written authorisation from Acquafy is prohibited.",
        p3: "The name Acquafy, the logo and other trademarks of Acquafy Corporation are registered or pending trademarks. Their unauthorised use is prohibited.",
      },
      s7: {
        title: "7. Limitation of Liability",
        p1: "To the maximum extent permitted by applicable law, Acquafy shall not be liable for indirect, incidental, special, consequential or punitive damages arising from the use or inability to use the site, products or services.",
      ...
      s10: {
        title: "10. Indemnification",
        p1: "You agree to defend, indemnify and hold harmless Acquafy Corporation, its directors, employees, partners and agents from any claims, liabilities, damages, losses and expenses (including reasonable solicitors' fees) arising from your use of the site or violation of these Terms.",
      },
      s11: {
        title: "11. Modifications to the Terms",
        p1: "Acquafy reserves the right to modify these Terms of Use at any time. Changes will take effect immediately upon publication on the site, with the date updated at the top of this page.",
  ...
  sv: {
    sidebarLabel: "Pa den har sidan",
    navItems: [
      { id: "aceitacao",        label: "1. Acceptans av villkor" },
      { id: "sobre",            label: "2. Om Acquafy" },
      { id: "uso-permitido",    label: "3. Tillaten anvandning" },
      { id: "contas",           label: "4. Anvandarkonton" },
      { id: "produtos",         label: "5. Produkter och tjanster" },
      { id: "propriedade",      label: "6. Immateriell aganderatt" },
      { id: "responsabilidade", label: "7. Ansvarsbegransning" },
      { id: "links",            label: "8. Tredjepartslanklar" },
      { id: "privacidade",      label: "9. Integritet" },
      { id: "indenizacao",      label: "10. Ersattning" },
      { id: "modificacoes",     label: "11. Andringar" },
      { id: "rescisao",         label: "12. Uppsagning" },
      { id: "legislacao",       label: "13. Tillamplig lag" },
      { id: "contato",          label: "14. Kontakt" },
    ],
    ...
    sections: {
      s1: {
        ...
        p1: "Genom att ga in pa och anvanda webbplatsen acquafy.com (och dess underdomaner) eller nagra produkter, applikationer eller tjanster som erbjuds av Acquafy forklarar du att du har last, forstat och accepterat dessa anvandningsvillkor samt var integritetspolicy.",
        p2: "Om du gar in pa tjanster for ett foretags eller en organisations rakning forklarar du att du har behorighet att binda den enheten till dessa villkor.",
      },
      s2: {
        title: "2. Om Acquafy",
      ...
      s3: {
        ...
        p1: "Du far anvanda var webbplats for lagliga andamal och i enlighet med dessa villkor. Foljande ar uttryckligen forbjudet:",
        items: [
          "Anvanda webbplatsen pa ett satt som bryter mot tillampliga lagar eller forordningar",
          "Skicka oansokt reklam- eller marknadsmaterial",
          "Forsoka fa obehoring atkomst till nagon del av webbplatsen eller systemet",
          "Storningar eller avbrott i webbplatsens integritet eller prestanda",
          "Samla in eller skorda data fran andra anvandare utan samtycke",
          "Anvanda robotar, scrapers eller andra automatiserade medel for att komma at webbplatsen",
          "Atervandskonstruera, dekompilera eller demontera programvara pa webbplatsen",
        ],
      },
      s4: {
        title: "4. Registrering och anvandarkonton",
        sub1t: "4.1 Kontoskapande",
        sub1p: "Vissa funktioner och tjanster fran Acquafy kan krova kontoregistrering. Nar du skapar ett konto forbinder du dig att ge sann, korrekt och fullstandig information.",
        sub2t: "4.2 Kontoansvar",
        sub2p: "Du ar ansvarig for att halla dina inloggningsuppgifter konfidentiella och for alla aktiviteter som utfors med ditt konto. Meddela omedelbart Acquafy om obehoring anvandning.",
        sub3t: "4.3 Avslutning",
        sub3p: "Acquafy forbehaller sig ratten att avsluta eller avbryta konton som bryter mot dessa villkor utan forhandsmeddelande.",
      },
      s5: {
        title: "5. Produkter och tjanster",
        sub1t: "5.1 Tillganglighet",
        sub1p: "Acquafy stravar efter att halla sina produkter och tjanster tillgangliga men garanterar inte oavbruten tillganglighet. Planerat underhall eller tekniska problem kan orsaka tillfallig otillganglighet.",
        sub2t: "5.2 Produktbeskrivning",
        sub2p: "Vi gor vart basta for att beskriva vara produkter noggrant. Vi garanterar dock inte att beskrivningar, bilder eller annat innehall pa webbplatsen ar fullstandigt, tillforlitligt, aktuellt eller felfritt.",
        sub3t: "5.3 Priser och betalningar",
        sub3p: "Priser som visas pa webbplatsen kan andras utan foranmalan. Vid prisfel forbehaller sig Acquafy ratten att annullera paverkade bestallningar med forhandsmeddelande till kunden.",
        sub4t: "5.4 App och digital plattform",
        sub4p: "Anvandningen av Acquafy-appen och Global Smart Water Platform ar foremal for specifika villkor som presenteras vid registreringen. Dessa villkor kompletterar dessa allmannar anvandningsvillkor.",
      },
      s6: {
        title: "6. Immateriell aganderatt",
        p1: "Allt innehall pa Acquafys webbplats - inklusive texter, bilder, logotyper, ikoner, videor, programvara och design - ar Acquafy Corporations eller dess licensgivares exklusiva egendom och skyddas av upphovsrattslagar, varumarken och andra tillampliga immateriella rattslagar.",
        p2: "Reproduktion, distribution, modifiering, offentlig visning eller skapande av derivatverk fran innehall pa webbplatsen utan forhandsskrivet tillstand fran Acquafy ar forbjudet.",
        p3: "Acquafy-namnet, logotypen och andra varumarken fran Acquafy Corporation ar registrerade eller oregistrerade varumarken. Obehort anvandning ar forbjuden.",
      },
      s7: {
        title: "7. Ansvarsbegransning",
        p1: "I den maximala utstrackning som tillamplig lag tillater ska Acquafy inte vara ansvarigt for indirekta, oavsiktliga, sarskilda, foljd- eller straffskador till foljd av anvandningen av eller oformaga att anvanda webbplatsen, produkterna eller tjanstterna.",
        p2: "Acquafy ar inte ansvarigt for avbrott orsakade av faktorer utanfor sin kontroll, inklusive tredjepartsinfrastrukturfel, naturkatastrofer eller cyberattacker.",
        p3: "Anvandaren erkanner att anvandning av webbplatsen och tjanstterna sker pa eget risk, inom de granser som anges i lagen.",
      },
      s8: {
        title: "8. Lankar till tredjepartswebbplatser",
        p1: "Var webbplats kan innehalla lankar till tredjepartswebbplatser. Dessa lankar tillhandahalls endast for bekvamlighetens skull och for information. Acquafy har ingen kontroll over innehallet pa dessa webbplatser och ansvarar inte for deras innehall, integritetspraxis eller tillganglighet.",
        p2: "Atkomst till tredjepartswebbplatser ar helt och hallet anvandarens ansvar, och anvandaren bor granska dessa webbplatsers villkor och policyer innan de anvands.",
      },
      s9: {
        title: "9. Integritet och dataskydd",
        p1pre: "Behandlingen av personuppgifter som samlas in av Acquafy regleras av var",
        p1post: ", som ar inkorporerad i dessa anvandningsvillkor. Genom att anvanda vara tjanster samtycker du till datainsamlings- och anvandningsmetoderna som beskrivs i den policyn.",
        p2: "Acquafy ar engagerat i efterlevnad av tillampliga dataskyddslagar, inklusive den allmannar dataskyddsforordningen (GDPR) i Europeiska unionen, dar sa ar tillampligt.",
      },
      s10: {
        title: "10. Ersattning",
        p1: "Du samtycker till att forsvara, ersatta och halla skadeslosa Acquafy Corporation, dess direktorer, anstallda, partners och agenter fran ansprak, ansvar, skador, forluster och utgifter (inklusive rimliga advokatkostnader) som uppstar fran din anvandning av webbplatsen eller brott mot dessa villkor.",
      },
      s11: {
        title: "11. Andring av villkor",
        p1: "Acquafy forbehaller sig ratten att nar som helst andra dessa anvandningsvillkor. Andringar trader i kraft omedelbart efter publicering pa webbplatsen, med uppdatering av datumet overst pa den har sidan.",
        p2: "Fortsatt anvandning av webbplatsen efter publicering av andringar utgor acceptans av de nya villkoren. Vi rekommenderar att du granskar den har sidan regelblundet.",
      },
      s12: {
        title: "12. Uppsagning",
        p1: "Acquafy kan nar som helst avsluta eller avbryta din atkomst till webbplatsen och tjanstterna, med eller utan meddelande, av vilket skal som helst, inklusive brott mot dessa villkor.",
        p2: "Efter uppsagning forblir de bestammelser i dessa villkor som till sin natur bor overleva i kraft, inklusive avsnitten om immateriell aganderatt, garantifriskrivning, ansvarsbegransning och ersattning.",
      },
      s13: {
        title: "13. Tillamplig lag och jurisdiktion",
        p1: "Dessa anvandningsvillkor regleras av lagarna i delstaten Florida, USA, utan att det pagar konsumentskyddslagar som galler i anvandarens bosattningsland.",
        p2: "I Brasilien ar konsumentrelationer med brasilianska anvandare ocksa underkastad konsumentskyddslagen (lag nr 8 078/1990) och tillamplig brasiliansk lagstiftning.",
        p3: "Eventuella tvister som uppstar fran dessa villkor ska foretrasvis losas genom medling. Om det inte ar mojligt valjs domstolarna i Sao Paulo/SP, Brasilien, for brasilianska anvandare, med avstandstagande fran andra domstolar, oavsett hur privilegierade de ar.",
      },
      s14: {
        title: "14. Kontakt",
        p1: "Om du har fragor, forslag eller klagomal relaterade till dessa anvandningsvillkor, kontakta Acquafy:",
      },
    },
  },
  fi: {
    sidebarLabel: "Talla sivulla",
    navItems: [
      { id: "aceitacao",        label: "1. Ehtojen hyvaksyminen" },
      { id: "sobre",            label: "2. Tietoa Acquafysta" },
      { id: "uso-permitido",    label: "3. Sallittu kaytto" },
      { id: "contas",           label: "4. Kayttajatilit" },
      { id: "produtos",         label: "5. Tuotteet ja palvelut" },
      { id: "propriedade",      label: "6. Immateriaalioikeudet" },
      { id: "responsabilidade", label: "7. Vastuunrajoitus" },
      { id: "links",            label: "8. Kolmansien osapuolten linkit" },
      { id: "privacidade",      label: "9. Yksityisyys" },
      { id: "indenizacao",      label: "10. Korvaus" },
      { id: "modificacoes",     label: "11. Muutokset" },
      { id: "rescisao",         label: "12. Irtisanominen" },
      { id: "legislacao",       label: "13. Sovellettava laki" },
    ...
    sections: {
      s1: {
        title: "1. Ehtojen hyvaksyminen",
        p1: "Kayttamalla acquafy.com-verkkosivustoa (ja sen aliverkkotunnuksia) tai mitaan Acquafyn tarjoamaa tuotetta, sovellusta tai palvelua ilmoitat lukeneesi, ymmartvasi ja hyvaksyneesi namat kayttoehdot seka tietosuojakaytantomme.",
        p2: "Jos kaytat palveluita yrityksen tai organisaation puolesta, ilmoitat, etta sinulla on valtuudet sitoa kyseinen taho naiden ehtojen noudattamiseen.",
      },
      s2: {
      ...
      s3: {
        ...
        p1: "Voit kayttaa verkkosivustoamme laillisiin tarkoituksiin naiden ehtojen mukaisesti. Seuraavat toiminnot on nimenomaisesti kielletty:",
        items: [
          "Verkkosivuston kayttaminen tavalla, joka rikkoo sovellettavia lakeja tai maarayksia",
          "Ei-toivotun mainos- tai markkinointimateriaalin lahettaminen",
          "Yritys saada luvaton paasy mihin tahansa sivuston tai jarjestelman osaan",
          "Sivuston eheyden tai suorituskyvyn hairitseminen tai keskeyttaminen",
          "Muiden kayttajien tietojen keraaminen tai korjaaminen ilman suostumusta",
          "Bottien, scrapereiden tai muiden automaattisten keinojen kayttaminen sivustoon paasemiseen",
          "Sivustolla olevan ohjelmiston takaisinmallintaminen, purkaminen tai purkaminen",
        ],
      },
      s4: {
        title: "4. Rekisteroityminen ja kayttajatilit",
        sub1t: "4.1 Tilin luominen",
        sub1p: "Jotkin Acquafyn ominaisuudet ja palvelut saattavat vaatia tilin rekisteroinnin. Luodessasi tilin sitoudut antamaan totuudenmukaiset, tarkat ja taydellisot tiedot.",
        sub2t: "4.2 Tilivastuu",
        sub2p: "Olet vastuussa kirjautumistietojesi luottamuksellisuuden sailyttamisesta ja kaikista tilisi avulla suoritetuista toiminnoista. Ilmoita Acquafylle viipymatta luvattomasta kaytosta.",
        sub3t: "4.3 Peruuttaminen",
        sub3p: "Acquafy pidattaa oikeuden peruuttaa tai keskeyttaa tilit, jotka rikkovat naita ehtoja, ilman etukateisilmoitusta.",
      },
      s5: {
        title: "5. Tuotteet ja palvelut",
        sub1t: "5.1 Saatavuus",
        sub1p: "Acquafy pyrkii pitamaan tuotteensa ja palvelunsa saatavilla, mutta ei takaa keskeytyksetonta saatavuutta. Ajoitettu yllapito tai tekniset ongelmat voivat aiheuttaa tilapaista saatavuuden puutetta.",
        sub2t: "5.2 Tuotekuvaus",
        sub2p: "Teemme parhaamme kuvata tuotteemme tarkasti. Emme kuitenkaan takaa, etta sivuston kuvaukset, kuvat tai muu sisalto on taydellist, luotettavaa, ajantasaista tai virheetonta.",
        sub3t: "5.3 Hinnat ja maksut",
        sub3p: "Sivustolla naytettavat hinnat voivat muuttua ilman etukatisilmoitusta. Hinnoitteluvirheen sattuessa Acquafy pidattaa oikeuden peruuttaa aiheutuneet tilaukset ilmoittamalla asiakkaalle etukaten.",
        sub4t: "5.4 Sovellus ja digitaalinen alusta",
        sub4p: "Acquafy-sovelluksen ja Global Smart Water Platformin kaytto on rekisteroinnin yhteydessa esitettyjen erityisehtojen alainen. Namat ehdot taydentavat naita yleisia kayttoehtoja.",
      },
      s6: {
        title: "6. Immateriaalioikeudet",
        p1: "Kaikki Acquafyn verkkosivuston sisalto - mukaan lukien tekstit, kuvat, logot, kuvakkeet, videot, ohjelmistot ja suunnittelu - on Acquafy Corporationin tai sen lisenssinantajien yksinomaista omaisuutta, ja se on suojattu tekijanoikeuslaeilla, tavaramerkein ja muilla sovellettavilla immateriaalioikeuslaeilla.",
        p2: "Minka tahansa sivuston sisallon jaljentaminen, jakaminen, muuttaminen, julkinen nayttaminen tai johdannaisteosten luominen ilman Acquafyn etukateista kirjallista lupaa on kielletty.",
        p3: "Acquafy-nimi, logo ja muut Acquafy Corporationin tavaramerkit ovat rekisteroituja tai rekisteroinnin kohteena olevia tavaramerkkeja. Niiden luvaton kaytto on kielletty.",
      },
      s7: {
        title: "7. Vastuunrajoitus",
        p1: "Sovellettavan lain sallimassa laajimmassa maarin Acquafy ei ole vastuussa epaasuorista, satunnaisista, erityisista, seuraamuksellisista tai rangaistuksenluontoisista vahingoista, jotka johtuvat sivuston, tuotteiden tai palvelujen kaytosta tai kayttokyvyttomyydesta.",
        p2: "Acquafy ei ole vastuussa sen hallinnan ulkopuolisten tekijoiden aiheuttamista katkoksista, mukaan lukien kolmansien osapuolten infrastruktuuriviat, luonnonkatastrofit tai kyberhyokkaykset.",
        p3: "Kayttaja myontaa, etta sivuston ja palvelujen kaytto tapahtuu omalla riskilla lain maarittamissa rajoissa.",
      },
      s8: {
        title: "8. Linkit kolmansien osapuolten sivustoille",
        p1: "Verkkosivustollamme voi olla linkkeja kolmansien osapuolten verkkosivustoille. Naita linkkeja tarjotaan vain mukavuuden ja tiedotuksen vuoksi. Acquafylla ei ole hallintaa naiden sivustojen sisallosta, eika se ole vastuussa niiden sisallosta, tietosuojakaytannoista tai saatavuudesta.",
        p2: "Kolmansien osapuolten sivustoille paasy on kokonaan kayttajan vastuulla, ja kayttajan tulisi tarkistaa kyseisten sivustojen ehdot ja kaytannot ennen niiden kayttoa.",
      },
      s9: {
        title: "9. Yksityisyys ja tietosuoja",
        p1pre: "Acquafyn keraaman henkilotietojen kasittely on meidanmme saateleman",
        p1post: "maaraama, joka on sisallytetty naihan kayttoehtoihin. Kayttamalla palveluitamme suostut kyseisessa kaytannossa kuvattuihin tietojenkerays- ja kayttomenettelyihin.",
        p2: "Acquafy on sitoutunut noudattamaan sovellettavia tietosuojalakeja, mukaan lukien Euroopan unionin yleinen tietosuoja-asetus (GDPR), siltakin osin kuin se soveltuu.",
      },
      s10: {
        title: "10. Korvaus",
        p1: "Suostut puolustamaan, korvaamaan ja pitamaan vahingottomana Acquafy Corporationin, sen johtajat, tyontekijat, kumppanit ja agentit kaikista vaatimuksista, vastuista, vahingoista, menetyksista ja kuluista (mukaan lukien kohtuulliset asianajajamaksut), jotka johtuvat sivuston kaytostasi tai naiden ehtojen rikkomisesta.",
      },
      s11: {
        title: "11. Ehtojen muuttaminen",
        p1: "Acquafy pidattaa oikeuden muuttaa naita kayttoehtoja milloin tahansa. Muutokset tulevat voimaan heti sivustolla julkaisemisen jalkeen, ja taman sivun ylaosassa oleva paivamara paivitetaan.",
        p2: "Sivuston jatkuva kaytto muutosten julkaisemisen jalkeen muodostaa uusien ehtojen hyvaksymisen. Suosittelemme tarkistamaan taman sivun saannollisesti.",
      },
      s12: {
        title: "12. Irtisanominen",
        p1: "Acquafy voi milloin tahansa ilman etukatisilmoitusta tai sen kanssa lopettaa tai keskeyttaa paasysi sivustoon ja palveluihin mista tahansa syyta, mukaan lukien naiden ehtojen rikkominen.",
        p2: "Irtisanomisen jalkeen naiden ehtojen maaraykset, jotka luonteeltaan tulisi jaada voimaan, jaat voimaan, mukaan lukien immateriaalioikeuksia, takuuvapautuksia, vastuunrajoitusta ja korvausta koskevat osiot.",
      },
      s13: {
        title: "13. Sovellettava laki ja toimivalta",
        p1: "Naita kayttoehtoja saatelee Floridan osavaltion, USA:n, lait, rajoittamatta kayttajan asuinmaassa sovellettavia kuluttajansuojalakeja.",
        p2: "Brasiliassa brasilialaisten kayttajien kuluttajasuhteet ovat myos kuluttajansuojalain (laki nro 8 078/1990) ja sovellettavan brasilialaisen lainsaadannon alaisia.",
        p3: "Naista ehdoista johtuvat riidat ratkaistaan ensisijaisesti sovittelulla. Jos se ei ole mahdollista, brasilialaisia kayttajia varten valitaan Sao Paulo/SP:n, Brasilian, tuomioistuimet, luopuen kaikista muista tuomioistuimista, riippumatta niiden etuoikeutetusta asemasta.",
      },
      s14: {
        title: "14. Yhteystiedot",
        p1: "Jos sinulla on kysymyksia, ehdotuksia tai valituksia liittyen naihan kayttoehtoihin, ota yhteys Acquafyyn:",
      },
    },
  },
  ru: {
    sidebarLabel: "Na etoy stranice",
    navItems: [
      { id: "aceitacao",        label: "1. Prinyatie usloviy" },
      { id: "sobre",            label: "2. Ob Acquafy" },
      { id: "uso-permitido",    label: "3. Razreshyonnoe ispolzovanie" },
      { id: "contas",           label: "4. Uchyotnye zapisi polzovateley" },
      { id: "produtos",         label: "5. Produkty i uslugi" },
      { id: "propriedade",      label: "6. Intellektualnaya sobstvennost" },
      { id: "responsabilidade", label: "7. Ogranichenie otvetstvennosti" },
      { id: "links",            label: "8. Ssylki tretikh storon" },
      { id: "privacidade",      label: "9. Konfidentsialnost" },
      { id: "indenizacao",      label: "10. Vozmeshchenie ushcherba" },
      { id: "modificacoes",     label: "11. Izmeneniya" },
      { id: "rescisao",         label: "12. Rastorzhenie" },
      { id: "legislacao",       label: "13. Primenimoe pravo" },
      { id: "contato",          label: "14. Kontakt" },
    ],
    ...
    sections: {
      s1: {
        title: "1. Prinyatie usloviy",
        p1: "Poseshchaya i ispolzuya sayt acquafy.com (i ego subdomeny) ili lyubыe produkty, prilozheniya ili uslugi, predlagaemye Acquafy, vy zayavlyaete, chto prochitali, ponyali i prinyali nastoyashchie Usloviya ispolzovaniya, a takzhe nashu Politiku konfidentsialnosti.",
        p2: "Esli vy polzuetes uslugami ot imeni kompanii ili organizatsii, vy zayavlyaete, chto imeyete polnomochiya svyazyvat etu organizatsiyu nastoyashchimi usloviyami.",
      },
      s2: {
        title: "2. Ob Acquafy",
      ...
      s3: {
        ...
        p1: "Vy mozhete ispolzovat nash sayt v zakonnykh tselyakh i v sootvetstvii s nastoyashchimi Usloviyami. Sleduyushchee yavlyaetsya pryamo zapreshchyonnym:",
        items: [
          "Ispolzovanie sayta sposobom, narushaushchim primenimye zakony ili normativy",
          "Peredacha lyubykh nezaproshennykh reklamno-marketingovykh materialov",
          "Popytki poluchit nesanktsionirovannyy dostup k lyuboy chasti sayta ili sistemy",
          "Vmeshatelstvo ili narushenie tselostnosti ili proizvoditelnosti sayta",
          "Sbor ili obrabotka dannykh drugikh polzovateley bez ikh soglasiya",
          "Ispolzovanie robotov, scrapperov ili inykh avtomatizirovannykh sredstv dlya dostupa k saytu",
          "Obratnaya razrabotka, dekompilatsiya ili razborka lyubogo programmnogo obespecheniya na sayte",
        ],
      },
      s4: {
        title: "4. Registratsiya i uchyotnye zapisi polzovateley",
        sub1t: "4.1 Sozdanie uchyotnoy zapisi",
        sub1p: "Nekotorye funktsii i uslugi Acquafy mogut trebovat registratsii uchyotnoy zapisi. Sozdavaya uchyotnuyu zapis, vy obyazuetes predostavlyat pravdivuyu, tochnuyu i polnuyu informatsiyu.",
        sub2t: "4.2 Otvetstvennost za uchyotnuyu zapis",
        sub2p: "Vy nesyote otvetstvennost za soglasheniye v tayne vashikh uchyotnykh dannykh dlya vkhoda v sistemu i za vse deystviya, vypolnyaemye s vashey uchyotnoy zapisyu. Nemedlenno uvedomite Acquafy o lyubom nesanktsionirovannom ispolzovanii.",
        sub3t: "4.3 Otmena",
        sub3p: "Acquafy ostavlyaet za soboy pravo otmenit ili priostanovit uchyotnye zapisi, narushaushchie nastoyashchie Usloviya, bez preduperezhdeniya.",
      },
      s5: {
        title: "5. Produkty i uslugi",
        sub1t: "5.1 Dostupnost",
        sub1p: "Acquafy stremitsya obespechit dostupnost svoikh produktov i uslug, no ne garantiruet nepreryvnoy dostupnosti. Zaplanirovannoe tekhnicheskoe obsluzhivanie ili tekhnicheskiye problemy mogut priveeti k vremennoy nedostupnosti.",
        sub2t: "5.2 Opisanie produktov",
        sub2p: "My delaem vsyo vozmozhnoye dlya tochnogo opisaniya nashikh produktov. Tem ne meneye, my ne garantiruyem, chto opisaniya, izobrazheniya ili inoy kontent na sayte yavlyayutsya polnymi, nadyozhnymi, aktualnymi ili svobodnymi ot oshibok.",
        sub3t: "5.3 Tseny i platezhi",
        sub3p: "Tseny, otobrazhaemye na sayte, mogut byt izmeneny bez preduperezhdeniya. V sluchaye oshibki v tsene Acquafy ostavlyaet za soboy pravo otmenit zatronutye zakazy, uvedomiv ob etom klienta zaranee.",
        sub4t: "5.4 Prilozhenie i tsifrovaya platforma",
        sub4p: "Ispolzovanie prilozheniya Acquafy i Global Smart Water Platform podchinyaetsya spetsificheskim usloviyam, predstavlennym na etape registratsii. Eti usloviya dopolnyayut nastoyashchie obshchie Usloviya ispolzovaniya.",
      },
      s6: {
        title: "6. Intellektualnaya sobstvennost",
        p1: "Ves kontent na sayte Acquafy - vklyuchaya teksty, izobrazheniya, logotipy, ikonki, video, programmnoe obespechenie i dizayn - yavlyaetsya isklyuchitelnoy sobstvennostyu Acquafy Corporation ili eyo litsenziarov i zashchishchyon zakonami ob avtorskikh pravakh, tovarnymi znakomi i drugimi primenimymi zakonami ob intellektualnoy sobstvennosti.",
        p2: "Vosproizvedenie, raspredelenie, modifikatsiya, publichnoe otobrazheniye ili sozdanie proizvodnykh rabot iz lyubogo kontenta sayta bez predvaritelnogo pismennogo razresheniya Acquafy zapreshcheno.",
        p3: "Nazvanie Acquafy, logotip i drugie tovarnye znaki Acquafy Corporation yavlyayutsya zaregistrirovannymi ili ozhidayushchimi registratsii tovarnymi znakami. Ikh nesanktsionirovannoye ispolzovanie zapreshcheno.",
      },
      s7: {
        title: "7. Ogranichenie otvetstvennosti",
        p1: "V maksimalnoy stepeni, dopuskaemoy primenimym zakonodatelstvom, Acquafy ne nesyot otvetstvennosti za kosvennye, sluchainye, spetsialnye, posledstvennye ili shtrafonye ubytki, voznikshiye v rezultate ispolzovaniya ili nevozmozhnosti ispolzovaniya sayta, produktov ili uslug.",
        p2: "Acquafy ne nesyot otvetstvennosti za pereboi, vyzvanye faktorami vne eyo kontrolya, vklyuchaya otkazы infrastruktury tretikh storon, stikhinye bedstviya ili kiberataki.",
        p3: "Polzovatel priznayet, chto ispolzovanie sayta i uslug osushchestvlyaetsya na ego sobstvennyy risk, v predelakh, ustanovlennykh zakonom.",
      },
      s8: {
        title: "8. Ssylki na sayty tretikh storon",
        p1: "Nash sayt mozhet soderzhat ssylki na veb-sayty tretikh storon. Eti ssylki predostavlyayutsya isklyuchitelno dlya udobstva i informirovaniya. Acquafy ne kontroliruet kontent etikh saytov i ne nesyot otvetstvennosti za ikh kontent, praktiku konfidentsialnosti ili dostupnost.",
        p2: "Dostup k saytam tretikh storon - polnostyu otvetstvennost polzovatelya, kotoryy dolzhen oznakomitsya s usloviyami i politikami etikh saytov pered ikh ispolzovaniem.",
      },
      s9: {
        title: "9. Konfidentsialnost i zashchita dannykh",
        p1pre: "Obrabotka personalnykh dannykh, sobiraemykh Acquafy, reguliruetsya nashey",
        p1post: ", kotoraya vklyuchena v nastoyashchie Usloviya ispolzovaniya. Ispolzuya nashi uslugi, vy soglashaetes s praktikami sbora i ispolzovaniya dannykh, opisannymi v etoy politike.",
        p2: "Acquafy priverzhen soblyudeniyu primenimykh zakonov o zashchite dannykh, vklyuchaya Obshchiy reglament zashchity dannykh (GDPR) Evropeyskogo soyuza, gde primeniemo.",
      },
      s10: {
        title: "10. Vozmeshchenie ushcherba",
        p1: "Vy soglashaetes zashchishchat, vozmeshchat ushcherb i uderzhat v bezopasnosti Acquafy Corporation, eyo direktorov, sotrudnikov, partnyorov i agentov ot lyubykh trebovaniy, otvetstvennosti, ubytkov, poter i raskhodov (vklyuchaya razumnye raschody na yuridicheskuyu pomoshch), voznikayushchikh v rezultate vashego ispolzovaniya sayta ili narusheniya nastoyashchikh Usloviy.",
      },
      s11: {
        title: "11. Izmeneniya usloviy",
        p1: "Acquafy ostavlyaet za soboy pravo v lyuboye vremya izmenyat nastoyashchie Usloviya ispolzovaniya. Izmeneniya vstupayut v silu nemedlenno posle publikatsii na sayte, pri etom data v verkhney chasti dannoy stranitsy obnovlyaetsya.",
        p2: "Prodolzheniye ispolzovaniya sayta posle publikatsii izmeneniy oznachaet prinyatiye novykh Usloviy. Rekomenduyem regulyarno prosmatrivat etu stranitsu.",
      },
      s12: {
        title: "12. Rastorzhenie",
        p1: "Acquafy mozhet v lyuboye vremya, s preduprezhdeniemi ili bez, po lyuboy prichine, vklyuchaya narushenie nastoyashchikh Usloviy, prekratit ili priostanovit vash dostup k saytu i uslugam.",
        p2: "Posle rastorzheniya polozheniya nastoyashchikh Usloviy, kotorye po svoey prirode dolzhny ostavatsya v sile, prodolzhayut deystvovat, vklyuchaya razdely ob intellektualnoy sobstvennosti, otkazye ot garantiy, ogranichenii otvetstvennosti i vozmeshchenii ushcherba.",
      },
      s13: {
        title: "13. Primenimoe pravo i yurisdiksiya",
        p1: "Nastoyashchie Usloviya ispolzovaniya reguliruyutsya zakonami shtata Florida, SShA, bez ushcherba dlya zakonov o zashchite prav potrebiteley, deystvuyushchikh v strane prozhivaniya polzovatelya.",
        p2: "V Brazilii potrebitelskiye otnosheniya s brazilskimi polzovatelyami takzhe podchinyayutsya Zakonu o zashchite prav potrebiteley (Zakon N 8 078/1990) i primenimому brazilskomu zakonodatelstvu.",
        p3: "Lyubыe spory, voznikayushchie iz nastoyashchikh Usloviy, budut predpochtitelno razreshatsya putyom mediatsii. Esli eto nevozmozhno, dlya brazilskikh polzovateley izbirayutsya sudy Sao Paulo/SP, Braziliya, s otkazom ot lyubogo drugogo suda, naskol ko privilegirovannym on ni byl by.",
      },
      s14: {
        title: "14. Kontakt",
        p1: "Esli u vas est voprosy, predlozheniya ili zhaloby, svyazannye s nastoyashchimi Usloviyami ispolzovaniya, svyazhites s Acquafy:",
      },
    },
  },
  ro: {
    sidebarLabel: "Pe aceasta pagina",
    navItems: [
      { id: "aceitacao",        label: "1. Acceptarea Termenilor" },
      { id: "sobre",            label: "2. Despre Acquafy" },
      { id: "uso-permitido",    label: "3. Utilizare Permisa" },
      { id: "contas",           label: "4. Conturi de Utilizator" },
      { id: "produtos",         label: "5. Produse si Servicii" },
      { id: "propriedade",      label: "6. Proprietate Intelectuala" },
      { id: "responsabilidade", label: "7. Limitarea Raspunderii" },
      { id: "links",            label: "8. Linkuri Terte" },
      { id: "privacidade",      label: "9. Confidentialitate" },
      { id: "indenizacao",      label: "10. Despagubire" },
      { id: "modificacoes",     label: "11. Modificari" },
      { id: "rescisao",         label: "12. Reziliere" },
      { id: "legislacao",       label: "13. Legislatie Aplicabila" },
      { id: "contato",          label: "14. Contact" },
    ],
    ...
    sections: {
      s1: {
        ...
        p1: "Prin accesarea si utilizarea site-ului acquafy.com (si subdomeniile sale) sau a oricarui produs, aplicatie sau serviciu oferit de Acquafy, declarati ca ati citit, inteles si acceptat acesti Termeni de Utilizare, precum si Politica noastra de Confidentialitate.",
        p2: "Daca accesati serviciile in numele unei companii sau organizatii, declarati ca aveti autoritatea de a lega acea entitate de acesti termeni.",
      },
      s2: {
      ...
      s3: {
        ...
        p1: "Puteti utiliza site-ul nostru in scopuri legale si in conformitate cu acesti Termeni. Urmatoarele sunt expres interzise:",
        items: [
          "Utilizarea site-ului intr-un mod care incalca legile sau reglementarile aplicabile",
          "Transmiterea oricarui material publicitar sau promotional nesolicitat",
          "Incercarea de a obtine acces neautorizat la orice parte a site-ului sau sistemului",
          "Interferarea cu sau intreruperea integritatii sau performantei site-ului",
          "Colectarea sau culegerea datelor altor utilizatori fara consimtamant",
          "Utilizarea robotilor, scraperelor sau altor mijloace automatizate pentru a accesa site-ul",
          "Inginerie inversa, decompilare sau dezasamblare a oricarui software de pe site",
        ],
      },
      s4: {
        title: "4. Inregistrare si Conturi de Utilizator",
        sub1t: "4.1 Creare cont",
        sub1p: "Unele functii si servicii Acquafy pot necesita inregistrarea unui cont. La crearea unui cont, va angajati sa furnizati informatii adevarate, exacte si complete.",
        sub2t: "4.2 Responsabilitate cont",
        sub2p: "Sunteti responsabil pentru mentinerea confidentialitatii acreditarilor de autentificare si pentru toate activitatile efectuate cu contul dumneavoastra. Notificati imediat Acquafy cu privire la orice utilizare neautorizata.",
        sub3t: "4.3 Anulare",
        sub3p: "Acquafy isi rezerva dreptul de a anula sau suspenda conturile care incalca acesti Termeni, fara notificare prealabila.",
      },
      s5: {
        title: "5. Produse si Servicii",
        sub1t: "5.1 Disponibilitate",
        sub1p: "Acquafy se straduieste sa mentina produsele si serviciile sale disponibile, dar nu garanteaza disponibilitatea neintrerupta. Intretinerea planificata sau problemele tehnice pot cauza indisponibilitate temporara.",
        sub2t: "5.2 Descrierea produselor",
        sub2p: "Facem tot posibilul pentru a descrie produsele noastre cu exactitate. Cu toate acestea, nu garantam ca descrierile, imaginile sau alt continut de pe site sunt complete, fiabile, actuale sau lipsite de erori.",
        sub3t: "5.3 Preturi si plati",
        sub3p: "Preturile afisate pe site pot fi modificate fara notificare prealabila. In cazul unei erori de pret, Acquafy isi rezerva dreptul de a anula comenzile afectate, notificand clientul in prealabil.",
        sub4t: "5.4 Aplicatie si platforma digitala",
        sub4p: "Utilizarea aplicatiei Acquafy si a platformei Global Smart Water Platform este supusa unor termeni specifici prezentati la momentul inregistrarii. Acesti termeni completeaza prezentii Termeni generali de Utilizare.",
      },
      s6: {
        title: "6. Proprietate Intelectuala",
        p1: "Tot continutul de pe site-ul Acquafy - inclusiv texte, imagini, logo-uri, pictograme, videoclipuri, software si design - este proprietatea exclusiva a Acquafy Corporation sau a licentiatilor sai si este protejat de legile drepturilor de autor, marcilor comerciale si alte legi aplicabile privind proprietatea intelectuala.",
        p2: "Reproducerea, distribuirea, modificarea, afisarea publica sau crearea de lucrari derivate din orice continut al site-ului fara autorizatia prealabila scrisa a Acquafy este interzisa.",
        p3: "Numele Acquafy, logo-ul si alte marci comerciale ale Acquafy Corporation sunt marci inregistrate sau in curs de inregistrare. Utilizarea lor neautorizata este interzisa.",
      },
      s7: {
        title: "7. Limitarea Raspunderii",
        p1: "In masura maxima permisa de legea aplicabila, Acquafy nu va fi raspunzatoare pentru daune indirecte, accidentale, speciale, consecutive sau punitive rezultate din utilizarea sau incapacitatea de a utiliza site-ul, produsele sau serviciile.",
        p2: "Acquafy nu este responsabila pentru intreruperi cauzate de factori in afara controlului sau, inclusiv defectiunile infrastructurii tertilor, dezastrele naturale sau atacurile cibernetice.",
        p3: "Utilizatorul recunoaste ca utilizarea site-ului si a serviciilor se face pe propria raspundere, in limitele prevazute de lege.",
      },
      s8: {
        title: "8. Linkuri catre Site-uri Terte",
        p1: "Site-ul nostru poate contine linkuri catre site-uri web terte. Aceste linkuri sunt furnizate doar pentru comoditate si informare. Acquafy nu are control asupra continutului acestor site-uri si nu este responsabila pentru continutul, practicile de confidentialitate sau disponibilitatea acestora.",
        p2: "Accesarea site-urilor terte este in intregime responsabilitatea utilizatorului, care ar trebui sa revizuiasca termenii si politicile acelor site-uri inainte de a le utiliza.",
      },
      s9: {
        title: "9. Confidentialitate si Protectia Datelor",
        p1pre: "Prelucrarea datelor personale colectate de Acquafy este reglementata de",
        p1post: ", care este incorporata in acesti Termeni de Utilizare. Utilizand serviciile noastre, consimtiti la practicile de colectare si utilizare a datelor descrise in acea politica.",
        p2: "Acquafy este angajata in respectarea legilor aplicabile privind protectia datelor, inclusiv Regulamentul General privind Protectia Datelor (GDPR) in Uniunea Europeana, unde este aplicabil.",
      },
      s10: {
        title: "10. Despagubire",
        p1: "Sunteti de acord sa aparati, sa despagubiti si sa tineti inofensive Acquafy Corporation, directorii, angajatii, partenerii si agentii sai de orice pretentii, raspunderi, daune, pierderi si cheltuieli (inclusiv onorariile rezonabile ale avocatilor) rezultate din utilizarea site-ului sau incalcarea acestor Termeni.",
      },
      s11: {
        title: "11. Modificarea Termenilor",
        p1: "Acquafy isi rezerva dreptul de a modifica acesti Termeni de Utilizare in orice moment. Modificarile vor intra in vigoare imediat dupa publicarea pe site, cu actualizarea datei din partea de sus a acestei pagini.",
        p2: "Utilizarea continua a site-ului dupa publicarea modificarilor constituie acceptarea noilor Termeni. Va recomandam sa revizuiti aceasta pagina periodic.",
      },
      s12: {
        title: "12. Reziliere",
        p1: "Acquafy poate rezilia sau suspenda accesul dumneavoastra la site si servicii in orice moment, cu sau fara notificare, din orice motiv, inclusiv incalcarea acestor Termeni.",
        p2: "Dupa reziliere, dispozitiile acestor Termeni care prin natura lor trebuie sa supravietuiasca vor ramane in vigoare, inclusiv sectiunile privind proprietatea intelectuala, excluderea garantiilor, limitarea raspunderii si despagubirea.",
      },
      s13: {
        title: "13. Legislatie Aplicabila si Jurisdictie",
        p1: "Acesti Termeni de Utilizare sunt reglementati de legile Statului Florida, Statele Unite, fara a aduce atingere legilor de protectie a consumatorilor aplicabile in tara de resedinta a utilizatorului.",
        p2: "In Brazilia, relatiile de consum cu utilizatorii brazilieni sunt, de asemenea, supuse Codului de Protectie a Consumatorului (Legea nr. 8.078/1990) si legislatiei braziliene aplicabile.",
        p3: "Orice litigiu rezultat din acesti Termeni va fi rezolvat preferential prin mediere. Daca nu este posibil, pentru utilizatorii brazilieni sunt alese instantele din Sao Paulo/SP, Brazilia, cu renuntarea la orice alt tribunal, indiferent cat de privilegiat ar fi.",
      },
      s14: {
        title: "14. Contact",
        p1: "Daca aveti intrebari, sugestii sau reclamatii legate de acesti Termeni de Utilizare, va rugam sa contactati Acquafy:",
      },
    },
  },
  he: {
    sidebarLabel: "Beamod zeh",
    navItems: [
      { id: "aceitacao",        label: "1. Kibul ha-tnaim" },
      { id: "sobre",            label: "2. Al Acquafy" },
      { id: "uso-permitido",    label: "3. Shimush mutar" },
      { id: "contas",           label: "4. Cheshbonot mishtatmashim" },
      { id: "produtos",         label: "5. Mutzarim ve-shrutim" },
      { id: "propriedade",      label: "6. Kinian ruchani" },
      { id: "responsabilidade", label: "7. Hagbalat achrayut" },
      { id: "links",            label: "8. Keshirim shel tzad shlishi" },
      { id: "privacidade",      label: "9. Pirtiyut" },
      { id: "indenizacao",      label: "10. Shiluy nezakim" },
      { id: "modificacoes",     label: "11. Shinuyim" },
      { id: "rescisao",         label: "12. Bitur" },
      { id: "legislacao",       label: "13. Din hachil" },
    ...
    sections: {
      s1: {
        title: "1. Kibul ha-tnaim",
        p1: "Al yedei gisha ve-shimush be-atar acquafy.com (ve-ttatei-ha-tivot shelo) o kol mutzar, yissum o sherut she-mutzaa al yedei Acquafy, atem matzharim she-kartem, hevntem ve-hesikmtem le-tnaim elu shel shimush, ve-khen le-mediniyut ha-pirtiyut shelanu.",
        p2: "Im atah nigas la-shrutim bishem chevra o irgun, atah matzhir she-yesh lecha samchut le-keshor et ha-guf ha-ze le-tnaim elu.",
      },
      s2: {
        title: "2. Al Acquafy",
      ...
      s3: {
        ...
        p1: "Atah yakhol lehishtamesh be-atar shelanu le-matarot chukkiyot u-ve-hitaem le-tnaim elu. Ha-devarim ha-baim asurim be-foresh:",
        items: [
          "Shimush ba-atar be-derech ha-meferet chukkim o takkanot hachilim",
          "Meshiluchat kol chomer pirsumit o shivuki she-lo nitbakashah",
          "Nisiyon lekabel gishah lo murshet le-kol chelek shel ha-atar o ha-machereket",
          "Hifsacut o likui shel shalemut o bitzuim shel ha-atar",
          "Likut o asifat netunim mi-mishtameshim acherim belo haskama",
          "Shimush be-botim, scrapperim o emtzaim automatiyim acherim lenishot la-atar",
          "Handassah hafucha, dipiqul o piquk shel kol tochna be-atar",
        ],
      },
      s4: {
        title: "4. Hisdarut ve-cheshbonot mishtatmashim",
        sub1t: "4.1 Yetziat cheshbon",
        sub1p: "Chalakim ve-shrutim mimeah shel Acquafy yekholim lidbor le-risher cheshbon. Be-yetzirat cheshbon, atah mitchayev laspek meida emet, meduyak ve-shalem.",
        sub2t: "4.2 Achrayut le-cheshbon",
        sub2p: "Atah achrayai le-shimur besod nituney ha-knisat la-machleket shekha u-le-chol ha-peulot she-butzeu im ha-cheshbon shelcha. Hoded le-Acquafy miyad al kol shimush lo masreach.",
        sub3t: "4.3 Bitur",
        sub3p: "Acquafy shomeret le-atzmah et ha-zchut levatel o le-hatlik cheshbonot ha-mefrim et ha-tnaim ha-elu, llelo hadaah mukdemet.",
      },
      s5: {
        title: "5. Mutzarim ve-shrutim",
        sub1t: "5.1 Zaminut",
        sub1p: "Acquafy shokefet lehachzir et ha-mutzarim ve-ha-shrutim shela zaminim, aval eina mevatachat zaminut blo hafsakot. Hatzenat tachzukim mתuknanot o beayot tekhniyot yekholot ligrom bilti-zaminut zamanit.",
        sub2t: "5.2 Teur mutzarim",
        sub2p: "Anachnu osim et ma she-nitkan letaar et ha-mutzarim shelanu be-diykun. Yachad im zot, einenu mevatchim she-ha-teurim, ha-timunim o chomer acher ba-atar hu shalem, amin, atdani o hofshi mi-shaot.",
        sub3t: "5.3 Mechir ve-tashlumim",
        sub3p: "Ha-mechirim ha-mutzagim ba-atar yekholim lehishtanot llelo hadaah mukdemet. Be-mekre taot mechir, Acquafy shomeret le-atzmah et ha-zchut levatel harashayot she-nifgeu, be-chazarat la-lachoch mukdemet.",
        sub4t: "5.4 Yissum ve-platforma digitalit",
        sub4p: "Shimush ba-yissum shel Acquafy u-ve-Global Smart Water Platform kfuf le-tnaim spetzifiyim she-mutzagim be-et ha-hisdarut. Tnaim elu mashlimim et ha-Tnaim ha-Klaliyim ha-elu shel Shimush.",
      },
      s6: {
        title: "6. Kinian ruchani",
        p1: "Kol ha-chomer ba-atar shel Acquafy - kolel tekstim, timunim, smalim, ikonim, videoim, tochna u-vi'kuach - hu rekush biledi shel Acquafy Corporation o shel narsheihem, ve-hu mugן al yedei chukei zchuyot yotzer, simanei mischar ve-chukei kinian ruchani achrim hachilim.",
        p2: "Shikhpul, hafatzah, shinui, tzigah tziburi o yetziat yetzir nifra mi-kol chomer ba-atar belo reshut bkhatav mukdemet mi-Acquafy asur.",
        p3: "Shem Acquafy, ha-smal ve-simanei ha-mischar ha-achrim shel Acquafy Corporation hem simanei mischar rashumim o be-thalich rishum. Shimush lo masreach bahem asur.",
      },
      s7: {
        title: "7. Hagbalat achrayut",
        p1: "Be-mishtar ha-gadol ha-muttar al yedei ha-din ha-chail, Acquafy lo tchaya achrait le-nezek akif, migri, meyuchad, ufiyot o onsheot ha-nobe mi-shimush o mi-bilti-yecholet shimush ba-atar, ba-mutzarim o ba-shrutim.",
        p2: "Acquafy eyna achrayat le-hafsakot ha-no'evet mi-gormim michutz le-shlitatah, kolel kishonot tshтit shel tzad shlishi, asonot teva o matzadey siber.",
        p3: "Ha-mishtatmash makim she-shimush ba-atar u-va-shrutim hu al acharayuto ha-ishit, bi-gvulot ha-mutzaim ba-chok.",
      },
      s8: {
        title: "8. Keshirim le-atarim shel tzad shlishi",
        p1: "Ha-atar shelanu yachol lehakil keshirim le-atarim shel tzad shlishi. Keshirim elu nitniyim rak le-nocheyut ve-le-meda. Le-Acquafy ein shlitah al ha-chomer shel ha-atarim ha-elu ve-hi eyna achrayat le-hatoram, le-nahag ha-pirtiyut o le-zaminutam.",
        p2: "Gishah le-atarim shel tzad shlishi hi ba-achrayut ha-mleah shel ha-mishtatmash, ve-ha-mishtatmash tzarich livdon et ha-tnaim ve-ha-mediniyot shel ha-atarim ha-elu lifney shimush bahem.",
      },
      s9: {
        title: "9. Pirtiyut ve-haganat netunim",
        p1pre: "Tipul be-netunim ishiyim she-Acquafy okevet menuhei al yedei",
        p1post: ", she-mushal le-Tnaim elu shel Shimush. Al yedei shimush ba-shrutim shelanu, atah maskeim le-nahagot asifat ha-netunim ve-shimush ba-hem ha-mtuarot ba-mediniyut ha-hi.",
        p2: "Acquafy mechuyevet le-hitkayem al chukei haganat ha-netunim ha-chailim, kolel ha-Takkanot ha-Klaliyot al Haganat Netunim (GDPR) ba-Ichud ha-Eropi, be-makom she-chail.",
      },
      s10: {
        title: "10. Shiluy nezakim",
        p1: "Atah maskeim lehagen, leshaleym ve-livli nezek et Acquafy Corporation, ha-menahalaיה, ha-ovdim, ha-shutafim ve-ha-sokhnim she-la mi-kol tviayot, achrayuyot, nezakim, avdanot ve-hotzaot (kolel schum orekhey din sevirutiyim) ha-novet mi-shimushcha ba-atar o mi-pfirtat ha-Tnaim ha-elu.",
      },
      s11: {
        title: "11. Shinui ha-tnaim",
        p1: "Acquafy shomeret le-atzmah et ha-zchut leshanot et ha-Tnaim elu shel Shimush be-kol zman she-hu. Shinuyim yichnasu le-tfayah miyad achar pirsunam ba-atar, im ikun ha-tarikh be-rashit ha-daf ha-ze.",
        p2: "Hemshech shimush ba-atar achar pirsum shinuyim mahaveh kibul shel ha-tnaim ha-chadashim. Anachnu memletzim shetivu'du et ha-daf ha-ze ve-derech klal.",
      },
      s12: {
        title: "12. Bitur",
        p1: "Acquafy yechola levatel o lehashlik et ha-gishah shelcha la-atar ve-la-shrutim be-kol zman she-hu, im o belo hadaah, mi-kol sibah she-hi, kolel pfirat ha-Tnaim ha-elu.",
        p2: "Achar ha-bitur, hukot Tnaim elu she-mi-tivam tzrichim lishot be-koach yishaeru be-tokef, kolel chalakim al kinian ruchani, shlilat achrayot, hagbalat achrayut ve-shiluy nezakim.",
      },
      s13: {
        title: "13. Din hachil ve-shmut mishpat",
        p1: "Tnaim elu shel Shimush menuhagim al yedei diney medinat Florida, Artzot ha-brit, llelo pgiya be-chukei haganat ha-zarakhanim ha-chailim ba-aretz ba-ah mishtatmash mתgוrar.",
        p2: "Be-Brazil, yachasei tzricha im mishtameshim braziliyim knuyim gam la-Chok le-Haganat ha-Zarakhan (Chok mispar 8.078/1990) u-le-chikaot ha-Brazil ha-chail.",
        p3: "Kol machloket ha-novaat mi-Tnaim elu tiyuptar be-edfanit be-derech gishur. Im lo nitkayem, yivachru batei ha-mishpat be-Sao Paulo/SP, Brazil, le-mishtameshim braziliyim, im vitur al kol beit mishpat acher, kolel ha-meouchanim yoter.",
      },
      s14: {
        title: "14. Yetzira kontakt",
        p1: "Im yesh lecha sheelot, hatzaot o tilunim ha-kashrurim le-Tnaim elu shel Shimush, tzor kesher im Acquafy:",
      },
    },
  },
};
