...
const T: Record<Lang, {
  ...
  "en-gb": {
    ...
    gold: {
      profile:      "Profile",       profileVal:      "Acquafy Media Operator",
      earn:         "Earnings",      earnVal:         "20% on Neo sales via QR Code / own link",
      extraIncome:  "Extra revenue", extraIncomeVal:  "Local media monetisation and hydration point operation",
      entry:        "Entry",         entryVal:        "Purchase of Acquafy Media for US$ 2,000",
      idealFor:     "Ideal for",     idealForVal:     "Entrepreneurs, media operators, and local businesses",
    },
    plat: {
  ...
  sv: {
    heading:   "Partner-",
    headingHL: "modeller",
    silverFooter: "Hänvisar kunder och tjänar provision på försäljning.",
    goldFooter:   "Driver Acquafy Media och säljer Neo",
    platFooter:   "Distribuerar Neo och expanderar regionalt",
    silver: {
      profile:    "Profil",        profileVal:    "Affiliate / Hänvisare",
      earn:       "Intäkter",      earnVal:       "20% på hänvisad försäljning via länk eller QR-kod",
      entry:      "Inträde",       entryVal:      "Enkel registrering och lätt drift",
      idealFor:   "Idealisk för",  idealForVal:   "Influencers, konsulter, säljare och lokala partners.",
    },
    gold: {
      profile:      "Profil",           profileVal:      "Acquafy Media-operatör",
      earn:         "Intäkter",         earnVal:         "20% på Neo-försäljning via QR-kod / egen länk",
      extraIncome:  "Extra intäkt",     extraIncomeVal:  "Monetisering av lokal media och drift av hydreringspunkt",
      entry:        "Inträde",          entryVal:        "Köp av Acquafy Media för US$ 2 000",
      idealFor:     "Idealisk för",     idealForVal:     "Entreprenörer, mediaoperatörer och lokala företag",
    },
    plat: {
      profile:    "Profil",              profileVal:    "Regional distributör / Masterpartner",
      howOp:      "Hur det fungerar",    howOpVal:      "Köp med 70% rabatt på det amerikanska priset",
      rule:       "Handelsregel",        ruleVal:       "FOB-villkor. Fri återförsäljning i din region.",
      obs:        "Notering",            obsVal:        "Ingen provision från Acquafy. Du täcker frakt, skatter och avgifter.",
      silverNet:  "Silver-nätverk",      silverNetVal:  "Kan driva ett eget Silver-partnernätverk och betala 20% till det nätverket",
      entry:      "Inträde",             entryVal:      "Regional distributionsstruktur.",
    },
  },
  fi: {
    heading:   "Kump-",
    headingHL: "panuusmallit",
    silverFooter: "Suosittelee asiakkaita ja ansaitsee provision myynnistä.",
    goldFooter:   "Operoi Acquafy Mediaa ja myy Neoa",
    platFooter:   "Jakaa Neoa ja laajentuu alueellisesti",
    silver: {
      profile:    "Profiili",      profileVal:    "Kumppani / Suosittelija",
      earn:       "Ansiot",        earnVal:       "20% suositelluista myynneistä linkin tai QR-koodin kautta",
      entry:      "Liittyminen",   entryVal:      "Yksinkertainen rekisteröinti ja kevyt toiminta",
      idealFor:   "Ihanteellinen", idealForVal:   "Vaikuttajat, konsultit, myyjät ja paikalliset kumppanit.",
    },
    gold: {
      profile:      "Profiili",        profileVal:      "Acquafy Media -operaattori",
      earn:         "Ansiot",          earnVal:         "20% Neo-myynnistä QR-koodin / oman linkin kautta",
      extraIncome:  "Lisätulo",        extraIncomeVal:  "Paikallisen median monetisointi ja hydraatiopisteen operointi",
      entry:        "Liittyminen",     entryVal:        "Acquafy Median osto hintaan US$ 2 000",
      idealFor:     "Ihanteellinen",   idealForVal:     "Yrittäjät, mediaoperaattorit ja paikalliset yritykset",
    },
    plat: {
      profile:    "Profiili",          profileVal:    "Alueellinen jakelija / pääkumppani",
      howOp:      "Toimintatapa",      howOpVal:      "Osto 70% alennuksella Yhdysvaltain hinnasta",
      rule:       "Kaupallinen sääntö", ruleVal:      "FOB-ehdot. Vapaa jälleenmyynti alueellasi.",
      obs:        "Huomio",            obsVal:        "Ei provisiota Acquafylta. Vastaat rahdista, veroista ja maksuista.",
      silverNet:  "Silver-verkosto",   silverNetVal:  "Voi operoida omaa Silver-kumppanikumppaniverkostoa maksamalla 20% kyseiselle verkostolle",
      entry:      "Liittyminen",       entryVal:      "Alueellinen jakelurakenne.",
    },
  },
  ru: {
    heading:   "Модели ",
    headingHL: "партнерства",
    silverFooter: "Рекомендует клиентов и получает комиссию с продаж.",
    goldFooter:   "Управляет Acquafy Media и продает Neo",
    platFooter:   "Распространяет Neo и расширяется регионально",
    silver: {
      profile:    "Профиль",       profileVal:    "Аффилиат / Реферал",
      earn:       "Доход",         earnVal:       "20% от рекомендованных продаж через ссылку или QR-код",
      entry:      "Вступление",    entryVal:      "Простая регистрация и лёгкая работа",
      idealFor:   "Идеально для",  idealForVal:   "Инфлюенсеры, консультанты, продавцы и местные партнёры.",
    },
    gold: {
      profile:      "Профиль",         profileVal:      "Оператор Acquafy Media",
      earn:         "Доход",           earnVal:         "20% от продаж Neo через QR-код / собственную ссылку",
      extraIncome:  "Дополнительный доход", extraIncomeVal: "Монетизация локальных СМИ и работа точки гидратации",
      entry:        "Вступление",      entryVal:        "Покупка Acquafy Media за US$ 2 000",
      idealFor:     "Идеально для",    idealForVal:     "Предприниматели, операторы СМИ и местный бизнес",
    },
    plat: {
      profile:    "Профиль",           profileVal:    "Региональный дистрибьютор / мастер-партнёр",
      howOp:      "Как работает",      howOpVal:      "Покупка со скидкой 70% от цены в США",
      rule:       "Коммерческое правило", ruleVal:    "Условия FOB. Свободная перепродажа в вашем регионе.",
      obs:        "Примечание",        obsVal:        "Без комиссии от Acquafy. Вы покрываете фрахт, налоги и сборы.",
      silverNet:  "Сеть Silver",       silverNetVal:  "Может управлять собственной сетью партнёров Silver, выплачивая 20% этой сети",
      entry:      "Вступление",        entryVal:      "Региональная дистрибьюторская структура.",
    },
  },
  ro: {
    heading:   "Modele de ",
    headingHL: "parteneriat",
    silverFooter: "Recomanda clienti si primeste comision din vanzari.",
    goldFooter:   "Opereaza Acquafy Media si vinde Neo",
    platFooter:   "Distribuie Neo si se extinde regional",
    silver: {
      profile:    "Profil",        profileVal:    "Afiliat / Referent",
      earn:       "Venituri",      earnVal:       "20% din vanzarile recomandate prin link sau cod QR",
      entry:      "Intrare",       entryVal:      "Inregistrare simpla si operatiune usoara",
      idealFor:   "Ideal pentru",  idealForVal:   "Influenceri, consultanti, agenti de vanzari si parteneri locali.",
    },
    gold: {
      profile:      "Profil",          profileVal:      "Operator Acquafy Media",
      earn:         "Venituri",        earnVal:         "20% din vanzarile Neo prin cod QR / link propriu",
      extraIncome:  "Venit suplimentar", extraIncomeVal: "Monetizarea media locale si operarea punctului de hidratare",
      entry:        "Intrare",         entryVal:        "Cumpararea Acquafy Media pentru US$ 2.000",
      idealFor:     "Ideal pentru",    idealForVal:     "Antreprenori, operatori media si afaceri locale",
    },
    plat: {
      profile:    "Profil",            profileVal:    "Distribuitor regional / partener master",
      howOp:      "Cum functioneaza",  howOpVal:      "Cumparare cu 70% reducere fata de pretul din SUA",
      rule:       "Regula comerciala", ruleVal:       "Conditii FOB. Revanzare libera in regiunea ta.",
      obs:        "Observatie",        obsVal:        "Fara comision de la Acquafy. Acoperi transportul, taxele si tarifele.",
      silverNet:  "Retea Silver",      silverNetVal:  "Poate opera propria retea de parteneri Silver, platind 20% acelei retele",
      entry:      "Intrare",           entryVal:      "Structura regionala de distributie.",
    },
  },
  he: {
    heading:   "מודלי ",
    headingHL: "שותפות",
    silverFooter: "ממליץ על לקוחות ומרוויח עמלה על מכירות.",
    goldFooter:   "מפעיל את Acquafy Media ומוכר Neo",
    platFooter:   "מפיץ Neo ומתרחב באופן אזורי",
    silver: {
      profile:    "פרופיל",       profileVal:    "שותף / ממליץ",
      earn:       "הכנסות",       earnVal:       "20% על מכירות שהומלצו דרך קישור או קוד QR",
      entry:      "הצטרפות",      entryVal:      "רישום פשוט ותפעול קל",
      idealFor:   "אידיאלי עבור", idealForVal:   "משפיענים, יועצים, נציגי מכירות ושותפים מקומיים.",
    },
    gold: {
      profile:      "פרופיל",       profileVal:      "מפעיל Acquafy Media",
      earn:         "הכנסות",       earnVal:         "20% על מכירות Neo דרך קוד QR / קישור אישי",
      extraIncome:  "הכנסה נוספת",  extraIncomeVal:  "מונטיזציה של מדיה מקומית ותפעול נקודת ההידרציה",
      entry:        "הצטרפות",      entryVal:        "רכישת Acquafy Media בUS$ 2,000",
      idealFor:     "אידיאלי עבור", idealForVal:     "יזמים, מפעילי מדיה ועסקים מקומיים",
    },
    plat: {
      profile:    "פרופיל",          profileVal:    "מפיץ אזורי / שותף ראשי",
      howOp:      "איך זה עובד",     howOpVal:      "רכישה בהנחה של 70% ממחיר ארה\"ב",
      rule:       "כלל מסחרי",       ruleVal:       "תנאי FOB. מכירה חוזרת חופשית באזורך.",
      obs:        "הערה",            obsVal:        "ללא עמלה מ-Acquafy. אתה מכסה משלוח, מסים ועמלות.",
      silverNet:  "רשת Silver",      silverNetVal:  "יכול להפעיל רשת שותפי Silver משלו ולשלם 20% לאותה רשת",
      entry:      "הצטרפות",         entryVal:      "מבנה הפצה אזורי.",
    },
  },
};
...
export const FORM_T: Record<Lang, FormLang> = {
  ...
  sv: {
    titleSilver: "Silver-partnerskap", titleGold: "Gold-partnerskap", titlePlatinum: "Platinum-partnerskap",
    labelNome: "Fullständigt namn", placeholderNome: "Ditt namn",
    labelEmail: "E-post", placeholderEmail: "din@email.com",
    labelEmpresa: "Företagsnamn", placeholderEmpresa: "Ditt företagsnamn",
    labelRegiao: "Land / Region", placeholderRegiao: "T.ex.: Sverige, Norge, Danmark…",
    labelMensagem: "Meddelande", placeholderMensagem: "Hur kan vi hjälpa dig?",
    submitBtn: "Skicka",
    btnSilver: "Bli Silver-partner", btnGold: "Bli Gold-partner", btnPlatinum: "Bli Platinum-partner",
    ...
    titleSilver: "Silver-kumppanuus", titleGold: "Gold-kumppanuus", titlePlatinum: "Platinum-kumppanuus",
    labelNome: "Koko nimi", placeholderNome: "Nimesi",
    labelEmail: "Sähköposti", placeholderEmail: "sinun@email.com",
    labelEmpresa: "Yrityksen nimi", placeholderEmpresa: "Yrityksesi nimi",
    labelRegiao: "Maa / Alue", placeholderRegiao: "Esim.: Suomi, Ruotsi, Norja…",
    labelMensagem: "Viesti", placeholderMensagem: "Kuinka voimme auttaa sinua?",
    submitBtn: "Lähetä",
    btnSilver: "Liity Silver-kumppaniksi", btnGold: "Liity Gold-kumppaniksi", btnPlatinum: "Liity Platinum-kumppaniksi",
    privacyPre: "Olen lukenut ja hyväksyn ", privacyTerms: "Käyttöehdot", privacyMid: " ja ", privacyPolicy: "Tietosuojakäytännön", privacyPost: " Acquafylta",
  },
  ru: {
    titleSilver: "Партнерство Silver", titleGold: "Партнерство Gold", titlePlatinum: "Партнерство Platinum",
    labelNome: "Полное имя", placeholderNome: "Ваше имя",
    labelEmail: "Эл. почта", placeholderEmail: "ваш@email.com",
    labelEmpresa: "Название компании", placeholderEmpresa: "Название вашей компании",
    labelRegiao: "Страна / Регион", placeholderRegiao: "Например: Россия, Казахстан, Германия…",
    labelMensagem: "Сообщение", placeholderMensagem: "Как мы можем вам помочь?",
    submitBtn: "Отправить",
    btnSilver: "Стать партнёром Silver", btnGold: "Стать партнёром Gold", btnPlatinum: "Стать партнёром Platinum",
    privacyPre: "Я прочитал и согласен с ", privacyTerms: "Условиями использования", privacyMid: " и ", privacyPolicy: "Политикой конфиденциальности", privacyPost: " Acquafy",
  },
  ro: {
    titleSilver: "Parteneriat Silver", titleGold: "Parteneriat Gold", titlePlatinum: "Parteneriat Platinum",
    labelNome: "Nume complet", placeholderNome: "Numele tau",
    labelEmail: "E-mail", placeholderEmail: "al.tau@email.com",
    labelEmpresa: "Numele companiei", placeholderEmpresa: "Numele companiei tale",
    labelRegiao: "Tara / Regiune", placeholderRegiao: "Ex.: Romania, Moldova, Franta…",
    labelMensagem: "Mesaj", placeholderMensagem: "Cum te putem ajuta?",
    submitBtn: "Trimite",
    btnSilver: "Devino partener Silver", btnGold: "Devino partener Gold", btnPlatinum: "Devino partener Platinum",
    privacyPre: "Am citit si sunt de acord cu ", privacyTerms: "Termenii de Utilizare", privacyMid: " si ", privacyPolicy: "Politica de Confidentialitate", privacyPost: " Acquafy",
  },
  he: {
    titleSilver: "שותפות Silver", titleGold: "שותפות Gold", titlePlatinum: "שותפות Platinum",
    labelNome: "שם מלא", placeholderNome: "שמך",
    labelEmail: "דוא\"ל", placeholderEmail: "your@email.com",
    labelEmpresa: "שם החברה", placeholderEmpresa: "שם החברה שלך",
    labelRegiao: "מדינה / אזור", placeholderRegiao: "לדוגמה: ישראל, ארה\"ב, גרמניה…",
    labelMensagem: "הודעה", placeholderMensagem: "כיצד נוכל לעזור לך?",
    submitBtn: "שלח",
    btnSilver: "הפוך לשותף Silver", btnGold: "הפוך לשותף Gold", btnPlatinum: "הפוך לשותף Platinum",
    privacyPre: "קראתי ואני מסכים ל", privacyTerms: "תנאי השימוש", privacyMid: " ול", privacyPolicy: "מדיניות הפרטיות", privacyPost: " של Acquafy",
  },
};
