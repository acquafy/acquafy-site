...
const T: Record<Lang, {
  ...
  sv: {
    ...
    heading2: " funktioner",
    items: [
      { title: "Global övervakning",                 desc: "Fullständig överblick över drift och enheter var som helst." },
      { title: "Förebyggande underhåll",             desc: "Planera byten i förväg och undvik oväntade driftstopp." },
      { title: "365-dagars filter-nedräkning",       desc: "Exakt kontroll över filtrets livslängd och prestanda." },
      { title: "App-styrning",                       desc: "Funktioner och justeringar direkt från din smartphone." },
      { title: "AI-insikter",                        desc: "Snabbare beslut med data och intelligenta förslag." },
      { title: "Drift på 16 språk",                  desc: "Historik och spårning" },
    ],
  },
  fi: {
    heading1: "Valitut",
    heading2: " ominaisuudet",
    items: [
      { title: "Globaali seuranta",                  desc: "Kattava näkymä toimintoihin ja laitteisiin kaikkialla." },
      { title: "Ennaltaehkäisevä huolto",            desc: "Ennakoi vaihdot ja vältä odottamattomat seisokit." },
      { title: "Suodattimen 365 päivän lähtölaskenta", desc: "Tarkka suodattimen käyttöiän ja suorituskyvyn hallinta." },
      { title: "Sovellusohjaus",                     desc: "Toiminnot ja säädöt suoraan älypuhelimestasi." },
      { title: "Tekoälyoivallukset",                 desc: "Nopeammat päätökset datan ja älykkäiden ehdotusten avulla." },
      { title: "Toiminta 16 kielellä",               desc: "Historia ja seuranta" },
    ],
  },
  ru: {
    heading1: "Ключевые",
    ...
    items: [
      { title: "Глобальный мониторинг",              desc: "Полный обзор операций и устройств в любом месте." },
      { title: "Профилактическое обслуживание",      desc: "Планируйте замены заранее и избегайте неожиданных простоев." },
      { title: "365-дневный обратный отсчёт фильтров", desc: "Точный контроль срока службы и производительности фильтров." },
      { title: "Управление через приложение",        desc: "Функции и настройки прямо со смартфона." },
      { title: "Аналитика ИИ",                       desc: "Более быстрые решения благодаря данным и умным подсказкам." },
      { title: "Работа на 16 языках",                desc: "История и отслеживание" },
    ],
  },
  ro: {
    heading1: "Functii",
    heading2: " principale",
    items: [
      { title: "Monitorizare globala",               desc: "Vedere completa a operatiunilor si dispozitivelor oriunde." },
      { title: "Intretinere preventiva",             desc: "Anticipeaza inlocuirile si evita opririle neasteptate." },
      { title: "Numaratoare inversa 365 zile filtre", desc: "Control precis al duratei de viata si performantei filtrelor." },
      { title: "Control prin App",                   desc: "Functii si ajustari direct de pe smartphone." },
      { title: "Informatii AI",                      desc: "Decizii mai rapide cu date si sugestii inteligente." },
      { title: "Operare in 16 limbi",                desc: "Istoric si urmarire" },
    ],
  },
  he: {
    heading1: "תכונות",
    heading2: " מובחרות",
    items: [
      { title: "ניטור גלובלי",                      desc: "תצוגה מלאה של פעולות ומכשירים בכל מקום." },
      { title: "תחזוקה מונעת",                      desc: "תכנן החלפות מראש והימנע מהשבתות בלתי צפויות." },
      { title: "ספירה לאחור של 365 ימים לפילטרים", desc: "שליטה מדויקת על אורך חיי הפילטר וביצועיו." },
      { title: "שליטה דרך האפליקציה",               desc: "פונקציות והתאמות ישירות מהסמארטפון שלך." },
      { title: "תובנות AI",                          desc: "החלטות מהירות יותר עם נתונים והצעות חכמות." },
      { title: "פעולה ב-16 שפות",                   desc: "היסטוריה ומעקב" },
    ],
  },
  "pt-pt": {
    heading1: "Recursos",
