...
const T: Record<Lang, {
  ...
  sv: {
    ...
    downloads_subtitulo: "Manualer, guider, programvara och dokument tillgängliga för nedladdning.",
    videos_titulo: "Handledningar och videor",
    videos_subtitulo: "Lär dig steg för steg med våra videohandledningar.",
    faq_titulo: "Vanliga frågor",
    faq_subtitulo: "Snabba svar på de vanligaste frågorna om Acquafys produkter och tjänster.",
    politicas_titulo: "Policyer och garantier",
    politicas_subtitulo: "Transparens och tydlighet om dina rättigheter och Acquafys villkor.",

    // Downloads categories
    cat_manuais: "Användarhandböcker",
    ...
    guia_manutencao: "Underhålls- och rengöringsguide",
    primeiros_passos_app: "Kom igång -- Acquafy-appen",
    guia_parceiro: "Acquafy partnerguide",
    guia_troca_filtros: "Guide för filterbyte",
    ficha_tecnica: "Tekniskt datablad -- Neo-serien",
    certificado_conformidade: "Konformitetsintyg",
    contrato_parceria: "Partnerskapsavtalsmall",
    politica_garantia_dl: "Acquafy garantipolicy",
    declaracao_anatel: "ANATEL konformitetsförklaring",
    ...
    // Videos
    video1_titulo: "Hur man installerar Neo-renaren",
    video1_desc: "Komplett steg-för-steg installationsguide.",
    video1_cat: "Installation",
    video2_titulo: "Kom igång med Acquafy-appen",
    video2_desc: "Installera och anslut din enhet till appen.",
    video2_cat: "App",
    video3_titulo: "Hur man byter filter på Neo-renaren",
    video3_desc: "Enkelt och snabbt filterbyte.",
    video3_cat: "Underhåll",
    video4_titulo: "Acquafy Media: annonsera på skärmen",
    video4_desc: "Skapa kampanjer och monetisera din skärm.",
    video4_cat: "Media",
    video5_titulo: "Acquafy-partnerskap: från Silver till Platinum",
    video5_desc: "Hur man växer inom Acquafys partnernätverk.",
    video5_cat: "Partnerskap",
    video6_titulo: "Fullständig rundtur i appen och funktionerna",
    video6_desc: "Utforska alla resurser i ekosystemet.",
    video6_cat: "App",

    // FAQ
    faq1_pergunta: "Vad är skillnaden mellan modellerna Neo Essentials och Neo Premium?",
    faq1_resposta: "Neo Essentials-serien (Neo UP, FIT, SMART H2, TOUCH, PLUS, ULTRA, MAX och varianter) har en 10,1\" LED-panel och fokuserar på kostnadseffektivitet med UV LED + UF-teknik. Neo Premium-serien (INFINITY, PRESTIGE och PRIME) inkluderar en 15,6\" IPS-panel, omvänd osmosfiltrering (RO) och premiummaterial. Alla modeller har Wi-Fi 5 och Bluetooth 5.3.",
    faq2_pergunta: "Hur laddar jag ner och installerar Acquafy-appen?",
    faq2_resposta: "Acquafy-appen finns i App Store (iOS) och Google Play (Android). Efter installationen skapar du ditt konto, håller smarttelefonen nära renaren via Bluetooth 5.3 för parkoppling och följer Wi-Fi-installationsguiden. Processen tar mindre än 5 minuter.",
    faq3_pergunta: "Hur ofta ska jag byta filter på renaren?",
    faq3_resposta: "Neo-filter har en livslängd på 365 dagar eller enligt vattenförbrukning. Acquafy-appen övervakar filtercykeln i realtid och skickar aviseringar när byte närmar sig. Det smarta påfyllningssystemet kan lägga beställningen automatiskt via appen.",
    faq4_pergunta: "Hur blir jag Acquafy-partner?",
    faq4_resposta: "Det finns tre partnerskapsnivåer: Silver (affiliate/referral, 20% provision, ingen startinvestering), Gold (Acquafy Media-operatör, 20% provision på försäljning + annonsintäkter, från US$2 000) och Platinum (regional distributör, 70% rabatt på USA-priset, FOB-modell). Besök partnersidan på webbplatsen eller kontakta vårt team.",
    faq5_pergunta: "Vad är Acquafy Media och hur genererar det återkommande intäkter?",
    faq5_resposta: "Acquafy Media är ett mediesystem integrerat i touchscreen-panelen på Neo-renarna. Lokala företag kan annonsera på displayen och Gold-partners får månatliga intäkter för varje annons som visas. Användare interagerar också via QR-kod i kampanjer, vilket genererar engagemangsdata.",
    faq6_pergunta: "Fungerar Neo-renaren med brunnsvatten eller bara kranvatten?",
    faq6_resposta: "Modeller i Essentials-serien är avsedda för kranvatten (med tryck på 20 till 80 PSI). Premium-serien med RO-teknik (omvänd osmos) kan behandla vatten med större kvalitetsvariation. För specifika situationer som brunnsvatten rekommenderar vi att kontakta en teknisk specialist för bedömning.",
    faq7_pergunta: "Vad är garantitiden för Acquafys produkter?",
    faq7_resposta: "Neo-renarna levereras med 1 års garanti mot tillverkningsfel. Garantiregistrering måste göras via Acquafy-appen eller supportportalen. Fel orsakade av felaktig installation, felaktigt användande eller vanvårdat underhåll täcks inte av garantin.",
    faq8_pergunta: "I hur många länder verkar Acquafy?",
    faq8_resposta: "Acquafy finns i fler än 180 länder, med 100% global verksamhet och support tillgänglig på 16 språk. Affärsmodellen gör det möjligt för regionala distributörspartners att verka lokalt med stöd från den centrala plattformen.",

    // Policies
    pol1_titulo: "Garantipolicy",
    pol1_desc: "Dina Acquafy-produkter levereras med tillverkargaranti och fullständig täckning.",
    pol1_item1: "12 månaders tillverkargaranti",
    pol1_item2: "Täckning för tillverkningsfel",
    pol1_item3: "Specialiserad teknisk support",
    pol2_titulo: "Integritetspolicy",
    pol2_desc: "Läs om hur vi samlar in, använder och skyddar dina personuppgifter.",
    pol2_item1: "Insamlade uppgifter och ändamål",
    pol2_item2: "Delning och säkerhet",
    pol2_item3: "Dina rättigheter som registrerad",
    pol3_titulo: "Användningsvillkor",
    pol3_desc: "Regler och villkor för användning av Acquafys plattform och produkter.",
    pol3_item1: "Villkor för användning av plattformen",
    pol3_item2: "Användarens ansvar",
    pol3_item3: "Immateriella rättigheter",
    pol4_titulo: "Returpolicy",
    pol4_desc: "Hur man begär byte, retur eller återbetalning av produkter.",
    pol4_item1: "7 dagars returfönster",
    pol4_item2: "Villkor för full återbetalning",
    pol4_item3: "Hur man öppnar en returbegäran",
    pol5_titulo: "Certifieringar och standarder",
    pol5_desc: "Regulatorisk efterlevnad och tekniska certifieringar för produkterna.",
    ...
    downloads_subtitulo: "Käyttöoppaat, oppaat, ohjelmistot ja asiakirjat ladattavissa.",
    ...
    politicas_titulo: "Käytännöt ja takuut",
    politicas_subtitulo: "Avoimuutta ja selkeyttä oikeuksistasi ja Acquafyn ehdoista.",

    // Downloads categories
    cat_manuais: "Käyttöoppaat",
    ...
    politica_garantia_dl: "Acquafy-takuukäytäntö",
    declaracao_anatel: "ANATEL-vaatimustenmukaisuusseloste",
    ...
    // Videos
    video1_titulo: "Neo-vedenpuhdistimen asennus",
    video1_desc: "Täysipainoinen vaiheittainen asennusohje.",
    video1_cat: "Asennus",
    video2_titulo: "Acquafy-sovelluksen käyttöönotto",
    video2_desc: "Aseta ja yhdistä laitteesi sovellukseen.",
    video2_cat: "Sovellus",
    video3_titulo: "Neo-puhdistimen suodattimen vaihto",
    video3_desc: "Yksinkertainen ja nopea suodattimen vaihto.",
    video3_cat: "Huolto",
    video4_titulo: "Acquafy Media: mainosta näytöllä",
    video4_desc: "Luo kampanjoita ja tienaa näytölläsi.",
    video4_cat: "Media",
    video5_titulo: "Acquafy-kumppanuus: Silveristä Platinumiin",
    video5_desc: "Kuinka kasvaa Acquafyn kumppaniverkostossa.",
    video5_cat: "Kumppanuus",
    video6_titulo: "Täysi kierros sovelluksessa ja ominaisuuksissa",
    video6_desc: "Tutustu ekosysteemin kaikkiin resursseihin.",
    video6_cat: "Sovellus",

    // FAQ
    faq1_pergunta: "Mikä on ero Neo Essentials- ja Neo Premium -mallien välillä?",
    faq1_resposta: "Neo Essentials -sarja (Neo UP, FIT, SMART H2, TOUCH, PLUS, ULTRA, MAX ja variantit) sisältää 10,1\" LED-paneelin ja keskittyy kustannustehokkuuteen UV LED + UF -tekniikalla. Neo Premium -sarja (INFINITY, PRESTIGE ja PRIME) sisältää 15,6\" IPS-paneelin, käänteisosmoosipuhdistuksen (RO) ja premium-viimeistelyn. Kaikissa malleissa on Wi-Fi 5 ja Bluetooth 5.3.",
    faq2_pergunta: "Kuinka lataan ja asetan Acquafy-sovelluksen?",
    faq2_resposta: "Acquafy-sovellus on saatavilla App Storesta (iOS) ja Google Playsta (Android). Asennuksen jälkeen luo tilisi, tuo älypuhelimesi lähelle puhdistinta Bluetooth 5.3 -yhteyden kautta parittamista varten ja seuraa Wi-Fi-asennusoppaan ohjeita. Prosessi kestää alle 5 minuuttia.",
    faq3_pergunta: "Kuinka usein puhdistimen suodatin pitää vaihtaa?",
    faq3_resposta: "Neo-suodattimilla on 365 päivän käyttöikä tai vedenkulutuksen mukaan. Acquafy-sovellus seuraa suodatinkiertoa reaaliajassa ja lähettää ilmoituksia, kun vaihto lähestyy. Älykäs täydennysjärjestelmä voi tilata automaattisesti sovelluksen kautta.",
    faq4_pergunta: "Kuinka tulen Acquafy-kumppaniksi?",
    faq4_resposta: "Kumppanuustasoja on kolme: Silver (affiliate/suosittelu, 20% provisio, ei alkuinvestointia), Gold (Acquafy Media -operaattori, 20% provisio myynnistä + mainostulot, alkaen US$2 000) ja Platinum (alueellinen jakelija, 70% alennus USA:n hinnasta, FOB-malli). Vieraile kumppanisivulla verkkosivustolla tai ota yhteyttä tiimiimme.",
    faq5_pergunta: "Mikä on Acquafy Media ja miten se tuottaa jatkuvaa tuloa?",
    faq5_resposta: "Acquafy Media on Neo-puhdistimien kosketusnäyttöpaneeliin integroitu mediajärjestelmä. Paikalliset yritykset voivat mainostaa näytöllä ja Gold-kumppanit ansaitsevat kuukausittaisia tuloja jokaisesta näytetystä mainoksesta. Käyttäjät voivat myös olla vuorovaikutuksessa kampanjoiden QR-koodien kautta, mikä tuottaa sitoutumistietoja.",
    faq6_pergunta: "Toimiiko Neo-puhdistin kaivoveden kanssa vai vain vesijohtoveden kanssa?",
    faq6_resposta: "Essentials-sarjan mallit on suunniteltu vesijohtovedelle (paineella 20-80 PSI). RO-tekniikalla (käänteisosmoosi) varustettu Premium-sarja pystyy käsittelemään vettä, jonka laatu vaihtelee enemmän. Erityistilanteisiin, kuten kaivovesi, suosittelemme ottamaan yhteyttä tekniseen asiantuntijaan arviointia varten.",
    faq7_pergunta: "Mikä on Acquafy-tuotteiden takuuaika?",
    faq7_resposta: "Neo-puhdistimilla on 1 vuoden takuu valmistusvirheitä vastaan. Takuurekisteröinti on tehtävä Acquafy-sovelluksen tai tukiportaalin kautta. Virheellisen asennuksen, väärän käytön tai huolimattoman huollon aiheuttamia vikoja ei kata takuu.",
    faq8_pergunta: "Monessako maassa Acquafy toimii?",
    faq8_resposta: "Acquafy on läsnä yli 180 maassa, 100% globaalilla toiminnalla ja tuella 16 kielellä. Liiketoimintamalli mahdollistaa alueellisten jakelijakumppaneiden toimimisen paikallisesti keskusalustan tuella.",

    // Policies
    pol1_titulo: "Takuukäytäntö",
    pol1_desc: "Acquafy-tuotteissasi on valmistajatakuu ja täydellinen kattavuus.",
    pol1_item1: "12 kuukauden valmistajatakuu",
    pol1_item2: "Kattavuus valmistusvirheille",
    pol1_item3: "Erikoistunut tekninen tuki",
    pol2_titulo: "Tietosuojakäytäntö",
    pol2_desc: "Lue, miten keräämme, käytämme ja suojelemme henkilötietojasi.",
    pol2_item1: "Kerättävät tiedot ja tarkoitus",
    pol2_item2: "Jakaminen ja turvallisuus",
    pol2_item3: "Oikeutesi rekisteröityneenä",
    pol3_titulo: "Käyttöehdot",
    pol3_desc: "Säännöt ja ehdot Acquafyn alustan ja tuotteiden käyttämiselle.",
    pol3_item1: "Alustan käyttöehdot",
    pol3_item2: "Käyttäjän vastuut",
    pol3_item3: "Immateriaalioikeudet",
    pol4_titulo: "Palautuskäytäntö",
    pol4_desc: "Kuinka pyytää tuotteiden vaihtoa, palautusta tai hyvitystä.",
    pol4_item1: "7 päivän palautusikkuna",
    pol4_item2: "Täyden hyvityksen ehdot",
    pol4_item3: "Kuinka avata palautuspyyntö",
    pol5_titulo: "Sertifioinnit ja standardit",
    pol5_desc: "Tuotteiden sääntelynmukaisuus ja tekniset sertifioinnit.",
    pol5_item1: "ANATEL-sertifiointi",
    pol5_item2: "INMETRO ja Brasilian tekniset standardit",
    pol5_item3: "Kansainväliset laatustandardit",
    doc_em_elaboracao: "Asiakirja valmisteilla",

    // UI
    ver_base: "Näytä tietopohja",
    fechar: "Sulje",
  },
