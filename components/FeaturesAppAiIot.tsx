    ...
    cards: [
      {
        ...
        items: [
          ...
          "Kulutus- ja kayttohistoria",
          "Resurssit ja tekniset tiedot",
          "Tuki ja kayttooppaat",
          "Ilmoitukset ja havytykset",
      ...
      },
      {
        ...
        items: [
          ...
          "Alykäs toimintayhteenveto",
          "Tekoalypohjainen toiminta-assistentti",
        ],
        img: imgAiApp,
      },
      {
        ...
        items: [
          ...
          "Ennaltaehkaiseva huolto",
          "Kriittiset toimintahavytykset",
        ],
        img: imgIotApp,
      },
      {
