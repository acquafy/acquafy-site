...
const T: Record<Lang, {
  ...
  "en-gb": {
    ...
    products: [
      ...
      { title: "350ml Mug",             desc: "Premium ceramic with printed logo." },
      { title: "Premium Tote Bag",      desc: "Ideal for kits and promotional actions." },
      { title: "Lanyard / Badge",       desc: "Customised with the Acquafy identity." },
      { title: "Sticker / Ticket",      desc: "Perfect for cups, equipment and materials." },
      { title: "Button (Brooch)",       desc: "Ideal for team use and brand promotion." },
      { title: "Business Card",         desc: "For partners and advertisers." },
    ],
  ...
  fr: {
    ...
    categories: [
      ...
      { label: "Evenements & Promotion" },
    ],
    products: [
      { title: "T-Shirt",                    desc: "Tissu premium, confortable et resistant avec logo brode." },
      { title: "Polo",                        desc: "Design elegant et professionnel pour votre equipe et vos partenaires." },
      { title: "Casquette",                   desc: "Ajustement confortable et finition premium avec logo brode." },
      { title: "Gobelet en papier de 180ml",  desc: "Ideal pour les evenements et les actions promotionnelles." },
      { title: "Gourde de 750ml",             desc: "Bouteille reutilisable au design premium." },
      { title: "Verre en verre de 400ml",     desc: "Design sophistique et resistant." },
      { title: "Mug de 350ml",               desc: "Ceramique premium avec logo imprime." },
      { title: "Tote Bag Premium",            desc: "Ideal pour les kits et les actions promotionnelles." },
      { title: "Laniere / Badge",             desc: "Personnalise avec l'identite Acquafy." },
      { title: "Autocollant / Ticket",        desc: "Parfait pour les gobelets, equipements et materiaux." },
      { title: "Badge (Broche)",              desc: "Ideal pour l'equipe et la promotion de la marque." },
  ...
  sv: {
    heading1: "Kollektion av",
    heading2: "Acquafy Tillbehör",
    cta: "Kontakta oss och läs mer",
    categories: [
      { label: "Skjortor & Uniformer" },
      { label: "Muggar & Koppar" },
      { label: "Flaskor & Sportflaskor" },
      { label: "Kepsar & Reklamartiklar" },
      { label: "Evenemang & Kampanjer" },
    ],
    products: [
      { title: "T-Shirt",                desc: "Premiumtyg, bekvämt och hållbart med broderad logotyp." },
      { title: "Pikétröja",              desc: "Elegant och professionell design för ditt team och partners." },
      { title: "Keps",                   desc: "Bekväm passform och premiumfinish med broderad logotyp." },
      { title: "Pappersmugg 180ml",      desc: "Idealisk för evenemang och kampanjaktioner." },
      { title: "Sportflaska 750ml",      desc: "Återanvändbar flaska med premiumdesign." },
      { title: "Glasmugg 400ml",         desc: "Sofistikerad och hållbar design." },
      { title: "Mugg 350ml",             desc: "Premiumkeramik med tryckt logotyp." },
      { title: "Premium Tygkasse",       desc: "Idealisk för kit och kampanjaktioner." },
      { title: "Halsband / Bricka",      desc: "Anpassad med Acquafy-identiteten." },
      { title: "Klistermärke / Biljett", desc: "Perfekt för muggar, utrustning och material." },
      { title: "Knapp (Brosch)",         desc: "Idealisk för teamanvändning och varumärkeskampanjer." },
      { title: "Visitkort",              desc: "För partners och annonsörer." },
    ],
  },
  fi: {
    heading1: "Acquafy",
    heading2: "Tarvikevalikoima",
    cta: "Ota yhteyttä ja lue lisää",
    categories: [
      { label: "Paidat & Univormut" },
      { label: "Mukeja & Kuppeja" },
      { label: "Pullot & Juomapullot" },
      { label: "Lippikset & Mainostuotteet" },
      { label: "Tapahtumat & Kampanjat" },
    ],
    products: [
      { title: "T-paita",                desc: "Laadukas kangas, mukava ja kestävä kirjaillulla logolla." },
      { title: "Pikeepaita",             desc: "Tyylikäs ja ammattimainen muotoilu tiimillesi ja kumppaneille." },
      { title: "Lippis",                 desc: "Mukava istuvuus ja premium-viimeistely kirjaillulla logolla." },
      { title: "Pahvimuki 180ml",        desc: "Ihanteellinen tapahtumiin ja kampanjoihin." },
      { title: "Juomapullo 750ml",       desc: "Uudelleenkäytettävä pullo premium-muotoilulla." },
      { title: "Lasimuki 400ml",         desc: "Tyylikäs ja kestävä muotoilu." },
      { title: "Muki 350ml",             desc: "Premium-keramiikka painetulla logolla." },
      { title: "Premium-kangaskassi",    desc: "Ihanteellinen paketteihin ja kampanjoihin." },
      { title: "Hihna / Nimilappu",      desc: "Räätälöity Acquafy-identiteetillä." },
      { title: "Tarra / Lippu",          desc: "Täydellinen mukeille, laitteille ja materiaaleille." },
      { title: "Nappi (Rintaneula)",     desc: "Ihanteellinen tiimikäyttöön ja brändin edistämiseen." },
      { title: "Käyntikortti",           desc: "Kumppaneille ja mainostajille." },
    ],
  },
  ru: {
    heading1: "Коллекция",
    heading2: "Аксессуаров Acquafy",
    cta: "Свяжитесь с нами и узнайте больше",
    categories: [
      { label: "Рубашки и форма" },
      { label: "Стаканы и кружки" },
      { label: "Бутылки и спортивные фляги" },
      { label: "Кепки и рекламная продукция" },
      { label: "Мероприятия и акции" },
    ],
    products: [
      { title: "Футболка",               desc: "Премиальная ткань, удобная и прочная с вышитым логотипом." },
      { title: "Поло",                   desc: "Элегантный и профессиональный дизайн для вашей команды и партнеров." },
      { title: "Кепка",                  desc: "Удобная посадка и премиальная отделка с вышитым логотипом." },
      { title: "Бумажный стакан 180мл",  desc: "Идеально для мероприятий и рекламных акций." },
      { title: "Спортивная фляга 750мл", desc: "Многоразовая бутылка с премиальным дизайном." },
      { title: "Стеклянный стакан 400мл",desc: "Изысканный и прочный дизайн." },
      { title: "Кружка 350мл",           desc: "Премиальная керамика с напечатанным логотипом." },
      { title: "Премиальная сумка-тоут", desc: "Идеально для наборов и рекламных акций." },
      { title: "Шнурок / Бейдж",         desc: "Персонализировано в стиле Acquafy." },
      { title: "Наклейка / Билет",        desc: "Подходит для стаканов, оборудования и материалов." },
      { title: "Значок (Брошь)",          desc: "Идеально для команды и продвижения бренда." },
      { title: "Визитная карточка",       desc: "Для партнеров и рекламодателей." },
    ],
  },
  ro: {
    heading1: "Colectia de",
    heading2: "Accesorii Acquafy",
    cta: "Contactati-ne si aflati mai multe",
    categories: [
      { label: "Tricouri & Uniforme" },
      { label: "Pahare & Cani" },
      { label: "Sticle & Bidoane" },
      { label: "Sepci & Produse Promotionale" },
      { label: "Evenimente & Promotii" },
    ],
    products: [
      { title: "Tricou",                    desc: "Material premium, confortabil si rezistent cu logo brodat." },
      { title: "Tricou Polo",               desc: "Design elegant si profesional pentru echipa si parteneri." },
      { title: "Sapca",                     desc: "Potrivire confortabila si finisaj premium cu logo brodat." },
      { title: "Pahar de hartie 180ml",     desc: "Ideal pentru evenimente si actiuni promotionale." },
      { title: "Bidon de 750ml",            desc: "Sticla reutilizabila cu design premium." },
      { title: "Pahar de sticla 400ml",     desc: "Design sofisticat si rezistent." },
      { title: "Cana de 350ml",             desc: "Ceramica premium cu logo imprimat." },
      { title: "Sacosa Premium",            desc: "Ideal pentru kituri si actiuni promotionale." },
      { title: "Snur / Ecuson",             desc: "Personalizat cu identitatea Acquafy." },
      { title: "Autocolant / Bilet",        desc: "Perfect pentru pahare, echipamente si materiale." },
      { title: "Insigna (Brosa)",           desc: "Ideal pentru echipa si promovarea brandului." },
      { title: "Carte de Vizita",           desc: "Pentru parteneri si anuntatori." },
    ],
  },
  he: {
    heading1: "Acquafy",
    heading2: "קולקציית אביזרים",
    cta: "צרו קשר וגלו עוד",
    categories: [
      { label: "חולצות ומדים" },
      { label: "כוסות וספלים" },
      { label: "בקבוקים וקנטיינים" },
      { label: "כובעים ומוצרי פרסום" },
      { label: "אירועים ומבצעים" },
    ],
    products: [
      { title: "חולצת טי",              desc: "בד פרמיום, נוח ועמיד עם לוגו רקום." },
      { title: "חולצת פולו",            desc: "עיצוב אלגנטי ומקצועי לצוות ולשותפים." },
      { title: "כובע מצחייה",           desc: "התאמה נוחה וגימור פרמיום עם לוגו רקום." },
      { title: "כוס נייר 180 מ\"ל",     desc: "אידיאלי לאירועים ופעילויות קידום מכירות." },
      { title: "בקבוק ספורט 750 מ\"ל",  desc: "בקבוק רב-שימושי בעיצוב פרמיום." },
      { title: "כוס זכוכית 400 מ\"ל",   desc: "עיצוב מתוחכם ועמיד." },
      { title: "ספל 350 מ\"ל",          desc: "קרמיקה פרמיום עם לוגו מודפס." },
      { title: "תיק פרמיום",            desc: "אידיאלי לערכות ופעילויות קידום מכירות." },
      { title: "רצועה / תג",            desc: "מותאם אישית עם זהות Acquafy." },
      { title: "מדבקה / כרטיס",         desc: "מושלם לכוסות, ציוד וחומרים." },
      { title: "סיכה (ברוש)",           desc: "אידיאלי לשימוש הצוות וקידום המותג." },
      { title: "כרטיס ביקור",           desc: "לשותפים ולמפרסמים." },
    ],
  },
};
    ...
    <section className="bg-[#f6f9fe] flex flex-col items-center justify-center px-[20px] py-[40px] w-full">
      <div className="flex flex-col gap-[40px] items-center max-w-[1400px] w-full">
        ...
        <div className="flex justify-center w-full">
          <Link href="/contact?assunto=Acess%C3%B3rios%20Acquafy">
