...
const T: Record<Lang, {
  ...
  "en-gb": {
    ...
    stats: [
      ...
      { icon: imgPartner,   label: "Partner network",     count: "150+",    description: "distributors and integrated partners" },
      { icon: imgWater,     label: "People impacted",     count: "+50M",    description: "solutions that improve lives" },
      { icon: imgGloboSust, label: "Sustainability",      count: "Millions", description: "litres of water preserved" },
      { icon: imgChat,      label: "Smart media",         count: "+1Bi",    description: "media interactions generated" },
    ],
  },
  es: {
  ...
  sv: {
    tagline: "Vår påverkan",
    heading: "Vi omvandlar teknologi till",
    headingHighlight: "positiv påverkan",
    headingEnd: "för människor och planeten.",
    stats: [
      { icon: imgGlobe,     label: "Global närvaro",      count: "180+",    description: "länder med vision och expansion" },
      { icon: imgPartner,   label: "Partnernätverk",      count: "150+",    description: "distributörer och integrerade partners" },
      { icon: imgWater,     label: "Påverkade människor", count: "+50M",    description: "lösningar som förbättrar liv" },
      { icon: imgGloboSust, label: "Hållbarhet",          count: "Miljoner", description: "liter vatten bevarade" },
      { icon: imgChat,      label: "Smart media",         count: "+1Bi",    description: "genererade medieinteraktioner" },
    ],
  },
  fi: {
    tagline: "Vaikutuksemme",
    heading: "Muutamme teknologian",
    headingHighlight: "positiiviseksi vaikutukseksi",
    headingEnd: "ihmisille ja planeetalle.",
    stats: [
      { icon: imgGlobe,     label: "Globaali läsnäolo",   count: "180+",    description: "maata visiolla ja laajentumisella" },
      { icon: imgPartner,   label: "Kumppaniverkosto",    count: "150+",    description: "jakelijat ja integroidut kumppanit" },
      { icon: imgWater,     label: "Vaikutetut ihmiset",  count: "+50M",    description: "ratkaisuja, jotka parantavat elämiä" },
      { icon: imgGloboSust, label: "Kestävyys",           count: "Miljoonia", description: "litraa vettä säilytetty" },
      { icon: imgChat,      label: "Älykäs media",        count: "+1Bi",    description: "generoituja mediavuorovaikutuksia" },
    ],
  },
  ru: {
    tagline: "Наше влияние",
    heading: "Мы превращаем технологии в",
    headingHighlight: "позитивное влияние",
    headingEnd: "для людей и планеты.",
    stats: [
      { icon: imgGlobe,     label: "Глобальное присутствие", count: "180+",    description: "стран с видением и расширением" },
      { icon: imgPartner,   label: "Сеть партнёров",         count: "150+",    description: "дистрибьюторы и интегрированные партнёры" },
      { icon: imgWater,     label: "Охваченные люди",        count: "+50M",    description: "решения, улучшающие жизнь" },
      { icon: imgGloboSust, label: "Устойчивость",           count: "Миллионы", description: "литров воды сохранено" },
      { icon: imgChat,      label: "Умные медиа",            count: "+1Bi",    description: "сгенерированных медиавзаимодействий" },
    ],
  },
  ro: {
    tagline: "Impactul nostru",
    heading: "Transformam tehnologia in",
    headingHighlight: "impact pozitiv",
    headingEnd: "pentru oameni si planeta.",
    stats: [
      { icon: imgGlobe,     label: "Prezenta globala",    count: "180+",    description: "tari cu viziune si expansiune" },
      { icon: imgPartner,   label: "Retea de parteneri",  count: "150+",    description: "distribuitori si parteneri integrati" },
      { icon: imgWater,     label: "Oameni impactati",    count: "+50M",    description: "solutii care imbunatatesc vieti" },
      { icon: imgGloboSust, label: "Sustenabilitate",     count: "Milioane", description: "litri de apa preservati" },
      { icon: imgChat,      label: "Media inteligenta",   count: "+1Bi",    description: "interactiuni media generate" },
    ],
  },
  he: {
    tagline: "ההשפעה שלנו",
    heading: "אנו הופכים טכנולוגיה ל",
    headingHighlight: "השפעה חיובית",
    headingEnd: "למען האנשים והכוכב.",
    stats: [
      { icon: imgGlobe,     label: "נוכחות גלובלית",    count: "180+",    description: "מדינות עם חזון והתרחבות" },
      { icon: imgPartner,   label: "רשת שותפים",        count: "150+",    description: "מפיצים ושותפים משולבים" },
      { icon: imgWater,     label: "אנשים שהושפעו",     count: "+50M",    description: "פתרונות המשפרים חיים" },
      { icon: imgGloboSust, label: "קיימות",             count: "מיליונים", description: "ליטר מים שנשמרו" },
      { icon: imgChat,      label: "מדיה חכמה",         count: "+1Bi",    description: "אינטראקציות מדיה שנוצרו" },
    ],
  },
};
