...
const T: Record<Lang, {
  ...
  sv: {
    breadcrumbBase: "Kunskapsbas",
    breadcrumbArtigos: "Artiklar",
    h1pre: "Artiklar &", h1highlight: "Guider",
    subtitle: "Handledningar, guider och detaljerade svar organiserade efter ämne så att du hittar exakt vad du behöver.",
    searchPlaceholder: "Sök artiklar och guider…",
    clearSearch: "Rensa sökning",
    resultsFor: "resultat för", resultSg: "resultat", resultPl: "resultat", forWord: "för",
    noResultsTitle: "Inga artiklar hittades",
    noResultsSub: "Prova andra sökord eller utforska kategorierna nedan.",
    seeAll: "Se alla artiklar",
    readArticle: "Läs artikel", minRead: "min läsning",
    ...
    catTitles: {
      ...
      "media-network": "Media Network",
      "parceiros": "Partners",
      "faturamento": "Fakturering",
      "instalacao-e-manutencao": "Installation & Underhåll",
    },
    catDescs: {
      "produtos": "Specifikationer, köpguider och funktioner för Neo-reningsverk.",
      "app-ai-iot": "Inställning, användning och funktioner i Acquafy-appen med AI och IoT.",
      "media-network": "Hur du använder annonssystemet, QR-kod och återkommande intäkter.",
      "parceiros": "Guider för Acquafy Silver, Gold och Platinum-partners.",
      "faturamento": "Fakturor, provisioner, betalningar och skattedokumentation.",
      "instalacao-e-manutencao": "Installation, rengöring, filterbyte och förebyggande underhåll.",
    },
  },
  fi: {
    breadcrumbBase: "Tietopankki",
    breadcrumbArtigos: "Artikkelit",
    h1pre: "Artikkelit &", h1highlight: "Oppaat",
    subtitle: "Oppaat, ohjeet ja yksityiskohtaiset vastaukset aiheittain järjestettynä, jotta löydät juuri tarvitsemasi.",
    searchPlaceholder: "Hae artikkeleita ja oppaita…",
    clearSearch: "Tyhjennä haku",
    resultsFor: "tulosta haulle", resultSg: "tulos", resultPl: "tulosta", forWord: "haulle",
    noResultsTitle: "Artikkeleita ei löytynyt",
    noResultsSub: "Kokeile eri hakusanoja tai selaa alla olevia kategorioita.",
    seeAll: "Katso kaikki artikkelit",
    readArticle: "Lue artikkeli", minRead: "min lukuaika",
    articleCount: "artikkelia",
    catTitles: {
      "produtos": "Tuotteet",
      "app-ai-iot": "App + AI + IoT",
      "media-network": "Media Network",
      ...
      "instalacao-e-manutencao": "Asennus & Huolto",
    },
    catDescs: {
      "produtos": "Neo-puhdistimien tekniset tiedot, ostooppaat ja ominaisuudet.",
      "app-ai-iot": "Acquafy-sovelluksen asennus, käyttö ja AI- sekä IoT-ominaisuudet.",
      "media-network": "Mainossysteemin, QR-koodin ja toistuvan tulon käyttöohjeet.",
      "parceiros": "Oppaat Acquafy Silver, Gold ja Platinum -kumppaneille.",
      "faturamento": "Laskut, provisiot, maksut ja verodokumentaatio.",
      "instalacao-e-manutencao": "Asennus, puhdistus, suodattimen vaihto ja ennaltaehkäisevä huolto.",
    },
  },
  ru: {
    breadcrumbBase: "База знаний",
    breadcrumbArtigos: "Статьи",
    h1pre: "Статьи и", h1highlight: "Руководства",
    subtitle: "Обучающие материалы, руководства и подробные ответы, организованные по темам, чтобы вы нашли именно то, что нужно.",
    searchPlaceholder: "Поиск статей и руководств…",
    clearSearch: "Очистить поиск",
    resultsFor: "результатов по запросу", resultSg: "результат", resultPl: "результатов", forWord: "по запросу",
    noResultsTitle: "Статьи не найдены",
    noResultsSub: "Попробуйте другие слова или просмотрите категории ниже.",
    seeAll: "Смотреть все статьи",
    readArticle: "Читать статью", minRead: "мин чтения",
    articleCount: "статей",
    catTitles: {
      "produtos": "Продукты",
      "app-ai-iot": "App + AI + IoT",
      "media-network": "Media Network",
      "parceiros": "Партнёры",
      "faturamento": "Выставление счетов",
      "instalacao-e-manutencao": "Установка и обслуживание",
    },
    catDescs: {
      "produtos": "Характеристики, руководства по покупке и функции очистителей Neo.",
      "app-ai-iot": "Настройка, использование и функции приложения Acquafy с ИИ и IoT.",
      "media-network": "Как использовать систему рекламы, QR-код и регулярный доход.",
      "parceiros": "Руководства для партнёров Acquafy Silver, Gold и Platinum.",
      "faturamento": "Счета, комиссии, платежи и налоговая документация.",
      "instalacao-e-manutencao": "Установка, чистка, замена фильтров и профилактическое обслуживание.",
    },
  },
  ro: {
    breadcrumbBase: "Baza de Cunostinte",
    breadcrumbArtigos: "Articole",
    h1pre: "Articole si", h1highlight: "Ghiduri",
    subtitle: "Tutoriale, ghiduri si raspunsuri detaliate organizate pe teme pentru a gasi exact ce ai nevoie.",
    searchPlaceholder: "Cauta articole si ghiduri…",
    clearSearch: "Sterge cautarea",
    resultsFor: "rezultate pentru", resultSg: "rezultat", resultPl: "rezultate", forWord: "pentru",
    noResultsTitle: "Niciun articol gasit",
    noResultsSub: "Incearca termeni diferiti sau exploreaza categoriile de mai jos.",
    seeAll: "Vezi toate articolele",
    readArticle: "Citeste articolul", minRead: "min de citit",
    ...
    catTitles: {
      ...
      "media-network": "Media Network",
      "parceiros": "Parteneri",
      "faturamento": "Facturare",
      "instalacao-e-manutencao": "Instalare si Intretinere",
    },
    catDescs: {
      "produtos": "Specificatii, ghiduri de cumparare si functionalitati ale purificatoarelor Neo.",
      "app-ai-iot": "Configurare, utilizare si functii ale aplicatiei Acquafy cu AI si IoT.",
      "media-network": "Cum sa folosesti sistemul de reclame, QR Code si venituri recurente.",
      "parceiros": "Ghiduri pentru partenerii Silver, Gold si Platinum Acquafy.",
      "faturamento": "Facturi, comisioane, plati si documentatie fiscala.",
      "instalacao-e-manutencao": "Instalare, curatare, inlocuire filtre si intretinere preventiva.",
    },
  },
  he: {
    breadcrumbBase: "בסיס ידע",
    breadcrumbArtigos: "מאמרים",
    h1pre: "מאמרים &", h1highlight: "מדריכים",
    subtitle: "מדריכים, הסברים ותשובות מפורטות המאורגנות לפי נושא כדי שתמצא בדיוק את מה שאתה צריך.",
    searchPlaceholder: "חיפוש מאמרים ומדריכים…",
    clearSearch: "נקה חיפוש",
    resultsFor: "תוצאות עבור", resultSg: "תוצאה", resultPl: "תוצאות", forWord: "עבור",
    noResultsTitle: "לא נמצאו מאמרים",
    noResultsSub: "נסה מונחים שונים או עיין בקטגוריות למטה.",
    seeAll: "ראה את כל המאמרים",
    readArticle: "קרא מאמר", minRead: "דקות קריאה",
    articleCount: "מאמרים",
    catTitles: {
      "produtos": "מוצרים",
      "app-ai-iot": "App + AI + IoT",
      ...
      "parceiros": "שותפים",
      "faturamento": "חיוב",
      "instalacao-e-manutencao": "התקנה ותחזוקה",
    },
    catDescs: {
      "produtos": "מפרטים, מדריכי רכישה ותכונות של מטהרי Neo.",
      "app-ai-iot": "הגדרה, שימוש ותכונות של אפליקציית Acquafy עם AI ו-IoT.",
      "media-network": "כיצד להשתמש במערכת הפרסום, קוד QR והכנסה חוזרת.",
      "parceiros": "מדריכים לשותפי Acquafy Silver, Gold ו-Platinum.",
      "faturamento": "חשבוניות, עמלות, תשלומים ותיעוד מס.",
      "instalacao-e-manutencao": "התקנה, ניקוי, החלפת פילטרים ותחזוקה מונעת.",
    },
  },
};
